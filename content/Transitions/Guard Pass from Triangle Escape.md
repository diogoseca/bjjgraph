...
---
title: "Guard Pass from Triangle Escape | BJJ Technique | BJJ Graph"
description: "Master the guard pass from triangle escape in BJJ. Convert triangle defense into side control with systematic passing technique and proper timing."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Guard Pass from Triangle Escape", "item": "https://bjjgraph.org/Transitions/Guard-Pass-from-Triangle-Escape" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  ...
  "@type": "DefinedTerm",
  "name": "Guard Pass from Triangle Escape",
  "description": "Guard Pass from Triangle Escape is a defense-to-offense transition where the top player, having survived a triangle attempt through stacking and posture recovery, drives directly through the opponent's disorganized legs to establish side control.",
...
**Guard Pass from Triangle Escape is a defense-to-offense transition where the top player, having survived a triangle attempt through stacking and posture recovery, drives directly through the opponent's disorganized legs to establish side control.**
...
[[Guard Pass from Triangle Escape/Attacker|→ Full Attacker Guide]]
...
- **Consolidate post-escape base**: As the triangle lock loosens, immediately widen your base and drive your weight forward through your...

- **Control the locking leg**: Use your previously-trapped arm to grip the opponent's top leg at the knee or behind the calf. This ...

- **Pin the near hip**: Drive your free hand into the opponent's near-side hip, pressing it firmly to the mat. This hip pin ...

- **Drive stacking pressure forward**: Using the momentum from your triangle escape, continue driving your weight forward over the opponent...

- **Clear legs with directional pressure**: As you drive forward, use your grip on the top leg to push it across the opponent's body toward the ...

- **Establish crossface control**: As your body clears the opponent's legs, immediately slide your near-side arm under their head to es...

- **Settle weight and consolidate side control**: Drop your hips low against the opponent's near hip with your chest heavy across their upper body in ...


### Common Mistakes


- **Releasing stacking pressure after the triangle breaks to reset posture before initiating the pass**
...
- **Attempting to pass before the triangle is fully broken with the opponent's ankle lock still partially engaged**
...
- **Ignoring the locking leg and allowing it to float freely during the passing sequence**
...
[[Guard Pass from Triangle Escape/Defender|→ Full Defender Guide]]
...
- **Re-lock triangle before legs fully clear by hooking the top leg back behind the opponent's neck and closing the ankle lock** - When: When you feel the triangle loosening but the opponent has not yet cleared your locking leg past their head—the earlier you re-lock, the higher the success rate

- **Shrimp hips away and recover closed guard by pulling legs back to wrap around the opponent's waist before they establish perpendicular alignment** - When: When the triangle is definitively broken and the opponent is beginning lateral movement for the pass but has not yet cleared your legs

- **Frame strongly against the opponent's shoulder and hip with both forearms to create distance and insert a knee shield for half guard recovery** - When: When the opponent has cleared one leg but not both, making closed guard recovery unlikely but half guard still available
...
**Stack Pass Completion**: Continue the stacking pressure from the triangle escape without pausing, driving the opponent's hips over their shoulders and folding them in half. Walk around to side control while maintaining constant downward pressure, never releasing the stack. The opponent's compressed spine prevents hip escape or guard recovery throughout the entire pass. (When to use: When you have deep stacking pressure established and the opponent is already folded with their hips elevated above their shoulders. Most effective against flexible opponents who cannot easily be passed laterally.)


**Knee Slide Variation**: After clearing the triangle lock, immediately transition to a knee slice pass by sliding the near knee across the opponent's thigh while maintaining the crossface established during the escape. The momentum from the circular escape movement feeds directly into the lateral passing angle required for the knee slide, creating a seamless defense-to-offense chain. (When to use: When the triangle breaks cleanly and you achieve a perpendicular angle to the opponent quickly. Best suited for practitioners with strong crossface pressure and hip mobility for the knee cut.)


**Leg Drag Finish**: As the triangle legs disengage, grip the far ankle and drag it across your body to the opposite hip. This leg drag control turns the opponent's hips away from you while pinning their far leg, creating a clear passing lane to side control with the opponent unable to face you or insert defensive hooks. (When to use: When the opponent actively extends their legs during the triangle breakdown rather than pulling them in for guard recovery. Particularly effective in no-gi where pant grips are unavailable.)
