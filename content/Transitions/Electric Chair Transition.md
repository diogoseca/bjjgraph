...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for Electric Chair Transition from Lockdown/Bottom. Possible outcomes: Electric Chair (65%), Lockdown (25%), Half Guard (10%).",
  "step": [
    {
      "@type": "HowToStep",
...
## Opponent Counters
- **Opponent drives weight forward and flattens you with crossface pressure before underhook is secured** (Effectiveness: High) - Your Response: Prioritize underhook establishment before hip elevation. If flattened, use whip-up motion to re-break posture or transition to Deep Half Guard by diving underneath
- **Opponent posts their far hand on the mat to base out against elevation** (Effectiveness: Medium) - Your Response: Use free hand to control their posting arm, pulling it across their body. Alternatively, accelerate transition and use their base commitment to hit Old School sweep
- **Opponent windshield wipers their trapped leg to extract it from lockdown** (Effectiveness: Medium) - Your Response: Increase lockdown squeeze and follow their leg movement. If they create significant rotation, immediately pursue Truck entry as their defensive motion exposes the crab ride position
- **Opponent sprawls hips backward to create distance and relieve pressure** (Effectiveness: Low) - Your Response: Follow their backward movement with continued hip extension. Their sprawling actually amplifies the Electric Chair pressure and often accelerates submission threat
...
## Common Mistakes
- **Mistake**: Releasing lockdown tension while reaching for ankle grip
...
- **Mistake**: Shallow underhook that doesn't reach across opponent's back
...
- **Mistake**: Attempting elevation without controlling opponent's near ankle
...
- **Mistake**: Using arm strength instead of hip extension to drive the transition
...
- **Mistake**: Failing to angle body perpendicular during elevation
...
- **Mistake**: Attempting transition against well-postured opponent
