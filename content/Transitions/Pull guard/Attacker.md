...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for executing Pull guard from Standing Guard/Bottom.",
  "step": [
    {
      "@type": "HowToStep",
...
<p class="section-subtitle">What are the key principles for executing Pull guard?</p>
...
<p class="section-subtitle">What do you need before attempting Pull guard?</p>
...
<p class="section-subtitle">How do you execute Pull guard step by step?</p>
...
<p class="section-subtitle">What mistakes should you avoid when executing Pull guard?</p>
...
<p class="section-subtitle">How do you train Pull guard (Attacker)?</p>
...
<p class="section-subtitle">What are the safety concerns for Pull guard?</p>
