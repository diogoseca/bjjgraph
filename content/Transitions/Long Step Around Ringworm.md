...
description: "Master Long Step Around Ringworm pass in BJJ. Navigate complex lapel configurations with long-step mechanics. Success: Beginner 30%, Intermediate 50%, Advanced 65%."
---
...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for Long Step Around Ringworm from Lapel Guard/Top. Possible outcomes: Side Control (55%), Half Guard (10%), Lapel Guard (20%), Back Control (15%).",
  "step": [
    {
      "@type": "HowToStep",
...
## Opponent Counters
- **Hip chase—opponent rotates their hips to follow your movement and re-establish guard angle** (Effectiveness: High) - Your Response: Maintain strong far hip control throughout the step and increase forward pressure to pin their hip to the mat
- **Sit-up to back take—opponent releases lapel grips and pursues your back as you step around** (Effectiveness: High) - Your Response: Drive shoulder pressure immediately upon landing and keep your elbow tight to prevent them from getting under your arm
- **Leg pummeling—opponent attempts to reinsert guard hooks as you pass around** (Effectiveness: Medium) - Your Response: Step completely past their hip before consolidating, and use knee pressure to block hook reinsertion
- **Lapel reconfiguration—opponent adjusts the lapel wrap to the new passing angle** (Effectiveness: Medium) - Your Response: Move faster than they can reconfigure—the long step should be explosive and continuous, not allowing adjustment time
...
## Common Mistakes
- **Mistake**: Taking too small of a step that remains within the controlled passing lanes
...
- **Mistake**: Failing to establish hip control before initiating the long step
...
- **Mistake**: Pausing between the long step and forward pressure application
...
- **Mistake**: Attempting long step against fresh opponent who hasn't committed to lapel configuration
...
- **Mistake**: Keeping hips too high during the stepping motion
...
- [[Spider Guard]] - Guard opponent may transition to if lapel configuration is abandoned
