...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for Granby Roll to Guard from Buggy Choke/Bottom. Possible outcomes: Closed Guard (50%), Open Guard (15%), Buggy Choke (20%), Back Control (15%).",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Create space",
...
## Opponent Counters
- **Opponent follows the roll and takes back control** (Effectiveness: High) - Your Response: Complete the roll faster with more hip extension, or transition directly to deep half guard by underhooking opponent's leg as they follow
- **Opponent sprawls heavy and drives forward as you initiate** (Effectiveness: High) - Your Response: Abort the granby and switch to sitting to half guard, using their forward momentum to create space underneath
- **Opponent maintains collar grip and follows to mounted position** (Effectiveness: Medium) - Your Response: Strip the collar grip during the roll using your far hand, or accept the collar grip and play collar defense from closed guard
- **Opponent angles perpendicular and blocks roll with knee pressure** (Effectiveness: Medium) - Your Response: Change direction mid-movement to granby to the opposite side, or use their knee as a pivot to sit directly to butterfly guard
...
## Common Mistakes
- **Mistake**: Initiating the roll before creating any space from opponent's pressure
...
- **Mistake**: Rolling directly over the top of the head instead of diagonally across shoulder
...
- **Mistake**: Stopping momentum mid-roll in the inverted position
...
- **Mistake**: Not establishing immediate leg contact after completing the roll
...
- [[Granby Roll Escape]] - Related technique using same movement pattern
