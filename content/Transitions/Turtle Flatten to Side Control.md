...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for Turtle Flatten to Side Control from Turtle/Top. Possible outcomes: Side Control (55%), Turtle (30%), Half Guard (15%).",
  "step": [
    {
      "@type": "HowToStep",
...
## Opponent Counters
- **Opponent granby rolls as you initiate the flatten, using your forward pressure to invert and recover guard** (Effectiveness: High) - Your Response: Recognize the roll initiation by their hip lift and immediately backstep or follow the roll while maintaining harness control to end up in back control rather than losing position
- **Opponent sits through to half guard or butterfly guard as you commit weight laterally for the flatten** (Effectiveness: Medium) - Your Response: If they sit through toward you, immediately transition to front headlock position and attack with guillotine or anaconda; if away, follow their hips and re-establish top pressure
- **Opponent posts a strong far arm and hip escapes during the flatten to create frames and recover guard** (Effectiveness: Medium) - Your Response: Drive through their posted arm with your crossface pressure, collapsing their frame. Alternatively, switch to kimura attack on the posted arm to either submit or use the grip to continue flattening
- **Opponent explosively stands up as you release upper body control to establish drive angle** (Effectiveness: High) - Your Response: Maintain at least one control point at all times. If they begin standing, immediately transition to body lock or snap down to front headlock rather than chasing the flatten
...
## Common Mistakes
- **Mistake**: Attempting to flatten by pulling opponent sideways instead of driving through with chest and knee pressure
...
- **Mistake**: Releasing all upper body control to establish hip grips before initiating the flatten
...
- **Mistake**: Pausing between flattening the opponent and transitioning to side control
...
- **Mistake**: Driving straight down onto opponent's back instead of at a lateral angle
...
- **Mistake**: Failing to block the near hip with your knee during the transition to side control
...
- **Mistake**: Attempting the flatten when opponent has strong defensive grips on your wrists or sleeves
