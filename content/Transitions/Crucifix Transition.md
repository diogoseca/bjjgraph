...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for Crucifix Transition from Standing Back Control/Top. Possible outcomes: Crucifix (55%), Standing Back Control (30%), Turtle (15%).",
  "step": [
    {
      "@type": "HowToStep",
    ...
    {
      "@type": "HowToStep",
      "name": "Secure arm with leg",
      "text": "Lock their arm between your leg and hip by squeezing your thigh tight and controlling their wrist with your hand. The arm should be bent at approximately ninety degrees with their elbow trapped against your hip bone.",
      "position": 4
    },
    {
      "@type": "HowToStep",
    ...
    },
    {
      ...
      "text": "Once on the mat, immediately triangle your legs around their trapped arm and torso. Reach over their head to control their other arm, completing the full crucifix position with both arms isolated and their neck exposed.",
      "position": 6
    }
  ],
...
## Opponent Counters
- **Opponent keeps elbow tight and refuses to extend arm during grip fighting, denying the capture opportunity** (Effectiveness: High) - Your Response: Attack the neck directly since they are not defending it, or use their tight arm position to break them down to grounded back control
- **Opponent drops weight explosively when they feel the arm capture beginning, pulling you down before you can consolidate** (Effectiveness: Medium) - Your Response: Follow them down and transition to truck position or standard back control, using their descent to establish hooks
- **Opponent turns aggressively into you during the transition, attempting to face you and escape back exposure** (Effectiveness: Medium) - Your Response: Maintain the arm trap and follow their rotation, converting to mounted crucifix or transitioning to armbar if they complete the turn
...
## Common Mistakes
- **Mistake**: Releasing harness control to reach for the arm capture
...
- **Mistake**: Attempting arm capture when opponent's arm is not sufficiently extended
...
- **Mistake**: Losing chest-to-back connection during the leg step through
...
- **Mistake**: Failing to control the wrist of the captured arm
...
- **Mistake**: Rushing the mat return before the arm trap is secure
...
- [[Rear Naked Choke]] - Primary submission threat that forces defensive grip fighting which creates opportunity
