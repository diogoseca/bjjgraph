...
---
title: "Inside Heel Hook from Honey Hole | BJJ Technique | BJJ Graph"
description: "Master the inside heel hook from Honey Hole in BJJ. Expert guide to grip mechanics, rotational finishing, defense protocols, and training drills for leg lock mastery."
---
...
- **Verify positional stability**: Confirm your inside leg triangle is tight with no slack, your outside leg is driving across opponent...

- **Neutralize the free leg**: Use your top-side arm to control opponent's free leg by gripping behind their knee or pinning their ...

- **Secure heel grip with bottom hand**: Slide your bottom hand (the one closest to the mat) onto the opponent's heel, placing four fingers o...

- **Establish wrist control with top hand**: Place your top hand on opponent's ankle, wrist, or forearm (depending on their defensive hand positi...

- **Pinch knees together**: Squeeze your knees tightly around the opponent's trapped leg, eliminating any remaining slack in the...

- **Initiate hip extension with medial rotation**: Bridge your hips upward and forward while simultaneously rotating the heel medially—toward the insid...

- **Apply progressive breaking pressure**: Continue driving through with hip extension and heel rotation in a smooth, progressive arc. In train...

- **Maintain control through submission**: Keep your positional grips and leg entanglement secure even as the opponent signals submission. Do n...


### Common Mistakes


- **Gripping the heel before establishing complete positional control**
...
- **Pulling with arm strength rather than using hip extension for breaking pressure**
...
- **Neglecting knee pinch during the finishing sequence**
...
- **Explosive counter-entanglement rotation to 50-50 guard** - When: Before the attacker secures the heel grip, when you feel the triangle but still have rotational freedom in your hips

- **Hide heel by curling toes and shielding foot with both hands** - When: When escape attempts have failed but the attacker has not yet secured the heel grip—buys time for secondary escape attempts

- **Two-hand grip strip on the attacker's heel-cupping hand** - When: When the attacker has secured the heel grip but has not yet initiated breaking pressure—the narrow window between grip and finish
...
**Standard Two-Hand Finish**: Classic configuration with bottom hand cupping heel (four fingers over top, thumb underneath) and top hand controlling the ankle or wrist. Provides maximum breaking leverage through coordinated grip and hip extension. The two-hand system creates a unified lever that directs all rotational force through the heel into the knee. (When to use: When opponent's heel is fully exposed and accessible with no active grip fighting, allowing clean establishment of the complete two-hand grip configuration.)


**Belly-Down Heel Hook**: After securing the heel grip from standard Honey Hole, the attacker rolls to a belly-down (prone) position while maintaining the heel cup. This generates extreme rotational pressure through bodyweight and gravity rather than hip extension alone. The prone position makes the finish nearly inescapable but sacrifices the ability to maintain Honey Hole if the grip breaks. (When to use: When opponent is actively rotating their body or when standard hip extension alone is insufficient to finish—typically against flexible opponents or when the breaking angle is suboptimal.)


**Single-Arm Finish**: Finishing with only the heel-cupping hand while the other hand posts on the mat for base or controls the opponent's hip and free leg. Requires stronger grip and more precise heel placement but allows the attacker to maintain better positional control throughout the finish. Often transitions into this variant when opponent strips one hand during grip fighting. (When to use: When opponent is actively grip fighting and preventing the standard two-hand configuration, or when controlling their body movement is a higher priority than maximum breaking leverage.)
