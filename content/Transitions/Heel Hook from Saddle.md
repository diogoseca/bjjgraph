...
---
title: "Heel Hook from Saddle | BJJ Technique | BJJ Graph"
description: "Master the heel hook from saddle in BJJ. Complete guide to inside heel hook finishing mechanics, grip sequencing, rotational control, defense, and safe training."
---
...
- **Verify saddle control integrity**: Before initiating any grip transition toward the heel, confirm all structural control points are sec...

- **Clear remaining defensive frames**: Address any frames the opponent has established on your hips, shoulders, or chest using your free ha...

- **Control the ankle to prevent knee rotation**: Secure the opponent's ankle with your outside arm, cupping above the ankle joint to prevent them fro...

- **Expose and capture the heel**: Using the ankle control as a platform, work your inside hand to cup the heel by placing the blade of...

- **Establish figure-four finishing grip**: Bring your secondary hand to grip your own wrist, creating a Kimura-style reinforced figure-four loc...

- **Set rotational angle and body position**: Before applying pressure, ensure your torso is positioned so that your rotation will drive the heel ...

- **Apply controlled progressive rotation**: Begin rotating the heel by turning your entire body as a unit—drive your elbows toward your chest wh...

- **Complete the finish or transition to chain attack**: Continue controlled rotation until the opponent taps or the referee stops the match. If the opponent...


### Common Mistakes


- **Reaching for the heel before establishing complete saddle control**
...
- **Using arm strength for rotational finish instead of whole-body mechanics**
...
- **Losing hip pressure during the transition from control grips to finishing grips**
...
- **Hide the heel by rotating knee inward and pressing heel against your own hip while gripping your own ankle** - When: Immediately upon recognizing the attacker is transitioning from control grips to heel capture—this is your first and most critical defensive action before any escape attempt

- **Two-on-one grip fighting to strip the attacker's heel grip at the wrist and thumb before the figure-four locks in** - When: When the attacker has captured your heel but has not yet established the reinforced figure-four finishing grip—grip fighting is most effective in this transition window

- **Frame on attacker's hips with free leg and initiate rotational escape moving body toward the attacker** - When: When the attacker's saddle configuration has loosened during grip transitions or when you have successfully stripped their finishing grip and created momentary space
...
**Standard Figure-Four Inside Heel Hook**: Classical finish using blade-of-wrist against Achilles tendon with Kimura-style figure-four reinforcement. Cup the heel with the primary hand, lock a figure-four with the secondary hand gripping your own wrist, tuck the foot into your armpit, and apply controlled rotation by driving elbows toward your chest while your entire torso turns as a unit. (When to use: When you have full positional control with all defensive barriers cleared and heel fully exposed. This is the highest-percentage finishing grip from established saddle.)


**Palm-to-Palm Gable Grip Heel Hook**: Two hands cupping the heel with interlocked fingers in a Gable grip configuration rather than figure-four. Provides more surface contact and friction in sweaty conditions but less mechanical reinforcement than the figure-four. Faster to establish since it skips the wrist-grip step. (When to use: When conditions are sweaty and the heel is slippery, or when you need to secure the heel quickly before the opponent can re-hide it. Also effective when the opponent's ankle is small and doesn't fill the figure-four pocket well.)


**Belly-Down Heel Hook Finish**: Rolling finish where you rotate over your shoulder while maintaining heel grip, ending belly-down with the opponent's leg trapped under your body weight. Creates enormous rotational torque by using your entire body as the lever arm rather than just arm rotation. Extremely difficult to defend once established. (When to use: When the opponent attempts to rotate away or sit up during your standard finishing sequence, making the belly-down transition a natural follow. Also useful when the opponent is stacking defense and you need additional breaking force beyond what the standard position generates.)


**Short Heel Hook with Elbows Tight**: Compact finishing position where you pull the opponent's foot deep into your armpit and keep both elbows pinched against your ribs with minimal arm extension. The rotation comes entirely from torso movement. Sacrifices some range of motion for dramatically increased grip security and resistance to grip breaks. (When to use: Against opponents with strong grip-fighting defense who consistently strip your finishing grip. The compact position makes it nearly impossible to access your grip for breaking, and the torso-driven rotation is harder to resist than arm-driven rotation.)
