...
## Opponent Counters
- **Opponent tucks chin hard and clamps far elbow tight to ribs, denying the armpit threading path during the redirect phase** (Effectiveness: High) - Your Response: If the far armpit is blocked, abandon the darce switch and either return to the original buggy choke collar grip or switch to the anaconda configuration which threads around the neck first and does not require far armpit access
- **Opponent extracts their near arm from the trapped position before the figure-four grip is secured, eliminating the compression fulcrum** (Effectiveness: High) - Your Response: Without the trapped arm, switch to a guillotine configuration since you already have neck access, or disengage the neck and transition to back control by hooking the near leg as they posture to escape
...
## Common Mistakes
- **Mistake**: Releasing chest-to-back pressure during the grip transition to focus entirely on hand positioning and arm threading
...
- **Mistake**: Attempting the darce switch when the opponent has not rotated and the far armpit remains closed
...
- **Mistake**: Threading the choking arm too shallow under the far armpit without achieving full neck encirclement
...
- **Mistake**: Failing to keep the opponent's near arm trapped inside the darce channel during the transition
...
- **Mistake**: Using pure arm squeeze to finish the darce rather than generating pressure through body angle and sprawl
...
- **Mistake**: Pausing between releasing the buggy choke collar grip and beginning the darce arm redirect
