...
---
title: "Guillotine Choke | BJJ Technique | BJJ Graph"
description: "Learn Guillotine Choke in BJJ. Step-by-step finishing mechanics from Guillotine Control. Success rates: Beginner 30%, Intermediate 50%, Advanced 65%."
---
...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for Guillotine Choke from Guillotine Control/Bottom. Possible outcomes: Game Over (65%), Guillotine Control (25%), Side Control (10%).",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Verify grip depth",
      "text": "Confirm the blade of your choking wrist crosses directly over the front of the opponent's throat, with your forearm contacting the trachea and carotid structures. If grip is shallow (across jaw or chin), adjust by pulling the head deeper before proceeding.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Secure hand clasp",
      "text": "Connect your hands using a gable grip (palm-to-palm), S-grip, or figure-four configuration behind the opponent's head. Ensure the grip is tight with no slack—your non-choking hand should pull the choking wrist firmly into the neck.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Close guard high",
      "text": "Lock your legs in closed guard positioned high on the opponent's back, near their shoulders. This positioning prevents them from posturing up or driving forward. Pull your heels toward your glutes to compress their upper body downward.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Angle hips toward choking side",
      "text": "Hip escape slightly toward the side of your choking arm while maintaining guard lock. This angle creates a fulcrum effect that dramatically increases choking pressure without requiring additional arm strength. Your hip becomes the lever point.",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Elevate choking elbow",
      "text": "Drive your choking elbow toward the ceiling while keeping it tight to your ribs. This motion lifts the forearm into the throat structures and closes the choking angle. Think of pointing your elbow at a spot on the ceiling above the opponent's far shoulder.",
      "position": 5
    },
    {
      "@type": "HowToStep",
      "name": "Pull head down and curl",
      "text": "Simultaneously pull the opponent's head down toward your chest using your clasped hands while curling your choking arm upward. This creates compression from two directions—head going down, forearm coming up—completing the choke mechanism.",
      "position": 6
    },
    {
      "@type": "HowToStep",
      "name": "Bridge and squeeze",
      "text": "Bridge your hips upward into the opponent while maintaining the curling pressure. This bridge amplifies the compression and prevents them from creating any space. Hold the position until you feel the tap or the opponent goes limp.",
      "position": 7
    }
  ],
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the optimal wrist position for maximum choking pressure in the guillotine?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Your opponent begins posturing up during your guillotine finish—how do you adjust?",
      "acceptedAnswer": {
        "@type": "Answer",
...
## Opponent Counters
- **Posture up and hand fight to extract head by straightening spine and peeling grip** (Effectiveness: High) - Your Response: Close guard tighter and use legs to break posture before they can fully extend. If they begin posturing, immediately hip bump sweep or transition to high elbow variation
- **Drive weight forward to flatten bottom player and relieve choke angle** (Effectiveness: Medium) - Your Response: Use their forward momentum for hip bump sweep to mount while maintaining guillotine grip, or angle hips away and use butterfly hooks to redirect their weight
- **Von Flue choke counter by passing guard and shoulder-pressuring the choking arm** (Effectiveness: High) - Your Response: Never allow guard pass while holding guillotine. If they begin passing, either commit fully to finish or release and recover guard before they consolidate
- **Turn head and shoulders toward choking arm to relieve pressure on carotids** (Effectiveness: Medium) - Your Response: Transition to anaconda or darce choke setups which exploit this turning motion. Their turn actually exposes them to arm-triangle variations
- **Tuck chin firmly and defend neck with hand fighting to prevent finishing pressure** (Effectiveness: Medium) - Your Response: Switch to high elbow guillotine which attacks behind the chin, or transition to triangle/omoplata as their arm positioning becomes compromised during neck defense
...
## Common Mistakes
- **Mistake**: Gripping too shallow with wrist across opponent's chin or jaw instead of throat
...
- **Mistake**: Squeezing with arms only without engaging hips or proper body angle
...
- **Mistake**: Allowing elbows to flare away from body during finish attempt
...
- **Mistake**: Losing guard connection and allowing opponent to pass while attempting finish
...
- **Mistake**: Pulling opponent's head up and away instead of down toward your chest
...
- **Mistake**: Attempting finish with legs extended or passive instead of actively breaking posture
...
## Variations
**High Elbow Guillotine**: Variation where the choking elbow drives extremely high toward the ceiling, with the forearm sliding behind the opponent's chin. This attacks the choke from a different angle and defeats chin-tuck defense by going behind the jaw rather than against it. (When to use: When opponent successfully tucks chin against standard guillotine or when you have achieved very deep grip)

**Arm-In Guillotine**: Variation executed when opponent's arm becomes trapped inside the guillotine loop. Uses the trapped arm to assist compression against the carotid by pressing it into the neck. Requires slight angle adjustment toward the trapped arm side. (When to use: When opponent's arm enters the guillotine loop during defense or scramble situations—opportunistic variation rather than intentional setup)

**Ten-Finger Guillotine**: Variation using interlocked fingers rather than gable or S-grip. Provides different leverage mechanics and can be easier to maintain against strong hand fighters. Requires secure finger lock to prevent grip breaks. (When to use: When opponent is effectively attacking standard grip configurations or when personal preference suits finger-lock gripping)

**Standing Guillotine Finish**: Finishing the guillotine while standing rather than pulling guard. Uses downward hip pressure and leg positioning to finish without going to ground. Higher risk of counter-throw but faster finish if successful. (When to use: When you catch guillotine from sprawl or clinch and opponent's posture is already severely broken, or in competition where guard pull may not be strategic)
...
- [[High Elbow Guillotine]] - Primary variation when chin is tucked
- [[Arm in Guillotine]] - Variation when arm is trapped
- [[Anaconda Choke]] - Transition when opponent turns into the choke
- [[Darce Choke]] - Transition when opponent turns away from choke
- [[Hip Bump Sweep]] - Sweep option when opponent drives forward defending
- [[Closed Guard]] - Guard position providing finishing platform
- [[Front Headlock]] - Parent position category
- [[Triangle Control]] - Alternative submission when arm crosses during defense
- [[Mount]] - Position achieved after hip bump sweep with guillotine
