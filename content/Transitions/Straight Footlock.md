...
description: "Master the Straight Footlock finish in BJJ. Step-by-step submission mechanics from Ankle Lock Control. Success rates: Beginner 30%, Intermediate 50%, Advanced 65%."
---
...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for Straight Footlock from Straight Ankle Lock Control/Bottom. Possible outcomes: Game Over (55%), Straight Ankle Lock Control (30%), Open Guard (15%).",
  "step": [
    {
      "@type": "HowToStep",
...
## Common Mistakes
- **Mistake**: Using arm strength to pull and crank the ankle rather than driving with hip extension and back arch
...
- **Mistake**: Initiating the extension before confirming leg control prevents hip rotation
...
- **Mistake**: Positioning the forearm across the top of the foot or shin instead of behind the Achilles tendon
...
- **Mistake**: Applying explosive jerking force rather than progressive pressure during the extension
...
- **Mistake**: Allowing slack between the forearm and the Achilles tendon before extending
...
- **Mistake**: Persisting with the finish attempt for too long when the defender has established effective defensive frames
...
- [[Straight Ankle Lock]] - Entry transition that establishes the control position preceding this finish
...
- [[Leg Entanglement]] - Conceptual framework principle governing the position category
- [[Straight Ankle Lock Entry]] - Alternative entry path that feeds into the same control and finish system
