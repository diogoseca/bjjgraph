...
---
title: "Complete Triangle Escape from Top | BJJ Technique | BJJ Graph"
description: "Complete guide to escaping the triangle choke from top position in BJJ. Master posture recovery, systematic arm extraction, and guard passing after escape."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Complete Triangle Escape from Top", "item": "https://bjjgraph.org/Transitions/Complete-Triangle-Escape-from-Top" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  ...
  "@type": "DefinedTerm",
  "name": "Complete Triangle Escape from Top",
  "description": "Complete Triangle Escape from Top is the full defensive sequence for breaking free of a triangle choke while on top — relieving the choke, recovering posture, controlling the hips, then circling and stacking to extract the trapped arm and pass.",
...
**Complete Triangle Escape from Top is the full defensive sequence for breaking free of a triangle choke while on top — relieving the choke, recovering posture, controlling the hips, then circling and stacking to extract the trapped arm and pass.**
...
[[Complete Triangle Escape from Top/Attacker|→ Full Attacker Guide]]
...
[[Complete Triangle Escape from Top/Defender|→ Full Defender Guide]]
...
**Stack Pass Escape**: Drive aggressive forward stacking pressure to compress opponent's hips onto their shoulders, then walk around the triangle while maintaining heavy downward pressure. This variant converts the escape directly into a passing sequence by using the stacking momentum to fold the opponent and pass their legs to one side. (When to use: When opponent has a loose triangle with poor ankle lock or when you have significant size and strength advantage that enables sustained stacking pressure without being swept.)


**Standing Triangle Break**: Stand up in base to maximum height, creating vertical distance that significantly reduces the triangle's choking effectiveness. From standing, use gravity and posture to weaken the lock before slamming opponent's hips to mat and circling free. The elevation changes the angle geometry so dramatically that most triangles lose finishing capability. (When to use: When you have strong base and balance, the triangle is not yet fully locked, or the opponent is lighter and cannot maintain the lock against gravitational pull on their body weight.)


**Shoulder Pin Escape**: Pin the opponent's far shoulder to the mat with your free hand while circling toward the trapped arm side. This prevents the opponent from following your lateral movement with their hips, forcing the triangle open as your body rotates out of alignment with their choking angle. Combine the shoulder pin with steady circling pressure. (When to use: When opponent has strong hip mobility and keeps adjusting their angle to match your circling. The shoulder pin immobilizes their rotation axis and creates a fixed point you can escape around.)
