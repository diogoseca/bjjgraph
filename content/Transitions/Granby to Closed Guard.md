...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for Granby to Closed Guard from Turtle/Bottom. Possible outcomes: Closed Guard (65%), Turtle (20%), Back Control (15%).",
  "step": [
    {
      "@type": "HowToStep",
...
- [[Technical Standup]] - Alternative defensive recovery creating distance rather than guard
- [[Rolling to Guard]] - Related rolling-based guard recovery technique
- [[Elbow Escape to Guard]] - Complementary escape using different mechanics for similar goals
- [[Bridge and Roll]] - Alternative rotation-based escape from bottom positions
- [[Granby Roll Escape]] - Related Granby technique for turtle escape scenarios
- [[Granby Roll to Guard]] - Closely related guard recovery using Granby mechanics
- [[Turtle]] - Primary starting position for this technique
- [[Closed Guard]] - Target position upon successful completion
- [[Butterfly Guard]] - Alternative guard recovery option when closed guard is unavailable
- [[Half Guard]] - Fallback guard position if full closed guard cannot be established
- [[Back Control]] - Position being defended against during execution
