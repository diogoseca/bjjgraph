...
description: "Learn Triangle from Back in BJJ. Step-by-step setup from Harness to Rear Triangle control. Success rates: Beginner 25%, Intermediate 45%, Advanced 65%."
---
...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for Triangle from Back from Harness/Top. Possible outcomes: Rear Triangle (55%), Harness (30%), Half Guard (15%).",
  "step": [
    {
      "@type": "HowToStep",
...
## Common Mistakes
- **Mistake**: Releasing chest-to-back connection while threading the leg, creating space between bodies
...
- **Mistake**: Attempting the triangle without first forcing the opponent to commit both hands to choke defense
...
- **Mistake**: Threading the leg too slowly or hesitating mid-arc over the shoulder
...
- **Mistake**: Removing both hooks simultaneously to free the leg instead of keeping one hook active
...
- **Mistake**: Failing to lock the figure-four immediately after the leg clears the shoulder
...
- **Mistake**: Neglecting to control the opponent's far arm during the transition phase
...
- [[Triangle Escape]] - Counter technique - opponent's primary defensive response once triangle is locked
