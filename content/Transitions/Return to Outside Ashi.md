...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for Return to Outside Ashi from Ushiro Ashi-Garami/Top. Possible outcomes: Outside Ashi-Garami (65%), Ushiro Ashi-Garami (25%), 50-50 Guard (10%).",
  "step": [
    {
      "@type": "HowToStep",
...
## Opponent Counters
- **Opponent accelerates rotation to turtle before you can reverse their hips** (Effectiveness: High) - Your Response: Follow to back control instead of fighting the rotation. If they commit fully to turtle, the back take becomes higher percentage than forcing outside ashi re-establishment.
- **Opponent uses free leg to post and resist hip reversal** (Effectiveness: Medium) - Your Response: Attack the posting leg with your outside leg by hooking behind their knee. Convert their post into a trapped second leg and consider transitioning to saddle instead of outside ashi.
- **Opponent counter-rotates into 50-50 guard during the transition** (Effectiveness: Medium) - Your Response: Accept 50-50 as a neutral position and work standard 50-50 escapes or attacks. The 50-50 is preferable to losing control entirely during a failed transition attempt.
...
## Common Mistakes
- **Mistake**: Releasing inside leg control before establishing outside leg position
...
- **Mistake**: Attempting transition while opponent is actively rotating with strong momentum
...
- **Mistake**: Ignoring opponent's free leg position during the transition
...
- **Mistake**: Forcing transition from shallow ushiro control without consolidating first
...
- **Mistake**: Failing to adjust hip angle after re-establishing outside ashi
