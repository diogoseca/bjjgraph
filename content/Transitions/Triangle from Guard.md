...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for Triangle from Guard from Mission Control/Bottom. Possible outcomes: Triangle Control (55%), Mission Control (25%), Closed Guard (10%), Headquarters Position (10%).",
  "step": [
    {
      "@type": "HowToStep",
...
## Common Mistakes
- **Mistake**: Attempting to swing the leg across the opponent's face without first baiting or waiting for a postural recovery attempt
...
- **Mistake**: Releasing head control with both hands while transitioning the leg across the opponent's neck
...
- **Mistake**: Failing to cut a perpendicular angle after locking the figure-four, leaving hips squared up with the opponent's centerline
...
- **Mistake**: Allowing the trapped arm to slip to the outside of the leg during the transition, resulting in both of the opponent's arms being outside the triangle
...
- **Mistake**: Dropping hips to the mat during the leg transition instead of maintaining or increasing hip elevation
...
- **Mistake**: Locking the figure-four too slowly, leaving a gap between the leg crossing and the lock being secured
...
- **Mistake**: Attempting to finish the choke by squeezing legs together without first pulling the trapped arm across the centerline
