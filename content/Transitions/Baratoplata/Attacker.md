...
---
title: "Baratoplata Attacker | BJJ Technique Guide | BJJ Graph"
description: "How to execute the Baratoplata shoulder lock in BJJ. Attacking perspective with arm weave mechanics, execution steps, counters, and safety protocols."
---
...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for executing Baratoplata from Omoplata Control/Top.",
  "step": [
    {
      "@type": "HowToStep",
    ...
    {
      "@type": "HowToStep",
      "name": "Neutralize free arm",
      "text": "Control the opponent's free arm by trapping it against your body or pinning it with your near-side hand. Their free arm is their primary tool for posting to create base or grip fighting to strip your weave. Eliminating this option dramatically reduces their defensive capacity.",
      "position": 4
    },
    {
      "@type": "HowToStep",
    ...
    {
      "@type": "HowToStep",
      "name": "Fine-tune angle and monitor response",
      "text": "Make micro-adjustments to hip angle and leg positioning to maximize shoulder pressure. Monitor opponent's response - increased resistance without tap indicates angle adjustment needed. Be prepared for immediate release upon any tap signal, verbal or physical.",
      "position": 7
    }
  ],
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "Baratoplata",
      "item": "https://bjjgraph.org/Transitions/Baratoplata"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjgraph.org/Transitions/Baratoplata/Attacker"
    }
  ]
}
</script>
...
4. **Neutralize free arm**: Control the opponent's free arm by trapping it against your body or pinning it with your near-side hand. Their free arm is their primary tool for posting to create base or grip fighting to strip your weave. Eliminating this option dramatically reduces their defensive capacity.
5. **Initiate controlled hip extension**: Begin slowly extending your hips away from opponent while maintaining the arm weave configuration. This extension creates the primary rotational force on their shoulder joint. The movement should be deliberate and progressive, not explosive.
6. **Apply compound pressure**: Combine hip extension with pulling your arm weave toward your chest while simultaneously driving down with your high guard leg. These three vectors create the complete submission pressure attacking the shoulder through internal rotation combined with extension.
7. **Fine-tune angle and monitor response**: Make micro-adjustments to hip angle and leg positioning to maximize shoulder pressure. Monitor opponent's response - increased resistance without tap indicates angle adjustment needed. Be prepared for immediate release upon any tap signal, verbal or physical.
...
### 1. Applying explosive or jerking pressure to finish quickly
...
### 2. Releasing high guard pressure during finish attempt
...
### 3. Incorrect hip angle attacking elbow instead of shoulder
...
### 4. Incomplete arm weave that doesn't clear opponent's elbow
...
### 5. Continuing pressure after opponent taps
...
### 6. Neglecting to control opponent's free arm before initiating finish

- **Consequence**: Opponent uses free arm to post, frame, or strip the arm weave, negating the submission attempt entirely
- **Correction**: Pin or trap the free arm before committing to hip extension - free arm control is a prerequisite, not an afterthought
...
**Week 7-8** - Chain integration
Drill the complete rubber guard chain from Mission Control through Meathook to Baratoplata Setup to finish. Practice recognizing when Baratoplata opens based on opponent's defensive reactions to other attacks. Work counter-to-counter sequences.
...
**A**: The Baratoplata primarily attacks the rotator cuff muscles (supraspinatus, infraspinatus, teres minor, subscapularis), the shoulder capsule, and potentially the labrum. The submission becomes dangerous when the opponent's shoulder begins rotating beyond its natural range of motion - typically felt as their resistance suddenly decreasing or any clicking or popping sounds. The point of no return occurs once proper angle is established and hip extension begins applying direct rotational force to the joint.

**Q9**: What grip configuration must be established for the arm weave and why is it mechanically superior?
**A**: The arm weave requires threading your forearm completely under the opponent's trapped elbow and securing a grip on your own shin or knee, creating a figure-four configuration. This is mechanically superior to simply holding the opponent's arm because the figure-four locks their limb against your skeletal structure rather than relying on grip strength. The opponent cannot strip a grip that connects to your own body, and the configuration converts your hip extension into precise rotational force on their shoulder joint.

**Q10**: Your opponent straightens their trapped arm during your finish attempt - what chain attack opens up?
**A**: A straightened arm defeats the rotational shoulder attack but immediately exposes the elbow joint to armbar mechanics. Release the arm weave and transition to a standard armbar by controlling their wrist, swinging your leg over their face, and applying hip elevation pressure against the elbow. The arm positioning from the failed Baratoplata creates an ideal armbar angle because you already have leg control across their back and their arm is extended and isolated. This chain punishes the most common intelligent defense.

**Q11**: When is the optimal timing window to initiate the Baratoplata finish from Omoplata Control?
**A**: The optimal window occurs immediately after the opponent's failed escape attempt, when they have momentarily exhausted their defensive energy and their posture is broken. Specifically, look for: their free arm returning to a neutral position after a failed post attempt, their body settling flat after an unsuccessful roll, or the moment after they abandon grip fighting on the weave. Initiating during active defense is suboptimal because their muscular tension resists the angle creation. The brief relaxation between defensive efforts is when the arm weave locks deepest and hip angle adjustments meet least resistance.
