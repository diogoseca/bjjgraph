...
- [[Finish from Hindulotine]] - Related general finishing sequence from the same position
...
- [[Darce Control]] - Alternative submission path when finish is defended with near-side frames

- [[Anaconda Control]] - Alternative choke transition when opponent creates space during defense

- [[Back Control]] - High-percentage transition when opponent turns away to relieve choke pressure

- [[Guillotine Choke]] - Standard guillotine finish for comparison with linear versus rotational mechanics

- [[Arm Triangle]] - Alternative head-arm choke available from similar top control positions

- [[Standing Guillotine from Clinch]] - Related guillotine finishing technique from standing position
