...
---
title: "Mat Return from Rear Clinch Defender | BJJ Defense Guide | BJJ Graph"
description: "Learn to defend and counter the mat return from rear clinch in BJJ. Recognition cues, defensive options, and escape strategies for standing rear clinch takedown defense."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Defend Mat Return from Rear Clinch in BJJ",
  "description": "Step-by-step guide for defending and countering Mat Return from Rear Clinch in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Two-on-one grip strip before descent begins",
      "text": "When you feel the attacker tightening their grip and shifting hips to angle, but before the sitting descent has started If successful: Breaks the attacker's controlling grip, creating opportunity to turn and face them, separate entirely, or establish your own clinch position",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Drop base and widen stance to resist the sitting motion",
      "text": "When you recognize the hip angle change but the attacker has not yet initiated the descent, or in the first moment of the sitting motion If successful: Your lowered center of gravity and wide base make it significantly harder for the attacker to complete the sitting motion and bring you to the mat",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Turn into the attacker during the descent to establish half guard",
      "text": "When the mat return has been initiated and you cannot prevent the takedown, typically once the attacker's hips have committed to the sitting motion If successful: Instead of landing with your back to the attacker in back control, you rotate to face them and establish half guard where you have significantly more defensive and offensive options",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Post hands and sprawl hips away as descent begins",
      "text": "In the first instant of the descent before the attacker's bodyweight has fully committed to the sitting motion If successful: Sprawling your hips away and posting your hands creates enough separation to prevent the controlled descent, potentially forcing the attacker to release their grip or abandon the attempt",
      "position": 4
    }
  ],
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Mat Return from Rear Clinch Defender",
  "description": "Learn to defend and counter the mat return from rear clinch in BJJ. Recognition cues, defensive options, and escape strategies for standing rear clinch takedown defense.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Graph",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Defender",
      "item": "https://bjjgraph.org/Transitions/Mat-Return-from-Rear-Clinch/Defender"
    }
  ]
}
</script>
...
**Phase 2: Defensive Technique Practice** - Executing specific defensive responses
Practice each defensive option individually against cooperative mat return attempts. Work the two-on-one grip strip, base widening, turning during descent, and sprawl defense as separate techniques with full repetitions. Partner initiates the mat return at 50% speed allowing the defender to practice each response cleanly.

**Phase 3: Defensive Decision Making** - Choosing correct defense based on timing
Partner initiates mat returns at varying speeds and stages of commitment. Defender must read the situation and select the appropriate defensive option: grip strip if early, base widening if pre-descent, turning if committed. Develops the ability to match defensive response to the phase of the attack.

**Phase 4: Live Positional Defense** - Full resistance defensive application
Positional sparring starting from standing rear clinch. Attacker attempts mat return with full intention while defender uses all available tools to prevent the takedown or minimize positional damage. Track outcomes across rounds to identify defensive patterns that need improvement and reinforce successful defensive habits.
