...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for Triangle Clear to Side from Body Triangle/Top. Possible outcomes: Side Control (50%), Body Triangle (30%), Back Control (20%).",
  "step": [
    {
      "@type": "HowToStep",
...
## Common Mistakes
- **Mistake**: Abandoning neck defense entirely to use both hands on the triangle clearing, leaving throat completely exposed
...
- **Mistake**: Trying to pull the opponent's legs apart with raw strength rather than attacking the figure-four lock mechanism at the ankle
...
- **Mistake**: Turning away from the triangle leg side instead of toward it, increasing the effective squeeze angle
...
- **Mistake**: Pausing after breaking the triangle lock to rest instead of immediately rotating hips and establishing frames
...
- **Mistake**: Bridging straight upward instead of bridging toward the triangle leg side to create directional space for the clearing hand
...
- **Mistake**: Attempting the escape with flat hips and no bridging, relying only on hand strength to peel the ankle
...
- [[Back Escape Series]] - Related system - broader back escape framework this technique belongs to
