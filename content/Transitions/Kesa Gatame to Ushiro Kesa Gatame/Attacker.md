...
---
title: "Kesa Gatame to Ushiro Kesa Gatame Attacker | BJJ Technique Guide | BJJ Graph"
description: "How to execute the transition from Kesa Gatame to Ushiro Kesa Gatame. Step-by-step rotation mechanics, arm isolation, and pressure maintenance guide."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Execute Kesa Gatame to Ushiro Kesa Gatame in BJJ",
  "description": "Step-by-step guide for executing Kesa Gatame to Ushiro Kesa Gatame from Kesa Gatame/Top.",
  "step": [
    {
      "@type": "HowToStep",
    ...
    {
      "@type": "HowToStep",
      "name": "Consolidate Ushiro Kesa Gatame control",
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "If the bridge occurs before the midpoint, abort the transition, drop your hips, and re-establish standard Kesa Gatame. If the bridge occurs after the midpoint, use the bridge momentum to accelerate your rotation, driving your chest down harder as you complete the pivot into Ushiro Kesa Gatame. The key decision point is whether you are closer to the start or the finish of the rotation. Going backward from past the midpoint is more dangerous than completing the movement."
      }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The far arm clamp under your armpit is the highest priority grip after completing the rotation. This is the primary offensive advantage of Ushiro Kesa Gatame over standard Kesa Gatame. Squeeze your elbow tight to your ribs with the opponent's arm trapped between your armpit and their body. This single control point opens Kimura, Americana, and arm triangle pathways. Without this arm isolation secured, Ushiro Kesa Gatame offers no significant advantage over standard side control."
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Kesa Gatame to Ushiro Kesa Gatame Attacker",
  "description": "How to execute the transition from Kesa Gatame to Ushiro Kesa Gatame. Step-by-step rotation mechanics, arm isolation, and pressure maintenance guide.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Graph",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://bjjgraph.org/Transitions/Kesa-Gatame-to-Ushiro-Kesa-Gatame"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjgraph.org/Transitions/Kesa-Gatame-to-Ushiro-Kesa-Gatame/Attacker"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Kesa Gatame to Ushiro Kesa Gatame (Attacker) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Ushiro kesa gatame (reverse scarf hold)",
      "description": "Kesa Gatame to Ushiro Kesa Gatame (Attacker) film study: Ushiro kesa gatame (reverse scarf hold), taught by Kodokan instructor.",
    ...
    },
    {
      ...
      "description": "Kesa Gatame to Ushiro Kesa Gatame (Attacker) film study: 12 attacks from kesa gatame, taught by Johnny Jitsu.",
...
<p class="section-subtitle">Watch Kesa Gatame to Ushiro Kesa Gatame (Attacker) in action — curated instructionals</p>
...
<p class="section-subtitle">What are the key principles for executing Kesa Gatame to Ushiro Kesa Gatame?</p>
...
<p class="section-subtitle">What do you need before attempting Kesa Gatame to Ushiro Kesa Gatame?</p>
...
<p class="section-subtitle">How do you execute Kesa Gatame to Ushiro Kesa Gatame step by step?</p>
...
6. **Consolidate Ushiro Kesa Gatame control**: Settle your weight fully into the new position by driving your chest down and sprawling your hips back slightly. Confirm your clamp on the opponent's far arm is secure. Adjust your base by widening your posted leg if the opponent begins to bridge. Your head should be low, near the opponent's far hip. Establish your breathing and begin evaluating submission and transition options from the new orientation.
...
|--------|----------|-------------|
| Success | [[Positions/Side Control/Ushiro Kesa Gatame]] | 65% |
...
<p class="section-subtitle">How might your opponent counter Kesa Gatame to Ushiro Kesa Gatame?</p>
...
<p class="section-subtitle">What mistakes should you avoid when executing Kesa Gatame to Ushiro Kesa Gatame?</p>
...
- **Consequence**: Creates a vulnerable window where you are neither in Kesa Gatame nor Ushiro Kesa Gatame. The opponent can exploit this in-between position with bridges, frames, or guard recovery. Halfway positions have the weaknesses of both positions and the strengths of neither.
...
- **Consequence**: The opponent establishes new defensive frames against your hips and shoulders from the reverse orientation. You lose the primary offensive advantage of the transition, as arm isolation is the main reason to enter Ushiro Kesa Gatame.
...
<p class="section-subtitle">How do you train Kesa Gatame to Ushiro Kesa Gatame (Attacker)?</p>
...
With a compliant partner, execute the full transition from Kesa Gatame to Ushiro Kesa Gatame. Partner provides feedback on whether chest pressure remained constant. Perform 10 repetitions slowly, then 10 at moderate speed. Partner should report any moments where pressure decreased.
...
Start every round in Kesa Gatame. Top player must attempt the transition to Ushiro Kesa Gatame at least once per round, then follow with submission attempts or positional advances. Full resistance. Track success rate and identify which setups create the best transition opportunities. 5 rounds of 3 minutes.

**Chain Integration** - Flowing between scarf hold family positions
Practice cycling between Kesa Gatame, Ushiro Kesa Gatame, North-South, and standard Side Control in continuous flow. Partner provides full resistance. Goal is to make the rotation feel natural as part of a pressure cycling system rather than an isolated technique. 3 rounds of 5 minutes.
