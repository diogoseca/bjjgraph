...
description: "Master Overhook Escape from New York Control. Step-by-step arm extraction mechanics with timing cues. Success rates: Beginner 30%, Intermediate 50%, Advanced 65%."
---
...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for Overhook Escape from New York Control/Top. Possible outcomes: Half Guard (50%), Open Guard (15%), New York Control (25%), Triangle Control (10%).",
  "step": [
    {
      "@type": "HowToStep",
...
## Opponent Counters
- **Deepening overhook grip and pulling arm across centerline when escape is sensed** (Effectiveness: High) - Your Response: Abort extraction attempt and reset defensive base - forcing against deep grip invites submission
- **Transitioning to triangle setup by shooting leg around neck during extraction attempt** (Effectiveness: High) - Your Response: Keep chin tucked and elbow tight throughout - if triangle begins, abort and stack immediately
- **Using free hand to control your posture and prevent shoulder rotation** (Effectiveness: Medium) - Your Response: Hand fight to remove their control before attempting extraction - their free hand occupied reduces submission threats
- **Increasing leg pressure across back to destabilize base during extraction** (Effectiveness: Medium) - Your Response: Widen base further and maintain low hips - address leg pressure after arm is free
...
## Common Mistakes
- **Mistake**: Pulling arm straight backward against the overhook grip
...
- **Mistake**: Attempting extraction against fully consolidated deep overhook
...
- **Mistake**: Extending free arm to post or push during extraction
...
- **Mistake**: Stopping extraction partway through with arm still partially trapped
...
- **Mistake**: Neglecting base maintenance while focusing solely on arm extraction
...
- [[Base Widening]] - Complementary defensive technique used during escape
