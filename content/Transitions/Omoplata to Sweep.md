...
- [[Omoplata]] - Primary submission threat that creates sweep opportunity through defensive reactions

- [[Omoplata from Guard]] - Initial setup technique for establishing omoplata control before sweep

- [[Omoplata to Back]] - Alternative transition when opponent rolls aggressively and exposes back
...
- [[Armbar from Guard]] - Alternative submission from omoplata control if sweep fails
...
- [[Back Control]] - Alternative ending position if opponent rolls through aggressively

- [[Technical Mount]] - Advanced finishing position maintaining submission threats post-sweep

- [[Omoplata Control]] - Starting control position from which sweep is initiated

- [[Rolling Omoplata]] - Dynamic entry variation that combines entry with immediate sweep momentum
