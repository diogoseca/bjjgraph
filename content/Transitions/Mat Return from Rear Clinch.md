...
---
title: "Mat Return from Rear Clinch | BJJ Technique | BJJ Graph"
description: "Master the mat return from rear clinch in BJJ. Convert standing rear clinch to ground back control with 55% success using systematic takedown mechanics."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Mat Return from Rear Clinch", "item": "https://bjjgraph.org/Transitions/Mat-Return-from-Rear-Clinch" }
  ]
}
</script>
...
[[Mat Return from Rear Clinch/Attacker|→ Full Attacker Guide]]
...
- **Secure controlling grip**: Lock your hands in either a bodylock configuration around the opponent's waist or a seatbelt grip wi...

- **Establish hip angle**: Step your hips to your preferred side at roughly a 45-degree angle behind the opponent. Your lead hi...

- **Compromise opponent's base**: Drive your chest pressure forward and downward into the opponent's upper back, forcing them to bend ...

- **Initiate controlled descent**: Sit your hips to the mat on your angled side in a controlled sitting motion, not a drop or fall. You...

- **Thread hooks during descent**: As you and the opponent descend toward the mat, immediately begin threading your inside leg between ...

- **Control the landing**: Land on your side or slightly on your back with the opponent's back against your chest. Absorb the l...

- **Establish ground back control**: Once grounded, immediately tighten all control points. Drive both hooks deep inside the opponent's t...


### Common Mistakes


- **Dropping straight down behind the opponent instead of sitting to an angle**
...
- **Releasing grip during the descent to post hands on the mat for balance**
...
- **Waiting until fully grounded to insert hooks**
...
[[Mat Return from Rear Clinch/Defender|→ Full Defender Guide]]
...
- **Two-on-one grip strip before descent begins** - When: When you feel the attacker tightening their grip and shifting hips to angle, but before the sitting descent has started

- **Drop base and widen stance to resist the sitting motion** - When: When you recognize the hip angle change but the attacker has not yet initiated the descent, or in the first moment of the sitting motion

- **Turn into the attacker during the descent to establish half guard** - When: When the mat return has been initiated and you cannot prevent the takedown, typically once the attacker's hips have committed to the sitting motion
...
**Bodylock Mat Return**: Uses a clasped bodylock around the opponent's waist with both arms encircling the midsection. The attacker sits their hips to the side and drives the opponent diagonally to the mat, landing in back control. The bodylock provides maximum hip-to-hip connection and prevents the opponent from creating upper body separation during the descent. (When to use: When you have secured a tight bodylock from the standing rear clinch and the opponent's hands are fighting low near your clasped hands rather than defending their neck or upper body.)


**Seatbelt Mat Return**: Executed with a seatbelt grip where one arm passes over the shoulder and the other under the armpit, hands clasped at the opponent's chest. The attacker uses the seatbelt to control the opponent's upper body posture while stepping to one side and sitting through to bring them to the mat. This variation offers immediate submission threat upon landing. (When to use: When you have established seatbelt control and want to maintain upper body dominance for immediate choke access upon grounding. Preferred when the opponent is defending the bodylock by peeling hands.)


**Ankle Pick Mat Return**: The attacker releases one hand from the clinch grip to reach down and pick the opponent's far ankle while driving them forward and to the side. This trips the opponent over their own base while the remaining arm maintains upper body control. Requires precise timing to prevent separation during the grip change. (When to use: When the opponent is stalling with a wide base that resists standard mat return attempts, or when they are postured upright making it difficult to sit through for the standard descent.)


**Suplex-Style Mat Return**: A more explosive variation where the attacker arches backward while lifting the opponent's hips, rotating them over the attacker's hip before landing in back control. This bypasses the opponent's base entirely through elevation and rotation rather than directional driving force. (When to use: When the opponent has a very strong base and resists standard driving mat returns, or in competition settings where explosive techniques score higher and the risk of brief separation is acceptable.)
