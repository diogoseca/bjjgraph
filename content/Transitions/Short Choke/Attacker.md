...
---
title: "Short Choke Attacker | BJJ Technique Guide | BJJ Graph"
description: "How to execute Short Choke in BJJ. Attacking perspective with setup, execution steps, and counters."
---
...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for executing Short Choke from Body Triangle/Bottom.",
  "step": [
    {
      "@type": "HowToStep",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjgraph.org/Transitions/Short-Choke/Attacker"
    }
  ]
}
</script>
...
### 1. Gripping collar too shallow near the shoulder rather than deep behind the neck
...
### 2. Positioning forearm across windpipe instead of side of neck targeting carotid
...
### 3. Releasing body triangle pressure while focusing on upper body choke
...
### 4. Pulling collar straight back rather than driving elbow down toward hip
...
### 5. Neglecting to control opponent's defending hands before finishing
