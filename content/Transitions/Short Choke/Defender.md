...
---
title: "Short Choke Defender | BJJ Defense Guide | BJJ Graph"
description: "How to defend against Short Choke in BJJ. Recognition cues, defensive options, and escape strategies."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Defend Short Choke in BJJ",
  "description": "Step-by-step guide for defending and countering Short Choke in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Two-on-one grip strip on the collar hand - use both hands to peel the attacker's fingers out of your collar by attacking the thumb and peeling the grip toward your chest away from the back of your neck",
      "text": "Immediately when you feel fingers entering your collar, before the grip is fully established and the forearm blade is positioned across your neck If successful: Returns you to body triangle position without active choke threat, forcing attacker to re-establish collar access while you reset your defensive posture",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Turn into the choking arm by rotating your shoulders and hips toward the side of the attacking forearm, reducing the cross-neck pressure angle while creating space to work your chin under the forearm",
      "text": "When the collar grip is already established and forearm pressure is building across your neck but the choke is not yet fully cinched If successful: Reduces choke effectiveness significantly by changing the pressure angle, and the turning motion can loosen the body triangle enough to transition to standard back control escape sequences",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Frame on the choking arm's elbow with both hands to prevent the downward elbow drive that creates the finishing pressure, wedging your hands between their forearm and your neck to create a barrier",
      "text": "When the choke is being actively applied and you need to prevent the finish while buying time for a positional escape If successful: Stalls the choke finish and creates a defensive standoff where attacker must adjust their mechanics, giving you time to work on turning or grip stripping",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Bridge explosively toward the choking arm side while simultaneously stripping the collar grip, using the hip thrust to create momentary space and disrupt the attacker's chest-to-back connection",
      "text": "As a last-resort defense when the choke is nearly locked and incremental defenses have failed, requiring an explosive escape attempt If successful: Disrupts the choke mechanics through positional displacement, potentially breaking the body triangle lock and creating enough space to begin full back escape sequence",
      "position": 4
    }
  ],
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the most critical moment to begin defending the Short Choke?",
      "acceptedAnswer": {
        "@type": "Answer",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "Short Choke",
      "item": "https://bjjgraph.org/Transitions/Short-Choke"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Defender",
      "item": "https://bjjgraph.org/Transitions/Short-Choke/Defender"
    }
  ]
}
</script>
...
### 1. Pulling the choking forearm away from your neck by grabbing the wrist and pulling forward rather than attacking the collar grip itself

- **Consequence**: The collar grip anchors the forearm in position regardless of pulling force, so you waste energy fighting the symptom rather than the cause while the choke continues tightening
- **Correction**: Attack the source of the choke by stripping the collar grip behind your neck using two-on-one technique on the gripping hand, peeling fingers out of the collar fabric

### 2. Panicking and using both hands to fight the body triangle while neglecting neck defense entirely

- **Consequence**: Leaves your neck completely exposed, allowing the attacker to establish the deep collar grip unopposed and finish the choke while you ineffectively fight the leg lock
- **Correction**: Always keep at least one hand defending your neck. The body triangle is uncomfortable but not immediately finishing - the collar choke is the lethal threat that requires priority defense

### 3. Turning away from the choking arm rather than toward it, which increases the cross-neck pressure angle

- **Consequence**: Exposes more of your neck surface area to the forearm blade and gives the attacker a better angle for the elbow drive, accelerating the choke finish
- **Correction**: Always turn toward the choking arm to reduce the pressure angle across your neck and begin disrupting the attacker's mechanical advantage

### 4. Holding breath and tensing neck muscles to resist the choke rather than working technically to escape

- **Consequence**: Rapidly depletes oxygen reserves that are already limited by body triangle compression, leading to faster unconsciousness and wasted defensive energy
- **Correction**: Maintain controlled breathing through your chest while using technical defenses like grip stripping and turning rather than muscular resistance against the choke pressure

### 5. Waiting too long to begin defensive action, only reacting once the choke is fully locked and the elbow drive has started

- **Consequence**: Once the deep collar grip is set and the elbow is driving down, defensive success probability drops dramatically as the blood choke can finish within seconds
- **Correction**: React immediately to the first recognition cue - fingers entering your collar. Early intervention at the grip establishment phase has the highest success rate for defense
...
Partner establishes body triangle and slowly works toward collar grip at 30% speed. Practice identifying the recognition cues and immediately fighting the grip entry with two-on-one defense. Focus on reaction time and proper hand placement for collar grip stripping. Reset each time partner achieves deep grip.

**Week 3-4** - Defensive options under moderate pressure
Partner applies Short Choke at 50% intensity with established grip. Practice all four defensive options: grip stripping, turning into choking arm, elbow framing, and bridge escape. Work on chaining these defenses together when the first option fails. Partner allows successful defense but maintains realistic pressure.

**Week 5-6** - Breathing management and composure
Partner maintains full body triangle squeeze while working Short Choke entries at 70% intensity. Focus on managing breathing under compression while executing technical defenses. Build tolerance for working under restricted breathing without panicking. Extend rounds progressively from 1 to 3 minutes.

**Week 7+** - Live defense and escape chaining
Defend Short Choke attempts in live sparring starting from body triangle position. Partner uses full speed and combination attacks cycling between RNC and Short Choke. Practice reading which attack is coming and selecting appropriate defense. Work on escaping body triangle entirely after neutralizing choke threat.
...
**Q1**: What is the most critical moment to begin defending the Short Choke?
**A**: The most critical moment is during grip establishment, when you first feel the attacker's fingers walking into your collar behind your neck. Defending at this stage is far more effective than trying to strip a fully established deep collar grip. Once the grip is set and forearm blade positioned, finishing mechanics are very difficult to counter.

**Q2**: Why should you turn toward the choking arm rather than away from it when defending?
**A**: Turning toward the choking arm reduces the cross-neck pressure angle by bringing your neck closer to the attacker's shoulder, which shortens the lever arm of the forearm blade across your neck. Turning away increases the exposed surface area and actually gives the attacker a better angle for the elbow drive that creates the finishing pressure.

**Q3**: Your attacker has established a deep collar grip and is beginning the elbow drive - what is your defensive priority sequence?
**A**: First, frame on the choking elbow with both hands to stall the finish and prevent the elbow from driving further toward their hip. Second, simultaneously begin turning your body toward the choking arm to reduce pressure angle. Third, use the space created by turning to attack the collar grip with two-on-one technique. The goal is to survive the immediate threat while working toward grip removal.

**Q4**: How does the body triangle complicate your defense compared to defending chokes from standard back control with hooks?
**A**: The body triangle restricts your breathing through ribcage compression, giving you less oxygen to work with during defense. It also severely limits hip mobility, preventing the hip escape movements that are central to most back control escapes. You cannot simply clear hooks and turn - you must either strip the choke and accept the triangle, or disrupt the triangle through turning and bridging before executing standard escape sequences.

**Q5**: Your attacker strips your defending hand and pins it to your chest while applying the Short Choke - how do you respond?
**A**: Immediately use your free hand to frame against their choking elbow while tucking your chin as deeply as possible. Simultaneously bridge hard toward the choking arm side to create space and disrupt their control of your pinned hand. The bridge should create enough displacement to free your trapped hand, at which point immediately resume two-on-one defense on the collar grip before they can re-establish hand control.
