...
---
title: "Cross Collar Choke | BJJ Technique | BJJ Graph"
description: "Master the Cross Collar Choke from High Mount. Step-by-step gi choke execution with grip sequences. Success rates: Beginner 30%, Intermediate 50%, Advanced 65%."
---
...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for Cross Collar Choke from High Mount/Top. Possible outcomes: Game Over (65%), High Mount (25%), Closed Guard (10%).",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Establish first grip",
      "text": "With your dominant hand, reach across to the opposite side collar. Insert your thumb inside the collar as deep as possible, ideally behind the neck seam, with your knuckles pressing firmly against the side of the neck below the ear.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Secure head control",
      "text": "Use your gripping arm's elbow to control the opponent's head, preventing them from turning away or creating defensive angles. Your forearm should rest against the side of their face, keeping their head centered and immobile.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Clear defensive hands",
      "text": "Use your free hand to strip any defensive grips the opponent establishes on your choking arm. Push their defending hand toward their hip or pin it under your knee if possible, creating space for the second grip entry.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Insert second grip",
      "text": "Slide your second hand under your first arm, reaching to the opposite collar with thumb inside. The second grip should be equally deep, with knuckles positioned against the other side of the neck. Your arms now form an X across the throat.",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Position elbows",
      "text": "Draw both elbows down toward the opponent's hips while keeping your hands in place. This creates the scissoring action essential for the choke. Your forearms should now be pressing against both sides of the neck, not the front of the throat.",
      "position": 5
    },
    {
      "@type": "HowToStep",
      "name": "Apply finishing pressure",
      "text": "Rotate your wrists inward while pulling your elbows toward each other and down toward your own hips. Lower your chest toward the opponent's face to add upper body weight to the choke. Maintain steady, increasing pressure until the tap or unconsciousness occurs.",
      "position": 6
    }
  ],
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the primary goal of Cross Collar Choke?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The primary goal is to apply bilateral compression to both carotid arteries simultaneously, restricting blood flow to the brain and causing unconsciousness within seconds. This blood choke is distinct from airway chokes and works by creating a scissoring action with crossed grips on the collar rather than crushing the windpipe."
      }
    },
    {
      "@type": "Question",
      "name": "What position do you start Cross Collar Choke from?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "This technique starts from High Mount Top position, where your knees are positioned near the opponent's armpits or shoulders. This elevated position provides optimal collar access while limiting the opponent's defensive options and bridging power."
      }
    },
    {
      "@type": "Question",
      "name": "What are the key grips needed for Cross Collar Choke?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Two deep collar grips with thumbs inside the collar are required. The first grip reaches across to the opposite collar with knuckles pressing against the carotid below the ear. The second grip threads under the first arm to the other collar, creating the essential X-pattern across the throat that enables the scissoring mechanism for bilateral arterial compression."
      }
    },
    {
      "@type": "Question",
      "name": "How do you counter Cross Collar Choke?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Primary defenses include two-on-one grip fighting to strip the first grip before the second is established, bridging during grip transitions to create escape opportunity, and tucking the chin to prevent deep collar access. Once both grips are established, defense becomes extremely difficult, making early intervention essential."
      }
    },
    {
      "@type": "Question",
      "name": "When is the best time to attempt Cross Collar Choke?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The optimal time is when the opponent's hands are occupied or pinned, such as after they fail a bridge attempt or when you've trapped one arm under your knee. Attacking during their defensive recovery windows, when their hands are transitioning between defensive positions, also provides grip establishment opportunities."
      }
    },
    {
      "@type": "Question",
      "name": "Your opponent frames on your biceps as you try to drive elbows down - how do you adjust?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "If both grips are already established deep in the collar, their bicep frames cannot prevent the scissoring action. Drop your chest low toward their face to add body weight, then focus on rotating your wrists inward while pulling elbows toward each other rather than straight down. The scissoring comes from the wrist rotation combined with elbow adduction, not purely downward elbow movement."
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 3, "name": "Cross Collar Choke", "item": "https://bjjgraph.org/Transitions/Cross-Collar-Choke"}
  ]
}
</script>
...
## Opponent Counters
- **Two-on-one grip fighting on the first hand** (Effectiveness: High) - Your Response: Maintain elbow pressure against their head to prevent stripping, or switch to armbar attack on their extended defending arm
- **Bridge and roll escape attempt during grip establishment** (Effectiveness: Medium) - Your Response: Base out with your free hand, ride the bridge, and continue pursuing grips once they settle. Their bridge commits their hips, preventing effective grip defense
- **Tucking chin to block collar access** (Effectiveness: Medium) - Your Response: Use cross-face pressure to turn their head, creating space for grip entry, or threaten Ezekiel choke to force chin elevation
- **Framing on biceps to prevent elbow movement** (Effectiveness: Low) - Your Response: Once both grips are established, their frames cannot prevent the scissoring action. Ignore the frames and apply finishing pressure
...
## Common Mistakes
- **Mistake**: Gripping too shallow on the collar, near the chest rather than deep behind the neck
...
- **Mistake**: Placing second grip on top of rather than under the first arm
...
- **Mistake**: Sitting upright during the choke attempt instead of maintaining forward pressure
...
- **Mistake**: Flaring elbows outward instead of driving them down toward the hips
...
- **Mistake**: Rushing to establish the second grip before securing the first grip position
...
- **Mistake**: Releasing pressure when opponent begins tapping or appears close to unconsciousness
...
## Variations
**Palm-Up Palm-Down Variation**: First grip uses palm-up position (four fingers inside collar) while second grip uses standard palm-down. Creates different angle of pressure that some practitioners find more effective against thick necks. (When to use: When opponent has thick neck or muscular trap development that limits traditional grip effectiveness)

**Loop Choke Style Entry**: Rather than establishing both grips separately, feed one lapel across and grip both sides with one hand initially, then establish second grip. Faster setup but requires specific collar configuration. (When to use: When opponent's collar is loose and you have opportunity for rapid grip establishment)

**Cross Collar from Closed Guard**: Same grip mechanics applied from bottom closed guard position. Requires breaking opponent's posture first and benefits from leg involvement to prevent posture recovery. (When to use: When opponent posts hands on your chest in closed guard, exposing their collar)
...
## Test Your Knowledge
**Q1**: What is the primary goal of Cross Collar Choke?
**A**: The primary goal is to apply bilateral compression to both carotid arteries simultaneously, restricting blood flow to the brain and causing unconsciousness within seconds. This blood choke is distinct from airway chokes and works by creating a scissoring action with crossed grips on the collar rather than crushing the windpipe.

**Q2**: What position do you start Cross Collar Choke from?
**A**: This technique starts from High Mount Top position, where your knees are positioned near the opponent's armpits or shoulders. This elevated position provides optimal collar access while limiting the opponent's defensive options and bridging power.

**Q3**: What are the key grips needed for Cross Collar Choke?
**A**: Two deep collar grips with thumbs inside the collar are required. The first grip reaches across to the opposite collar with knuckles pressing against the carotid below the ear. The second grip threads under the first arm to the other collar, creating the essential X-pattern across the throat that enables the scissoring mechanism for bilateral arterial compression.

**Q4**: How do you counter Cross Collar Choke?
**A**: Primary defenses include two-on-one grip fighting to strip the first grip before the second is established, bridging during grip transitions to create escape opportunity, and tucking the chin to prevent deep collar access. Once both grips are established, defense becomes extremely difficult, making early intervention essential.

**Q5**: When is the best time to attempt Cross Collar Choke?
**A**: The optimal time is when the opponent's hands are occupied or pinned, such as after they fail a bridge attempt or when you've trapped one arm under your knee. Attacking during their defensive recovery windows, when their hands are transitioning between defensive positions, also provides grip establishment opportunities.

**Q6**: Your opponent frames on your biceps as you try to drive elbows down - how do you adjust?
**A**: If both grips are already established deep in the collar, their bicep frames cannot prevent the scissoring action. Drop your chest low toward their face to add body weight, then focus on rotating your wrists inward while pulling elbows toward each other rather than straight down. The scissoring comes from the wrist rotation combined with elbow adduction, not purely downward elbow movement.

**Q7**: What distinguishes a blood choke from an airway choke in Cross Collar technique?
**A**: A blood choke compresses the carotid arteries on the sides of the neck, causing unconsciousness in 6-10 seconds. An airway choke crushes the windpipe, which is painful but takes much longer to cause submission. The Cross Collar Choke is properly applied as a blood choke—elbows driving down toward the hips creates lateral pressure on arteries, while flared elbows create frontal pressure on the airway.

**Q8**: Your opponent defends by grip fighting your first hand with both their hands - what attack does this open?
...
**Q9**: Why must the second grip go under rather than over the first arm?
**A**: The under-position creates the scissoring mechanism essential for bilateral carotid compression. When arms cross with the second underneath, driving elbows down creates opposing diagonal forces that squeeze inward on both sides of the neck. If the second grip goes over, both arms push in the same direction, eliminating the scissoring effect and reducing the choke to ineffective frontal pressure.

**Q10**: How does the Cross Collar Choke integrate with other high mount attacks?
**A**: The Cross Collar Choke creates a submission chain where defending the choke exposes armbar opportunities, and defending the armbar re-exposes the collar. Combined with Ezekiel Choke and Americana threats, the Cross Collar Choke is part of the high mount submission web that forces opponents to choose which attack to defend, inevitably leaving another attack open.
...
- [[High Mount]] - Starting position
- [[Armbar from Mount]] - Chain attack when opponent defends collar with extended arms
- [[Ezekiel from Mount]] - Alternative attack when opponent tucks chin to defend collar
- [[Americana from Mount]] - Alternative attack when opponent keeps arms bent and tight
- [[S Mount]] - Positional advancement option if choke fails and opponent turns
- [[Mount]] - Parent position from which high mount is established
- [[Technical Mount]] - Alternative mount variation for continued attacks
- [[Triangle from Mount]] - Alternative submission when opponent pushes on hips with both hands
