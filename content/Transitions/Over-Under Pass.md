...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "What should you do if the opponent successfully frames against your neck during the stack?",
      "acceptedAnswer": {
        "@type": "Answer",
...
**Q4**: What should you do if the opponent successfully frames against your neck during the stack?
...
**Q6**: How does the Over-Under Pass exemplify the principle of position over submission in BJJ?
**A**: The Over-Under Pass demonstrates position-over-submission by prioritizing the establishment of dominant side control rather than rushing for submissions. By methodically advancing position through superior control and pressure, you create a more sustainable attack platform. This pass teaches patience under pressure, systematic advancement, and the value of controlling the opponent's movement before hunting submissions. The completed pass to side control opens numerous high-percentage submission opportunities from a position of complete dominance.
...
- [[Double Under Pass]] - Variation - Uses two under-hooks instead of one over and one under
- [[Knee Slice Pass]] - Combination - Natural follow-up when opponent defends the over-under circulation
- [[Smash Pass]] - Related technique - Similar pressure principles with different grip configuration
- [[Leg Weave Pass]] - Advanced progression - More complex pass using similar hip control concepts
- [[Stack Pass]] - Related technique - Uses similar stacking mechanics from different guard positions
- [[Headquarters Position]] - Transitional position - Can be used as entry or exit for over-under passing
- [[Kimura from Half Guard]] - Submission threat - Can be attacked during the over-under pass setup
- [[Darce Choke]] - Submission opportunity - Available if opponent turns away during the pass
- [[Back Control]] - Alternative finish - Can be achieved if opponent turns away from pressure
- [[Turtle]] - Transition opportunity - Common defensive response that opens back-take attacks
