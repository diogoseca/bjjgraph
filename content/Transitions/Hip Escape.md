...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for Hip Escape from Side Control/Bottom. Possible outcomes: Half Guard (55%), Closed Guard (15%), Side Control (20%), Mount (10%).",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Establish frames",
      "text": "Create strong frames using forearms and hands against opponent's hips, shoulders, or neck. Keep elbows tight to body while extending frames to create maximum structural integrity. Frame placement depends on opponent's position - typically one frame on hip and one on shoulder or neck.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Bridge and turn",
      "text": "Drive hips explosively upward and slightly toward the direction you want to escape, using legs and core power. Simultaneously turn shoulders and upper body onto your side, creating a wedge shape with your body. This bridge momentarily disrupts opponent's base and creates the initial space needed.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Slide hips away",
      "text": "As you bridge and turn, forcefully slide your hips away from opponent in the direction opposite their pressure. Push off the mat with your outside foot (the foot furthest from opponent) while dragging the inside leg. The movement should trace your hips along the mat in a 'shrimping' motion, creating 6-12 inches of distance.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Maintain frames",
      "text": "Throughout the hip movement, maintain or re-establish strong frames to prevent opponent from following and closing the distance you've created. Frames must be dynamic - extending when space is created, tucking when opponent applies pressure, but always maintaining structural integrity to prevent being crushed.",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Insert knee shield",
      "text": "As space is created, immediately bring your inside knee (knee closest to opponent) up and across to create a knee shield barrier between you and opponent. The knee should target opponent's hip or torso, with your shin creating a horizontal barrier. This prevents opponent from immediately reclosing distance and pressuring back into the pin.",
      "position": 5
    },
    {
      "@type": "HowToStep",
      "name": "Recover guard position",
      "text": "Use the knee shield and frames to continue creating distance while bringing your outside leg around to establish full guard, half guard, or butterfly hooks. Maintain active pressure with frames and legs to keep opponent at bay while transitioning from defensive escape to guard position. Get your shoulders square to opponent and hips mobile for guard retention.",
      "position": 6
    }
  ],
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Why is establishing frames critical before executing the hip escape movement?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Frames create the structural barrier that maintains the space you create with your hip movement. Without frames, your opponent can simply follow your hips as you move, negating any space created. Strong frames on the opponent's hips, shoulders, or neck prevent them from closing distance and allow you to maintain the separation needed to insert your knee shield or recover guard position."
      }
    },
    {
      "@type": "Question",
      "name": "What is the proper sequence of movements in a basic hip escape?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The proper sequence is: 1) Establish strong frames, 2) Bridge hips upward and turn onto your side, 3) Slide hips away from opponent while maintaining frames, 4) Insert knee shield in the created space, 5) Recover to guard position. The bridge-turn-shrimp should flow as one continuous explosive movement, not separate distinct steps."
      }
    },
    {
      "@type": "Question",
      "name": "How should you respond when your initial hip escape fails to create enough space?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "When would you choose a reverse shrimp toward the opponent instead of standard shrimp away?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Reverse shrimps are advanced techniques used when opponent heavily commits to preventing standard escape direction, creating opportunities for alternative guards like deep half or single leg X. They create unexpected angles that opponents aren't defending against. This requires sophisticated timing and understanding of positional entries. Also useful when you want to access underhooks or leg entanglements rather than simply creating separation."
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 3, "name": "Hip Escape", "item": "https://bjjgraph.org/Transitions/Hip-Escape"}
  ]
}
</script>
...
**Q2**: What is the proper sequence of movements in a basic hip escape?
**A**: The proper sequence is: 1) Establish strong frames, 2) Bridge hips upward and turn onto your side, 3) Slide hips away from opponent while maintaining frames, 4) Insert knee shield in the created space, 5) Recover to guard position. The bridge-turn-shrimp should flow as one continuous explosive movement, not separate distinct steps.

**Q3**: How should you respond when your initial hip escape fails to create enough space?
**A**: Chain multiple shrimps together, creating cumulative distance. After each shrimp, quickly re-establish frames and execute another explosive hip escape before opponent can fully settle their weight. You may also change directions on subsequent shrimps to confuse opponent's following pressure. Three to five consecutive shrimps can create significant space even against skilled opponents.

**Q4**: What timing considerations are most important for successful hip escapes?
**A**: Execute escapes when opponent's weight is shifting, they're reaching for submissions, or adjusting their position. These moments create temporary reductions in pressure and compromises in their base. Avoid escaping when opponent's weight is fully settled and their base is most stable. Develop sensitivity to weight distribution by training with progressive resistance and paying attention to subtle shifts in pressure.

**Q5**: How does the hip escape from mount differ from the hip escape from side control?
**A**: Mount escapes require a higher, more explosive bridge directed toward opponent's head, creating space to slide hips out from under their legs. The escape angle is more toward opponent's centerline rather than purely lateral. From side control, the bridge is more lateral and the shrimp creates space to the side. Mount escapes also typically require more precise timing with opponent's posting or weight shifts, as mount provides more control and attacking options.

**Q6**: When would you choose a reverse shrimp toward the opponent instead of standard shrimp away?
...
**Q7**: What role does body rotation play in effective hip escapes?
**A**: Turning your shoulders and upper body onto your side is essential for creating the proper wedge shape that allows maximum hip mobility. Remaining flat on your back severely limits how far you can move your hips and prevents you from creating the angles needed for guard recovery. The rotation also helps generate power for the movement by engaging your core and allowing you to push more effectively off your outside foot.

**Q8**: Your opponent posts their hand on the mat during your hip escape attempt - how do you capitalize on this?
**A**: When opponent posts their hand, their weight shifts to that side and their base becomes compromised. Immediately accelerate your hip escape in the opposite direction of their post, as they cannot follow effectively. This creates a larger window for guard recovery. Alternatively, if they post toward you, use the momentary space to insert your knee shield or switch to a technical standup since their weight is committed away from blocking your rise.

**Q9**: What grip requirements must be met before initiating an explosive hip escape?
**A**: Before initiating the escape, establish at least one strong frame - typically forearm against opponent's hip line or shoulder/neck area. Your hands should not grip the opponent but rather create structural barriers with open palms or forearms. Avoid grabbing opponent's sleeve or lapel as this limits your ability to create distance. The frame must be rigid enough to prevent opponent from collapsing their weight through it when you create movement.

**Q10**: What is the critical direction of force application during the shrimping motion?
**A**: The primary force direction is lateral and away from opponent, not straight backward. Push off the mat with your outside foot driving force at approximately 45 degrees away from your opponent's centerline. Your hips should trace along the mat surface rather than lifting upward. The bridge provides vertical displacement to create initial space, but the shrimp itself is predominantly a horizontal sliding motion that maximizes distance from opponent's control.

**Q11**: What should you do if opponent threatens a kimura as you attempt to hip escape?
**A**: Immediately prioritize arm defense by keeping your elbow tight to your body and turning your thumb toward the ceiling to prevent the rotation needed for the kimura finish. Use your free hand to control their wrist grip while maintaining your frame with your shoulder and upper arm. Once you've neutralized the immediate submission threat, continue the escape sequence but with heightened awareness of arm positioning. Do not sacrifice arm position for escape distance.

**Q12**: How do you identify the optimal timing window for initiating your hip escape?
**A**: The optimal window occurs when opponent's weight distribution shifts - typically when they reach for a submission, adjust their position, switch their hip angle, or respond to your initial frame. Feel for moments when their chest pressure lightens or their hips lift. You can create these windows by threatening movements that force reactions, such as pushing their head or appearing to escape in one direction before going the other. The escape should be immediate and explosive once you detect the opening.
...
- [[Elbow Escape]] - Alternative name - same core technique with emphasis on elbow positioning
- [[Frame and Shrimp]] - Direct technical relationship - combines framing concepts with shrimp movement
- [[Bridge and Roll]] - Complementary escape - often combined with hip escape
- [[Guard Recovery]] - Follow-up technique - guard recovery after creating space with hip escape
- [[Knee Shield Half Guard]] - Follow-up position - knee shield established in space created by hip escape
- [[Ghost Escape]] - Advanced variation - similar hip movement principles with different angle
- [[Granby Roll to Guard]] - Alternative escape - different movement pattern for similar guard recovery goal
- [[Half Guard]] - Primary recovery target - most common guard recovered after successful hip escape
- [[Closed Guard]] - Advanced recovery target - full guard recovery when sufficient space created
- [[Deep Half Guard]] - Alternative entry - reverse shrimp can create deep half entry opportunity
- [[Side Control]] - Starting position - hip escape is primary escape from side control bottom
- [[Mount]] - Alternative starting position - hip escape variant used to escape mount
- [[Elbow Escape to Guard]] - Complete escape sequence - hip escape leading to full guard recovery
