...
---
title: "Electric Chair from Electric Chair | BJJ Technique | BJJ Graph"
...
| **Key Principles** | Maintain constant lockdown tension throughout the entire fin... | Recognize the transition from Electric Chair control to fini... |
...
- [[Positions/Half Guard/Electric Chair]] - Source position from which this submission finish is executed

- [[Positions/Half Guard/Lockdown]] - Parent position system that enables the Electric Chair entry and control

- [[Submissions/Banana Split]] - Mechanically similar groin-splitting submission with different entry and control points

- [[Positions/Half Guard]] - Base guard system from which the lockdown and Electric Chair develop

- [[Positions/Twister Control/Truck]] - Alternative transition when opponent defends the finish by turning away

- [[Positions/Half Guard/Deep Half Guard]] - Fallback transition when lockdown is compromised during finish attempt

- [[Positions/Half Guard/Old School]] - Primary sweep alternative that creates the sweep-or-submit dilemma with this finish

- [[Positions/Dogfight Position]] - Transition option when underhook is retained but lockdown breaks during the attempt
