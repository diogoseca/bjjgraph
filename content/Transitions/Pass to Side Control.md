...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for Pass to Side Control from 50-50 Guard/Top. Possible outcomes: Side Control (65%), 50-50 Guard (25%), 50-50 Guard (10%).",
  "step": [
    {
      "@type": "HowToStep",
...
## Opponent Counters
- **Re-capturing legs by hooking your extracting leg before it clears** (Effectiveness: High) - Your Response: If opponent begins to re-hook, immediately return to chest pressure and restart grip fighting sequence. Do not force extraction against active leg defense.
- **Hip escape and knee insertion during transition to recover half guard** (Effectiveness: Medium) - Your Response: Keep constant forward pressure and use your knee on their hip to block insertion. If they start hip escaping, accelerate your pass to beat their recovery timing.
- **Sitting up during extraction to reach for leg attacks on your partially cleared leg** (Effectiveness: Medium) - Your Response: Drive crossface aggressively to flatten them. Your chest weight should prevent sit-up; if they manage to rise, abort pass and re-establish 50-50 top pressure.
...
## Common Mistakes
- **Mistake**: Attempting to extract legs without first breaking opponent's grip control
...
- **Mistake**: Lifting hips high during extraction instead of maintaining constant pressure
...
- **Mistake**: Extracting both legs simultaneously leaving torso unsupported
...
- **Mistake**: Neglecting crossface establishment after legs clear
...
- **Mistake**: Passing to the wrong side relative to opponent's body position
