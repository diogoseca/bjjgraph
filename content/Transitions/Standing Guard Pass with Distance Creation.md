...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for Standing Guard Pass with Distance Creation from Ringworm Guard/Top. Possible outcomes: Side Control (55%), Headquarters Position (10%), Ringworm Guard (20%), Open Guard (5%), Back Control (10%).",
  "step": [
    {
      "@type": "HowToStep",
...
## Common Mistakes
- **Mistake**: Attempting to stand while leaning forward with weight over the trapped leg
...
- **Mistake**: Using only one hand to strip the lapel while keeping the other hand on sleeve or collar control
...
- **Mistake**: Initiating a passing motion before the lapel is fully cleared from the leg
...
- **Mistake**: Standing straight up without controlling the opponent's ability to follow with leg hooks
...
- **Mistake**: Pausing after clearing the lapel instead of immediately transitioning to passing grips
...
- **Mistake**: Turning sideways or exposing your back during the circling extraction phase
...
- [[Stack Pass with Lapel Control Negation]] - Alternative technique - pressure-based approach to passing Ringworm Guard without standing
- [[Smash Pass Counter]] - Alternative technique - smash pass approach to defeating lapel guard configurations
...
- [[Ringworm Sweep to Back Control]] - Counter threat - the primary sweep danger during the standing extraction phase
