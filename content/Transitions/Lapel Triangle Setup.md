...
description: "Master the Lapel Triangle Setup from Lapel Guard. Use lapel control to isolate the arm and create triangle entry. Success rates: Beginner 30%, Intermediate 50%, Advanced 65%."
---
...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for Lapel Triangle Setup from Lapel Guard/Bottom. Possible outcomes: Triangle Control (55%), Lapel Guard (30%), Half Guard (15%).",
  "step": [
    {
      "@type": "HowToStep",
...
## Opponent Counters
- **Posture immediately when triangle threat is recognized, stacking weight forward to prevent hip movement** (Effectiveness: High) - Your Response: Use their forward stack momentum to elevate hips higher—their pressure aids your triangle entry. Alternatively, transition to omoplata as stacking opens that angle.
- **Strip lapel grip before triangle leg can swing over, removing the arm isolation mechanism** (Effectiveness: High) - Your Response: Transition immediately to spider or lasso guard using the freed fabric. The grip break opens traditional guard options while you retain leg engagement.
- **Circle toward the trapped arm side to change angle and relieve lapel pressure** (Effectiveness: Medium) - Your Response: Follow their rotation with your hips, using their movement to load a sweep. Their circling actually helps establish the perpendicular angle you need.
- **Drive knee through the middle to split the guard and prevent leg from swinging over** (Effectiveness: Medium) - Your Response: Use the knee drive to off-balance them forward, then pummel your leg inside their knee to re-establish guard. Their forward commitment opens back take opportunities.
...
## Common Mistakes
- **Mistake**: Attempting triangle entry without first creating perpendicular hip angle
...
- **Mistake**: Releasing lapel grip too early before triangle lock is secured
...
- **Mistake**: Swinging leg over shoulder while opponent maintains good posture
...
- **Mistake**: Using the wrong leg for the triangle based on which arm is trapped
...
- **Mistake**: Telegraphing the triangle by looking at opponent's shoulder or reaching for their head prematurely
...
- **Mistake**: Failing to maintain tension on lapel throughout the setup
