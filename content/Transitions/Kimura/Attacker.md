...
---
title: "Kimura Attacker | BJJ Technique Guide | BJJ Graph"
description: "How to execute Kimura in BJJ. Attacking perspective with setup, execution steps, and counters."
---
...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for executing Kimura from Crucifix/Top.",
  "step": [
    {
      "@type": "HowToStep",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjgraph.org/Transitions/Kimura/Attacker"
    }
  ]
}
</script>
...
### 1. Releasing leg control on the trapped arm to focus on the Kimura
...
### 2. Allowing the elbow to float away from your body during the attack
...
### 3. Applying lifting force instead of rotational force
...
### 4. Attempting the Kimura before securing proper figure-four grip
...
### 5. Rushing the finish without controlling the opponent's ability to roll
