...
---
title: "Kuzure Kesa Gatame to Mount Attacker | BJJ Technique Guide | BJJ Graph"
description: "Learn to execute the Modified Kesa Gatame to Mount transition. Step-by-step weight transfer mechanics, crossface control, and timing to secure the highest-scoring position in BJJ."
---
...
<script type="application/ld+json">
{
  ...
  "step": [
    ...
    },
    {
      ...
      "text": "Transition your grips from Kuzure Kesa Gatame configuration to mount control position. Grapevine the legs or post feet wide depending on the opponent's immediate escape attempts. Establish heavy hip pressure and begin reading their defensive posture. Only after full mount consolidation should you consider submission threats or positional advancement to high mount.",
      "position": 8
    }
  ],
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the optimal timing window for initiating the Kuzure Kesa Gatame to Mount transition?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The optimal window opens when the bottom player's arms are committed to defending Kuzure Kesa Gatame's chest pressure rather than establishing positional frames at your hip. Specifically, when they retract their arms after a submission threat, turn away from pressure, or flatten out under sustained weight. These moments leave the hip line unprotected and their knee insertion mechanics compromised by their current defensive commitment."
      }
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      "name": "What grip configuration provides the most control during the step-over from Kuzure Kesa Gatame?",
      "acceptedAnswer": {
        "@type": "Answer",
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Kuzure Kesa Gatame to Mount Attacker",
  "description": "Learn to execute the Modified Kesa Gatame to Mount transition. Step-by-step weight transfer mechanics, crossface control, and timing to secure the highest-scoring position in BJJ.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Graph",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://bjjgraph.org/Transitions/Kuzure-Kesa-Gatame-to-Mount"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjgraph.org/Transitions/Kuzure-Kesa-Gatame-to-Mount/Attacker"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Kuzure Kesa Gatame to Mount (Attacker) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Kesa gatame position, transition and submission",
      "description": "Kuzure Kesa Gatame to Mount (Attacker) film study: Kesa gatame position, transition and submission, taught by Merge Grappling.",
    ...
    },
    {
      ...
      "description": "Kuzure Kesa Gatame to Mount (Attacker) film study: Kesa Gatame to Mount Transition, taught by Amy Campo.",
    ...
    },
    {
      ...
      "description": "Kuzure Kesa Gatame to Mount (Attacker) film study: Kesa Gatame to Mount Instruction, taught by Mark Massey.",
...
<p class="section-subtitle">Watch Kuzure Kesa Gatame to Mount (Attacker) in action — curated instructionals</p>
...
<p class="section-subtitle">What are the key principles for executing Kuzure Kesa Gatame to Mount?</p>
...
<p class="section-subtitle">What do you need before attempting Kuzure Kesa Gatame to Mount?</p>

- Established Kuzure Kesa Gatame with consistent chest-to-chest pressure and stable base
...
<p class="section-subtitle">How do you execute Kuzure Kesa Gatame to Mount step by step?</p>

1. **Confirm control position**: From established Kuzure Kesa Gatame, verify your chest pressure is heavy and your opponent is not mid-escape. Confirm your crossface or head control is secure and the near arm is trapped. Check that their far knee is not threatening to insert between your bodies. This rapid assessment prevents committing to a transition during a vulnerable window.
...
<p class="section-subtitle">How might your opponent counter Kuzure Kesa Gatame to Mount?</p>

- **Bottom player inserts far knee between bodies during the leg swing creating a knee shield** (Effectiveness: High) - Your Response: Use your swinging leg to hook behind their inserting knee and push it flat. If the knee is already established, abort the mount entry and return to Kuzure Kesa Gatame to re-establish control. Attack their extended arms to force frame retraction before reattempting. → Leads to [[Positions/Half Guard]]
...
<p class="section-subtitle">What mistakes should you avoid when executing Kuzure Kesa Gatame to Mount?</p>
...
- **Correction**: Only initiate the transition when the opponent is relatively settled under pressure. Re-establish Kuzure Kesa Gatame control first if they are actively escaping, then transition during the lull between their escape attempts.
...
<p class="section-subtitle">How do you train Kuzure Kesa Gatame to Mount (Attacker)?</p>

**Phase 1: Mechanics** - Weight transfer and leg clearance fundamentals
Practice the step-over motion from Kuzure Kesa Gatame against a compliant partner. Focus on maintaining chest pressure during the leg swing, keeping hips low, and settling heavy into mount. Perform 20 repetitions per side with no resistance, concentrating on smooth weight transfer and crossface maintenance throughout the movement.

**Phase 2: Timing and Reactions** - Reading defensive patterns for transition windows
Partner provides specific defensive reactions from Kuzure Kesa Gatame bottom: turning away, flattening out, pushing against chest, or retracting arms after submission defense. Practice recognizing each reaction and timing the step-over to exploit the window it creates. Develop sensitivity to when the opponent's arms are committed to pressure defense versus actively blocking the hip line.

**Phase 3: Attack Integration** - Combining with Kuzure Kesa Gatame submission threats
Chain the mount transition with submission threats from Kuzure Kesa Gatame. Threaten americana to force arm retraction, then transition to mount when defensive frames collapse. Practice the mount entry as part of a flowing attack sequence. Partner provides 50-75% resistance and varies defensive responses.

**Phase 4: Live Application** - Positional sparring with full resistance
Start from established Kuzure Kesa Gatame in positional sparring rounds. Top player scores by achieving mount for 3 seconds, bottom player scores by recovering any guard position. Full resistance with focus on selecting the right moment for the transition based on real-time defensive reactions. Alternate roles every 2 minutes for 10-minute rounds.
...
<p class="section-subtitle">What are the safety concerns for Kuzure Kesa Gatame to Mount?</p>
