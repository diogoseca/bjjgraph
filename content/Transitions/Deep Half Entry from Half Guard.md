...
---
title: "Deep Half Entry from Half Guard | BJJ Technique | BJJ Graph"
description: "Master the Deep Half Entry from Half Guard in BJJ. Learn systematic techniques for sliding underneath opponents to create powerful sweep opportunities."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Deep Half Entry from Half Guard", "item": "https://bjjgraph.org/Transitions/Deep-Half-Entry-from-Half-Guard" }
  ]
}
</script>
...
[[Deep Half Entry from Half Guard/Attacker|Play as Attacker]]
[[Deep Half Entry from Half Guard/Defender|Play as Defender]]
...
[[Deep Half Entry from Half Guard/Attacker|→ Full Attacker Guide]]
...
[[Deep Half Entry from Half Guard/Defender|→ Full Defender Guide]]
...
**Lockdown to Deep Half Entry**: Using the lockdown figure-four leg control to break down the opponent's posture before releasing the lockdown and sliding underneath to deep half. The lockdown provides secure control that prevents the opponent from posturing up during the transition. (When to use: When opponent has strong crossface pressure and you need to control their posture before initiating the entry)


**Underhook Dive Entry**: From a secured underhook position in half guard, the bottom player drives forward to create momentum then redirects underneath by ducking the head under the opponent's far hip while maintaining the underhook throughout the transition. (When to use: When you have already won the underhook battle and opponent attempts to drive forward with pressure)


**Knee Shield Retreat Entry**: Starting from knee shield half guard, the bottom player drops the knee shield and slides underneath as the opponent advances into the vacated space. The retreating motion of removing the knee shield creates the pathway for sliding under. (When to use: When opponent is actively pressuring past your knee shield and you redirect their momentum into your deep half entry)
