...
---
title: "Kuzure Kesa Gatame to Kesa Gatame | BJJ Technique | BJJ Graph"
description: "Master the Kuzure Kesa Gatame to Kesa Gatame transition in BJJ. Step-by-step guide covering hip rotation, head control transfer, and arm trapping mechanics."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Kuzure Kesa Gatame to Kesa Gatame", "item": "https://bjjgraph.org/Transitions/Kuzure-Kesa-Gatame-to-Kesa-Gatame" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Kuzure Kesa Gatame to Kesa Gatame \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Kesa Gatame basic scarf hold control",
      "description": "Kuzure Kesa Gatame to Kesa Gatame film study: Kesa Gatame basic scarf hold control, taught by Grappler Station.",
    ...
    },
    {
      ...
      "description": "Kuzure Kesa Gatame to Kesa Gatame film study: Turnover into Kesa Gatame from prone, taught by Nigel Bowley.",
...
<script type="application/ld+json">
{
  ...
  "@type": "DefinedTerm",
  "name": "Kuzure Kesa Gatame to Kesa Gatame",
  "description": "Kuzure Kesa Gatame to Kesa Gatame is a side-control-family positional switch in which the top player rotates from a chest-to-chest modified scarf hold into a perpendicular scarf pin, threading the head and trapping the near arm to open americana and armbar attacks.",
...
[[Kuzure Kesa Gatame to Kesa Gatame/Attacker|Play as Attacker]]
[[Kuzure Kesa Gatame to Kesa Gatame/Defender|Play as Defender]]

</div>

<section id="overview" class="content-section">

**Kuzure Kesa Gatame to Kesa Gatame is a side-control-family positional switch in which the top player rotates from a chest-to-chest modified scarf hold into a perpendicular scarf pin, threading the head and trapping the near arm to open americana and armbar attacks.**
...
<p class="section-subtitle">Watch Kuzure Kesa Gatame to Kesa Gatame in action — curated instructionals</p>
...
[[Kuzure Kesa Gatame to Kesa Gatame/Attacker|→ Full Attacker Guide]]
...
- **Assess and Confirm Setup**: From established Kuzure Kesa Gatame, confirm your chest pressure is heavy and your opponent is not m...
...
[[Kuzure Kesa Gatame to Kesa Gatame/Defender|→ Full Defender Guide]]
...
This transition sits at the heart of the side control family's internal flow system. Kuzure Kesa Gatame and Kesa Gatame represent two distinct control geometries within the same positional territory, and the ability to switch between them prevents opponents from developing stable defensive patterns. When an opponent adapts to modified scarf hold's chest pressure through frames and hip movement, transitioning to kesa gatame's perpendicular wrap resets the defensive problem. The reverse transition (Kesa Gatame to Kuzure Kesa Gatame) completes the cycle. This positional switching integrates with broader transitions to North-South, Mount, and Ushiro Kesa Gatame, creating a comprehensive top control system where each position flows naturally into the others based on the bottom player's reactions.
...
- [[Positions/Side Control/Kuzure Kesa Gatame]] - Starting position for this transition
...
- [[Transitions/Kesa Gatame to Kuzure Kesa Gatame]] - Reverse transition completing the positional cycle
...
- [[Transitions/Escape Kuzure Kesa Gatame]] - Defensive technique this transition can preempt
