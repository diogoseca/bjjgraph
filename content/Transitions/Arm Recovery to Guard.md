...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for Arm Recovery to Guard from Kuzure Kesa-Gatame/Bottom. Possible outcomes: Closed Guard (50%), Half Guard (15%), Kuzure Kesa-Gatame/Bottom (25%), Armbar Control (10%).",
  "step": [
    {
      "@type": "HowToStep",
...
## Opponent Counters
- **Opponent tightens armpit clamp and drops chest weight when sensing extraction attempt** (Effectiveness: High) - Your Response: Abandon the direct extraction and chain into a Granby Roll or hip escape to Half Guard instead. Return to arm recovery when the opponent adjusts again. The failed attempt often causes them to overcommit to arm control, opening other escape paths.
...
## Common Mistakes
- **Mistake**: Yanking the trapped arm straight out with muscular force against the armpit clamp
...
- **Mistake**: Attempting extraction without bridging first to create a weight shift
...
- **Mistake**: Pausing after arm extraction instead of immediately hip escaping to recover guard
...
- **Mistake**: Extending the trapped arm fully straight during the extraction attempt
...
- **Mistake**: Pushing the opponent away with the free arm instead of creating a structural frame
...
- **Mistake**: Attempting guard recovery with legs before the arm is fully extracted
...
- **Mistake**: Bridging straight upward instead of at a perpendicular angle toward the opponent's posting leg
...
- [[Elbow Escape]] - Alternative escape from same position—chains when arm recovery is denied
- [[Granby Roll]] - Alternative escape to Turtle when direct guard recovery is blocked
