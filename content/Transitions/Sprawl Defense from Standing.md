...
---
title: "Sprawl Defense from Standing | BJJ Technique | BJJ Graph"
description: "Master the sprawl defense from standing in BJJ. Complete guide covering takedown defense mechanics, front headlock entries, and counterattacking strategies."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Sprawl Defense from Standing", "item": "https://bjjgraph.org/Transitions/Sprawl-Defense-from-Standing" }
  ]
}
</script>
...
[[Sprawl Defense from Standing/Attacker|Play as Attacker]]
[[Sprawl Defense from Standing/Defender|Play as Defender]]
...
[[Sprawl Defense from Standing/Attacker|→ Full Attacker Guide]]
...
- **Secure Head Position**: As the shot is stuffed, transition one arm to wrap around your opponent's head and neck, establishin...
...
[[Sprawl Defense from Standing/Defender|→ Full Defender Guide]]
...
**Hard Sprawl**: An explosive, full-commitment sprawl where you drive all bodyweight directly onto the opponent's upper back and shoulders, maximizing downward force to immediately flatten their posture. Both legs extend fully behind the body with toes driving into the mat for additional weight transfer. Prioritizes stopping power over immediate positional follow-up. (When to use: Against powerful opponents with deep penetration who are driving through standard sprawl defense, or when the shot carries significant forward momentum that requires maximum stopping force.)


**Crossface Sprawl**: Combines the hip sprawl with an immediate crossface by driving your forearm across the opponent's jaw line from the near side. This redirects their head angle and breaks their shot alignment while the hip drop kills forward momentum. The crossface naturally guides you toward front headlock on your preferred side. (When to use: When the opponent maintains strong inside head position during the shot and you need to redirect their angle to deny the takedown finish and establish front headlock control on your dominant side.)


**Whizzer Sprawl**: A modified sprawl incorporating an immediate overhook on the opponent's near arm as the hips drive back. The whizzer prevents the opponent from maintaining their grip on your leg while the sprawl neutralizes forward drive. This variant is particularly effective for transitioning to front headlock or executing a whizzer-kick reversal. (When to use: Against single leg takedown attempts where the opponent has secured grip on one leg and you need to neutralize their arm control while simultaneously sprawling to stop the shot.)
