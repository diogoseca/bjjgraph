...
---
title: "Transition to Game Over | BJJ Technique | BJJ Graph"
description: "Master BJJ submission finishing mechanics. Complete guide to converting control into taps with progressive pressure, escape prevention, and safe application."
---
...
[[Transition to Game Over/Attacker|→ Full Attacker Guide]]
...
- **Confirm control stability**: Before initiating the finish, verify that your control position is fully consolidated. Check that al...

- **Identify and block the primary escape**: Determine the opponent's highest-percentage escape route from your current control and proactively s...

- **Establish finishing grip or position**: Secure the specific grip configuration or body position required for your chosen submission. For cho...

- **Engage secondary control**: While maintaining your finishing grip, activate a secondary control mechanism that prevents the oppo...

- **Apply progressive pressure**: Begin applying the finishing force in a smooth, steady escalation. For chokes, progressively tighten...

- **Monitor, adjust, and release on tap**: As you apply pressure, the opponent will make final defensive adjustments. Monitor their response an...


### Common Mistakes


- **Rushing the finish before control position is fully consolidated**
...
- **Using only arm and hand strength for chokes instead of engaging full body mechanics**
...
- **Neglecting to block the primary escape route before committing to the finish**
...
[[Transition to Game Over/Defender|→ Full Defender Guide]]
...
- **Hand fight and grip prevention to stop the finishing grip from consolidating** - When: During the early grip setup phase before the opponent has fully secured the finishing mechanism - this is the highest-percentage defensive window

- **Frame and hip escape to create separation and extract the endangered limb or neck from the finishing position** - When: After the grip is established but before full finishing pressure is applied, when you can still create space through hip movement and skeletal frames

- **Explosive bridge and rotation to disrupt the finishing angle and force a positional scramble** - When: As finishing pressure begins to build but before it reaches the point of no return, using the last available window of movement before the lock or choke is fully tight
...
**Choke Finishing Mechanics**: Finishing mechanics specific to blood chokes and air chokes, where the primary mechanism restricts blood flow to the brain via carotid compression or compresses the airway. Requires correct forearm or lapel angle across the neck, shoulder retraction to generate squeeze force, and chest expansion to fill remaining space. The finishing pressure comes from skeletal alignment rather than arm strength. (When to use: From back control, mounted triangle, guillotine control, or any position with neck access where a choking grip is established)


**Joint Lock Finishing Mechanics**: Finishing mechanics for hyperextension and rotation-based joint attacks including armbars, kimuras, americanas, and heel hooks. The fulcrum point positioning determines effectiveness - the attacking structure must be placed precisely at the target joint while the limb is isolated and controlled on both sides of the fulcrum. Force is applied perpendicular to the joint's natural range of motion. (When to use: From armbar control, kimura trap, ashi garami, or any position where a limb is isolated with a clear fulcrum established)


**Compression Finishing Mechanics**: Finishing mechanics for calf slicers, bicep slicers, and chest compressions where muscle tissue is crushed against bone. Requires precise positioning of the attacking limb as a wedge between the opponent's joints, then closing the angle to increase compression. These finishes often catch opponents off-guard because the pain escalation is non-linear. (When to use: From leg entanglements, truck position, or body triangle scenarios where a limb is trapped between two fulcrum points)
