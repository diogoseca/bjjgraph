...
---
title: "Rear Naked Choke Setup | BJJ Technique | BJJ Graph"
description: "Master the Rear Naked Choke Setup from back control. Step-by-step arm positioning and grip mechanics. Success rates: Beginner 35%, Intermediate 55%, Advanced 75%."
---
...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for Rear Naked Choke Setup from Back Control/Top. Possible outcomes: Harness (55%), Back Control (30%), Turtle (15%).",
  "step": [
    {
      "@type": "HowToStep",
...
- **Opponent turns their body toward your choking arm, facing partially toward you and potentially recovering guard** (Effectiveness: Medium) - Your Response: Follow their turn while maintaining chest contact. If they commit to turning, transition to gift wrap control or technical mount. Use their turn momentum to take the opposite side back control
...
## Common Mistakes
- **Mistake**: Inserting the choking arm with palm facing up or elbow flared away from your body
...
- **Mistake**: Rushing the arm insertion before stripping opponent's defensive grips
...
- **Mistake**: Placing the non-choking hand behind the head before the choking arm is fully inserted
...
- **Mistake**: Losing chest-to-back connection while focusing on the choke setup
...
- **Mistake**: Attempting to finish with arm strength by flexing bicep rather than using proper mechanics
...
- **Mistake**: Accepting a shallow choke position and hoping it will be enough to finish
...
- **Mistake**: Neglecting hook control while attacking the neck, allowing opponent to clear legs
...
- [[Back Escape Series]] - Escape system opponent employs if setup is delayed
