...
description: "Master the Leg Knot reversal to Outside Ashi. Transform defensive entanglement into attacking position. Success rates: Beginner 30%, Intermediate 50%, Advanced 65%."
---
...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for Reverse the entanglement to Outside Ashi from Leg Knot/Bottom. Possible outcomes: Outside Ashi-Garami (65%), Leg Knot (25%), Saddle (10%).",
  "step": [
    {
      "@type": "HowToStep",
...
## Opponent Counters
- **Opponent widens base and posts hands to prevent rotation** (Effectiveness: High) - Your Response: Threaten the heel hook from current position to force reaction, or switch to 50-50 entry instead of Outside Ashi
- **Opponent drives forward and stacks during reversal attempt** (Effectiveness: Medium) - Your Response: Use their forward momentum to accelerate your hip switch, allowing their drive to complete your rotation rather than fighting it
- **Opponent disengages completely and creates distance** (Effectiveness: Medium) - Your Response: Follow immediately with Single Leg X entry or technical standup; do not allow them to reset to neutral standing
- **Opponent counter-rotates and attempts to maintain entanglement control** (Effectiveness: Low) - Your Response: Your grip on their far leg prevents effective counter-rotation; continue reversal with increased hip drive
...
## Common Mistakes
- **Mistake**: Attempting reversal without controlling opponent's far leg
...
- **Mistake**: Exposing heel during leg extraction phase
...
- **Mistake**: Half-committing to the rotation and stopping midway
...
- **Mistake**: Using explosive leg strength instead of hip rotation mechanics
...
- **Mistake**: Failing to secure outside hook immediately after rotation
...
- **Mistake**: Attempting reversal when opponent has strong cross-face control
...
- [[Granby Roll Escape]] - Related escape mechanics used in Granby variation
