...
description: "Learn Body Triangle Lock from Gift Wrap in BJJ. Step-by-step execution for securing dominant leg control. Success rates: Beginner 30%, Intermediate 50%, Advanced 65%."
---
...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for Body Triangle Lock from Gift Wrap/Top. Possible outcomes: Body Triangle (65%), Gift Wrap (25%), Half Guard (10%).",
  "step": [
    {
      "@type": "HowToStep",
...
- **Opponent turns toward you during leg transition to prevent the thread from reaching the far hip** (Effectiveness: High) - Your Response: Use your Gift Wrap arm control to prevent the turn by pulling their trapped shoulder back toward you. If they successfully turn, follow them to technical mount while maintaining the Gift Wrap rather than forcing the body triangle.
- **Opponent hand fights your leg during the threading motion to block the triangle lock** (Effectiveness: Medium) - Your Response: Since their other arm is trapped in Gift Wrap, they only have one hand available for this defense. Attack the neck immediately when they commit their free hand to leg defense, as they cannot protect both simultaneously.
- **Opponent pushes your locking ankle off before triangle is secured** (Effectiveness: Low) - Your Response: Keep your ankle tight to your attacking leg during the lock phase. If they manage to push the ankle, simply revert to standard hooks and reattempt when they fatigue from defensive efforts.
...
## Common Mistakes
- **Mistake**: Releasing Gift Wrap arm control to use both hands for leg positioning
...
- **Mistake**: Threading the body triangle too high across opponent's floating ribs
...
- **Mistake**: Attempting to lock body triangle while opponent is actively bridging or creating space
...
- **Mistake**: Locking ankle in front of the knee rather than behind it
...
- **Mistake**: Losing chest-to-back connection during leg threading motion
...
- [[Back Escape Series]] - Defensive counter-system - understanding escapes improves offensive application
