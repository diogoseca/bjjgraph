...
---
title: "Ushiro Kesa Gatame to Side Control | BJJ Technique | BJJ Graph"
description: "Master the Ushiro Kesa Gatame to Side Control transition in BJJ. Complete guide covering rotation mechanics, pressure maintenance, and grip transitions for top control."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Ushiro Kesa Gatame to Side Control", "item": "https://bjjgraph.org/Transitions/Ushiro-Kesa-Gatame-to-Side-Control" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Ushiro Kesa Gatame to Side Control \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Side control to scarf hold hip switch",
      "description": "Ushiro Kesa Gatame to Side Control film study: Side control to scarf hold hip switch, taught by Raven Jiu Jitsu.",
    ...
    },
    {
      ...
      "description": "Ushiro Kesa Gatame to Side Control film study: Osaekomi waza: pinning and transitioning between pins, taught by Samir Seif.",
    ...
    },
    {
      ...
      "description": "Ushiro Kesa Gatame to Side Control film study: How to mount reverse kesa gatame, taught by David Webster.",
...
<script type="application/ld+json">
{
  ...
  "@type": "DefinedTerm",
  "name": "Ushiro Kesa Gatame to Side Control",
  "description": "Ushiro Kesa Gatame to Side Control is a top-control transition in which the pinning player rotates from the reverse scarf-hold orientation into standard perpendicular side control, trading the reverse pin's arm isolation for side control's broader submission and mount-advancement options.",
...
[[Ushiro Kesa Gatame to Side Control/Attacker|Play as Attacker]]
[[Ushiro Kesa Gatame to Side Control/Defender|Play as Defender]]

</div>

<section id="overview" class="content-section">

**Ushiro Kesa Gatame to Side Control is a top-control transition in which the pinning player rotates from the reverse scarf-hold orientation into standard perpendicular side control, trading the reverse pin's arm isolation for side control's broader submission and mount-advancement options.**
...
<p class="section-subtitle">Watch Ushiro Kesa Gatame to Side Control in action — curated instructionals</p>
...
[[Ushiro Kesa Gatame to Side Control/Attacker|→ Full Attacker Guide]]
...
[[Ushiro Kesa Gatame to Side Control/Defender|→ Full Defender Guide]]
...
- [[Positions/Side Control/Ushiro Kesa Gatame]] - Source position from which this transition begins
...
- [[Transitions/Ushiro Kesa Gatame to North-South]] - Alternative transition from the same starting position heading toward opponent's head
...
- [[Transitions/Bridge from Ushiro Kesa Gatame]] - Defensive technique the bottom player may use to disrupt the transition
