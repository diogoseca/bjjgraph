...
description: "Learn Peruvian Necktie Setup in BJJ. Step-by-step execution from Front Headlock to submission finish. Success rates: Beginner 20%, Intermediate 35%, Advanced 50%."
---
...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for Peruvian Necktie Setup from Front Headlock/Top. Possible outcomes: game-over (50%), Front Headlock (35%), Turtle (15%).",
  "step": [
    {
      "@type": "HowToStep",
