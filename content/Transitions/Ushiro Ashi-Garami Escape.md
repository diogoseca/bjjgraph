...
description: "Learn Ushiro Ashi-Garami Escape in BJJ. Systematic leg extraction from reversed entanglement to Open Guard. Success rates: Beginner 30%, Intermediate 50%, Advanced 65%."
---
...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for Ushiro Ashi-Garami Escape from Ushiro Ashi-Garami/Bottom. Possible outcomes: Open Guard (55%), Turtle (10%), Ushiro Ashi-Garami (25%), Saddle (10%).",
  "step": [
    {
      "@type": "HowToStep",
...
## Opponent Counters
- **Opponent accelerates heel hook attempt during your extraction sequence, attacking exposed heel during leg clearing** (Effectiveness: High) - Your Response: Intensify dorsiflexion and use both hands to strip their heel grip before continuing extraction. If grip is deep, accept turtle position by continuing rotation rather than fighting the grip in place
- **Opponent transitions to saddle by stepping the inside leg through as you clear the outside leg** (Effectiveness: High) - Your Response: Maintain inside knee control throughout the entire clearing sequence. If they begin stepping through, immediately redirect to Granby roll escape to turtle rather than fighting the saddle entry
- **Opponent re-establishes outside leg cross after initial clearing by chasing your knee with their leg** (Effectiveness: Medium) - Your Response: Keep pushing frame active on their hip and angle your knee inward toward your centerline to deny the re-cross. Accelerate extraction timing before they can re-establish the figure-four
...
## Common Mistakes
- **Mistake**: Relaxing foot dorsiflexion during the extraction sequence when focus shifts to leg clearing mechanics
...
- **Mistake**: Attempting explosive single-motion extraction instead of sequential leg clearing
...
- **Mistake**: Neglecting control of opponent's inside knee while focusing on clearing the outside leg
...
- **Mistake**: Extending the trapped leg toward the opponent in an attempt to push away or create space
...
- **Mistake**: Stopping the escape halfway to rest after partial clearing without establishing a safe position
...
- **Mistake**: Failing to establish guard structure immediately after successful leg extraction
...
- [[Granby Roll Escape]] - Variant escape using rolling momentum for deep control situations
