...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for Fireman's Carry from Clinch/Top. Possible outcomes: Side Control (70%), Clinch (20%), Clinch (10%).",
  "step": [
    {
      "@type": "HowToStep",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 3, "name": "Fireman's Carry", "item": "https://bjjgraph.org/Transitions/Fireman's-Carry"}
  ]
}
</script>
...
**Q9**: What is the optimal direction of force during the lifting phase of the Fireman's Carry?
...
**Q10**: What entry conditions must exist before you can successfully attempt a Fireman's Carry?
...
**Q11**: If the Fireman's Carry is blocked but you maintain arm control, what chain attacks become available?
...
**Q12**: What is the optimal timing window to initiate the Fireman's Carry during clinch exchanges?
...
- [[Snap Down]] - Setup technique that creates reactions exploitable with Fireman's Carry
...
- [[Sprawl Defense]] - Primary counter opponents will use to defend the technique
