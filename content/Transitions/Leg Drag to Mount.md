...
---
title: "Leg Drag to Mount | BJJ Technique | BJJ Graph"
description: "Master the Leg Drag to Mount transition in BJJ. Step-by-step guide from Leg Drag Control to full Mount. Success rates: Beginner 30%, Intermediate 50%, Advanced 65%."
---
...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for Leg Drag to Mount from Leg Drag Control/Top. Possible outcomes: Mount (65%), Leg Drag Control (25%), Half Guard (10%).",
  "step": [
    {
      "@type": "HowToStep",
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the primary goal of the Leg Drag to Mount transition?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The primary goal is to consolidate from leg drag control to full mount position when the opponent stays flat rather than turning away. This scores points (typically 4 for mount) and opens high-percentage submission opportunities while denying the opponent guard recovery options."
      }
    },
    {
      "@type": "Question",
      "name": "Which leg should you step over with first during the mount transition?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Step over with your far leg first while your near knee maintains pressure against the opponent's hip. This ensures continuous control throughout the transition and prevents the opponent from inserting frames or recovering guard during the movement."
      }
    },
    {
      "@type": "Question",
      "name": "What should you do if the opponent starts bridging explosively during your step-over?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Keep your weight low and forward rather than fighting the bridge. Post your hands wide for base and ride the bridge motion. Once the bridge fails (which it will if your weight is properly distributed), immediately complete the mount transition before they can attempt another escape."
      }
    },
    {
      "@type": "Question",
      "name": "How do you decide between transitioning to mount versus following to back control from leg drag?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The decision is based on the opponent's reaction. If they stay relatively flat and fight your upper body control, transition to mount. If they turn away to protect their guard (exposing their back), follow immediately for back control. The leg drag creates a decision tree where either reaction gives you a dominant position."
      }
    },
    {
      "@type": "Question",
      "name": "Your opponent inserts a knee shield as you attempt to slide your near knee across—what is your response?",
      "acceptedAnswer": {
        "@type": "Answer",
...
## Opponent Counters
- **Opponent bridges explosively during the step-over phase** (Effectiveness: High) - Your Response: Keep your weight low and forward during transition. If they start to bridge, post your hands wide and ride the bridge rather than fighting it. Once the bridge fails, immediately complete the mount.
...
- **Opponent hip escapes toward you and attempts to recover half guard** (Effectiveness: Medium) - Your Response: Follow their hip escape by stepping your far leg even wider and driving your near knee into their hip. Use their movement to complete the transition more quickly. The hip escape actually makes mount easier if you follow it properly.
- **Opponent frames strongly against your shoulder and creates space** (Effectiveness: Low) - Your Response: Swim through their frame with an underhook or push their framing arm across their body. Once the frame is cleared, immediately continue the mount transition before they can re-establish defensive structure.
...
## Common Mistakes
- **Mistake**: Releasing hip pressure before initiating the step-over
...
- **Mistake**: Stepping over with the near leg first instead of the far leg
...
- **Mistake**: Rising up during the step-over phase
...
- **Mistake**: Neglecting shoulder control during the transition
...
- **Mistake**: Attempting the mount transition when opponent has already started turning away
...
## Test Your Knowledge
**Q1**: What is the primary goal of the Leg Drag to Mount transition?
**A**: The primary goal is to consolidate from leg drag control to full mount position when the opponent stays flat rather than turning away. This scores points (typically 4 for mount) and opens high-percentage submission opportunities while denying the opponent guard recovery options.

**Q2**: Which leg should you step over with first during the mount transition?
**A**: Step over with your far leg first while your near knee maintains pressure against the opponent's hip. This ensures continuous control throughout the transition and prevents the opponent from inserting frames or recovering guard during the movement.

**Q3**: What should you do if the opponent starts bridging explosively during your step-over?
**A**: Keep your weight low and forward rather than fighting the bridge. Post your hands wide for base and ride the bridge motion. Once the bridge fails (which it will if your weight is properly distributed), immediately complete the mount transition before they can attempt another escape.

**Q4**: How do you decide between transitioning to mount versus following to back control from leg drag?
**A**: The decision is based on the opponent's reaction. If they stay relatively flat and fight your upper body control, transition to mount. If they turn away to protect their guard (exposing their back), follow immediately for back control. The leg drag creates a decision tree where either reaction gives you a dominant position.

**Q5**: Your opponent inserts a knee shield as you attempt to slide your near knee across—what is your response?
**A**: Do not force the mount against an established knee shield. Instead, redirect immediately to knee on belly by posting your knee on their belly while maintaining upper body control, or backstep to re-establish leg drag position. Fighting through a knee shield wastes energy and creates scramble opportunities that favor the bottom player.

**Q6**: What is the critical hip pressure principle during the leg drag to mount transition?
...
**Q7**: Why is maintaining shoulder control essential during the mount transition, and how do you adjust it during movement?
**A**: Shoulder control prevents the opponent from sitting up or rotating during the vulnerable moment when you're stepping over. Throughout the transition, maintain crossface pressure or shoulder control with your free arm. Only adjust hand position once mount is fully secured—the upper body control acts as an anchor while your lower body completes the positional change.

**Q8**: What immediate adjustments should you make upon completing the mount to prevent the elbow-knee escape?
**A**: Settle your weight low on the mount immediately with hips driving into their belly. Establish grapevines or hook your feet under their thighs to prevent bridging. Your hands should post on the mat or control their head and arm. Low, heavy mount with active base prevents the opponent from creating the angle needed for elbow-knee escape.
...
- [[Americana from Mount]] - High-percentage submission from mount position
