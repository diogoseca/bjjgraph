...
---
title: "Rolling Escape to Guard | BJJ Technique | BJJ Graph"
description: "Master the Rolling Escape to Guard from Aoki Lock. Step-by-step escape using forward roll mechanics. Success rates: Beginner 30%, Intermediate 50%, Advanced 65%."
---
...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for Rolling Escape to Guard from Aoki Lock/Bottom. Possible outcomes: Open Guard (65%), Aoki Lock (25%), Back Control (10%).",
  "step": [
    {
      "@type": "HowToStep",
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the primary goal of Rolling Escape to Guard?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The primary goal is to escape the Aoki Lock shoulder submission by rolling toward your trapped arm, which follows the path of least resistance and creates space for arm extraction. The escape aims to recover to open guard where you can establish defensive frames and prevent immediate re-attack."
      }
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      "name": "Your opponent begins following your roll - how should you adjust your escape?",
      "acceptedAnswer": {
        "@type": "Answer",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 3, "name": "Rolling Escape to Guard", "item": "https://bjjgraph.org/Transitions/Rolling-Escape-to-Guard"}
  ]
}
</script>
...
## Opponent Counters
- **Opponent follows the roll to maintain back control** (Effectiveness: High) - Your Response: If opponent follows your roll, immediately establish turtle defense or continue the roll to seated guard position - do not stop mid-roll
- **Opponent tightens leg entanglement anticipating the roll** (Effectiveness: Medium) - Your Response: Attack their posted leg base before rolling to destabilize their structure, then initiate the roll when they adjust
- **Opponent switches to back control instead of finishing shoulder lock** (Effectiveness: Medium) - Your Response: If you feel them transitioning to back control, use the opening to extract your arm and immediately establish guard rather than completing full roll
- **Opponent base posts and resists the roll direction** (Effectiveness: Low) - Your Response: Their resistance to the roll often loosens the leg entanglement - use this moment to extract arm and hip escape to guard instead
...
## Common Mistakes
- **Mistake**: Rolling away from trapped arm direction
...
- **Mistake**: Initiating roll with shoulder externally rotated
...
- **Mistake**: Attempting roll when shoulder is already at maximum pressure
...
- **Mistake**: Stopping mid-roll without completing to guard
...
- **Mistake**: Neglecting to establish guard frames after roll completion
...
- **Mistake**: Using muscular effort to fight the roll instead of technique
...
## Test Your Knowledge
**Q1**: What is the primary goal of Rolling Escape to Guard?
**A**: The primary goal is to escape the Aoki Lock shoulder submission by rolling toward your trapped arm, which follows the path of least resistance and creates space for arm extraction. The escape aims to recover to open guard where you can establish defensive frames and prevent immediate re-attack.
...
**Q5**: Your opponent begins following your roll - how should you adjust your escape?
...
**Q7**: How do you counter an opponent who tightens their leg entanglement when they sense you preparing to roll?
...
**Q8**: What distinguishes the Rolling Escape from other Aoki Lock escapes?
**A**: The Rolling Escape uses forward momentum and the opponent's pressure to create escape, making it effective when opponent is actively finishing. Unlike arm extraction escapes that require loosened leg control, the roll works specifically because you use their committed pressure. It is highest percentage when opponent drives forward but requires precise direction and shoulder positioning.
...
- [[Granby Roll Escape]] - Related rolling escape mechanics used in other positions
- [[Hip Escape to Guard Recovery]] - Alternative guard recovery method if roll is partially successful
