...
---
title: "Ezekiel from Closed Guard | BJJ Technique | BJJ Graph"
description: "Master the Ezekiel choke from closed guard top in BJJ. Complete guide to sleeve grip setup, surprise timing, finishing mechanics, and counter defense."
---
...
[[Ezekiel from Closed Guard/Attacker|→ Full Attacker Guide]]
...
- **Establish head control**: From inside closed guard, slide your left arm behind the opponent's head, cupping the back of their ...

- **Feed the sleeve grip**: While maintaining head control with your left arm, use your right hand to reach across and thread yo...

- **Position the choking forearm**: Rotate your right arm so the blade of your forearm—the bony radial edge—crosses directly over the op...

- **Drop your weight forward**: Lower your chest and drop your head beside the opponent's head on the side of your sleeve-gripping a...

- **Drive the fist across the throat**: Punch your left fist forward and across the opposite side of the opponent's neck, creating a scissor...

- **Squeeze and consolidate the choke**: Draw your elbows together while simultaneously pulling your right hand (sleeve grip) back toward you...

- **Maintain and finish**: Hold the compression for two to five seconds as the carotid restriction takes effect. If the opponen...


### Common Mistakes


- **Telegraphing the sleeve grip entry by reaching obviously and slowly across the body toward your own sleeve**
...
- **Attempting the choke from too far away without adequate head control established first**
...
- **Placing the forearm across the chin or face instead of directly across the throat and carotid arteries**
...
[[Ezekiel from Closed Guard/Defender|→ Full Defender Guide]]
...
**No-Gi Ezekiel**: Uses the blade of the wrist and closed fist instead of the gi sleeve to create the choking mechanism. The non-sleeve hand cups behind the opponent's head while the choking fist drives across the throat with the wrist bone pressing into one carotid artery. (When to use: When training no-gi or when the opponent has stripped your sleeve grip but you still have head control and proximity to the neck.)


**Reverse Ezekiel (Palm-Up Variation)**: Instead of the traditional palm-down forearm-across-throat position, the choking hand enters palm-up with the back of the wrist pressing into the throat. This variation changes the angle of compression and can bypass defenses that are effective against the standard grip orientation. (When to use: When the opponent successfully defends the standard Ezekiel by turning their chin toward your forearm, making the traditional angle ineffective.)


**Baited Ezekiel Setup**: Deliberately allow the opponent to break your posture or pull you forward, appearing to be caught in their offensive control. Use their pulling energy to establish the Ezekiel grip while they believe they are successfully breaking you down for their own attacks. (When to use: Against aggressive guard players who constantly pull your posture down, using their offensive energy as your setup mechanism.)
