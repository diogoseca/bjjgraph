...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for executing Bullfighter Pass from De La Riva Guard/Top.",
  "step": [
    {
      "@type": "HowToStep",
...
<p class="section-subtitle">What are the key principles for executing Bullfighter Pass?</p>
...
<p class="section-subtitle">What do you need before attempting Bullfighter Pass?</p>
...
<p class="section-subtitle">How do you execute Bullfighter Pass step by step?</p>
...
<p class="section-subtitle">How might your opponent counter Bullfighter Pass?</p>
...
<p class="section-subtitle">What mistakes should you avoid when executing Bullfighter Pass?</p>
...
<p class="section-subtitle">How do you train Bullfighter Pass (Attacker)?</p>
...
<p class="section-subtitle">What are the safety concerns for Bullfighter Pass?</p>
