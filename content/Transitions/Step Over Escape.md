...
## Common Mistakes
- **Mistake**: Attempting to step over without first turning into the opponent and bridging the hips
...
- **Mistake**: Stepping with the near leg instead of the far leg
...
- **Mistake**: Failing to establish a frame on the opponent's hip before stepping over
...
- **Mistake**: Lifting the chin during the stepping motion to look where the leg is going
...
- **Mistake**: Stopping after the leg clears without continuing the full hip rotation and arm extraction
...
- **Mistake**: Not establishing guard immediately after breaking free from the choke
