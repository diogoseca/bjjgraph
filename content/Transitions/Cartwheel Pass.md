...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for Cartwheel Pass from Grasshopper Guard/Top. Possible outcomes: Side Control (65%), Grasshopper Guard (25%), Closed Guard (10%).",
  "step": [
    {
      "@type": "HowToStep",
...
## Opponent Counters
- **Opponent tracks your movement and rotates their inversion to follow, maintaining leg threat** (Effectiveness: High) - Your Response: Abort the cartwheel and circle back to original side, using their rotation against them by attacking the now-exposed opposite angle
- **Opponent extends legs directly at you during cartwheel initiation, catching your hips or legs** (Effectiveness: Medium) - Your Response: Increase cartwheel height and speed to clear the extended legs, or convert to a back step pass if legs catch early
- **Opponent posts on hip and technical stands during your aerial transition** (Effectiveness: Medium) - Your Response: Land and immediately transition to front headlock or snap down rather than forcing side control on a recovering opponent
- **Opponent Granby rolls under your landing trajectory, recovering guard as you land** (Effectiveness: Low) - Your Response: Follow their roll and reestablish top position, using their momentum to settle into north-south or repeat passing sequence
...
## Common Mistakes
- **Mistake**: Hesitating mid-cartwheel or attempting a slow, controlled rotation
...
- **Mistake**: Placing hands directly on opponent's body instead of beside their hips
...
- **Mistake**: Attempting the pass when opponent's legs are extended toward you
...
- **Mistake**: Landing too far from opponent after completing the cartwheel
...
- **Mistake**: Failing to establish immediate control after landing
...
- [[Toreando Pass]] - Ground-based alternative for passing inverted guards
