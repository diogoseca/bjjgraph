...
---
title: "Leg Drag Pass to Side Control Attacker | BJJ Technique Guide | BJJ Graph"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://bjjgraph.org/Transitions/Leg-Drag-Pass-to-Side-Control"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjgraph.org/Transitions/Leg-Drag-Pass-to-Side-Control/Attacker"
    }
  ]
}
</script>
...
**Q11**: What is the critical force direction when clearing the dragged leg past the opponent's hip?
**A**: The force must drive the leg downward toward the mat and away from you at a diagonal angle. Pushing straight down leaves the leg in a position where the opponent can re-hook. The diagonal push combined with your near knee sliding forward past their hip creates a wedge that cuts off any re-guard angle and prevents the opponent from recapturing your leg.

**Q12**: Your opponent successfully gets an underhook as you begin the consolidation—what chain attack do you pursue?
**A**: If the opponent secures an underhook during your consolidation, immediately apply a whizzer overhook and drive your shoulder into their jaw to flatten them. If the whizzer fails to kill the underhook, transition to north-south by sliding around their head, using their underhook commitment against them. From north-south you can attack the kimura on the underhooking arm or re-establish side control from a better angle.
