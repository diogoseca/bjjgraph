...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "Anaconda Control Bottom",
      "item": "https://bjjgraph.org/Positions/Anaconda-Control-Bottom"
    }
  ]
}
</script>
...
The bottom player's primary objectives are to prevent the choke from being locked in, relieve pressure on the neck, and create enough space to escape back to a neutral or more favorable position such as [[Half Guard]], [[Closed Guard]], or [[Turtle]]. Understanding the mechanics of how the anaconda works is crucial for defending it — the choke tightens as the top player pulls their choking arm's elbow toward their own hip while driving their chest into your trapped shoulder, creating a constricting loop around your neck and arm. The bottom player must act decisively and systematically to address the immediate submission threat before working toward positional escape.

This position often occurs during scrambles from [[Turtle]], failed takedown attempts, or transitions from other [[Front Headlock]] positions, and represents one of the most dangerous control positions in modern no-gi grappling. The defensive hierarchy must prioritize survival over escape: first prevent the choke from tightening, then create breathing space, and finally work systematic escape to guard or neutral position. The two highest-percentage escape routes are the [[Rolling Escape from Anaconda]] and the [[Anaconda Grip Break to Front Headlock]]. If the opponent switches submissions mid-control to [[Darce Control]] or [[Guillotine Control]], the defensive concepts remain similar but the specific hand-fighting targets change. Time is critical — once the position is fully locked, escape becomes exponentially more difficult.
