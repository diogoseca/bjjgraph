...
Butterfly Guard is BJJ's most explosive elevation-based guard, where the bottom player inserts hooks (feet) under the opponent's thighs while sitting up. Success Rate: Beginner 50%, Intermediate 65%, Advanced 80%. This position allows for explosive elevation of the opponent and offers exceptional offensive options while maintaining defensive capabilities. Butterfly Guard serves as both a powerful position in its own right and as a connector between various guard configurations — including [[Positions/X-Guard]], [[Positions/Single Leg X-Guard]], [[Positions/Deep Half Guard]], and [[Positions/Closed Guard]].
