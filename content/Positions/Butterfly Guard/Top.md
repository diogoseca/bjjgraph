...
Butterfly Guard Top is a challenging defensive scenario that demands technical passing skill rather than raw pressure. The top player faces constant sweeping threat from hooks under their thighs, postural control from the bottom player's grips, and explosive elevation that can immediately reverse position. Success requires specific anti-butterfly mechanics: maintaining base, fighting grips, and selecting the correct passing sequence for each defensive configuration.

How to pass butterfly guard — the four primary methods: (1) Long Step Pass — step one foot laterally outside the opponent's hook, drop your knee to the mat on that side, break their grip on that arm, and drive hips through to [[Side Control]]. Effective when opponent maintains upright posture. (2) [[Double Under Pass]] — scoop both legs under your arms, stack opponent's hips upward, drive forward and around to side control. Works when opponent extends arms or creates distance. (3) [[Knee Slice Pass]] — flatten one hook by driving your knee across their thigh, clear that hook, and knee-slide to side control. Best when opponent shifts their weight to one side. (4) [[Butterfly Pass]] / [[Butterfly Smash]] — establish grip on opponent's collar or head, apply downward pressure to break their posture, then thread a knee through the hooks to pin them and pass. Executes when opponent is momentarily postured-down during sweep attempts. (5) [[Body Lock Pass]] — secure a body lock around the hips, stand, and pressure-step to the side. Effective against opponents who rely on grip fighting rather than active hook pressure.

The key error when facing butterfly guard is committing weight too far forward — this provides the forward momentum the bottom player needs for elevation sweeps. Keep hips back, chest up, and weight distributed. Grip fight actively before any passing movement: if the bottom player establishes a collar grip and sleeve grip simultaneously, any passing attempt becomes a high-risk sweep opportunity for them. Deny the controlling grips first, then pass.

Tactically, butterfly guard top rewards patience and bait-and-counter approaches. When the bottom player commits to a sweep, their structure momentarily changes — hook drives upward, posture pitches forward — creating a split-second window for the top player to redirect and pass. Reading these commitment moments and timing the [[Butterfly Pass]] or [[Knee Slice Pass]] to the sweep transition is what separates technical passers from purely athletic ones. Elite top players cycle between threatening standing passes (which force opponents to keep hooks low) and driving knee-slice passes (which work when opponents try to recover hooks), creating a passing dilemma that the bottom player cannot solve with a single defensive strategy.
