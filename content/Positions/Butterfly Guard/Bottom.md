...
Butterfly Guard Bottom is one of the most offensive guard positions in Brazilian Jiu-Jitsu. The bottom player sits upright with both feet inserted as hooks under the opponent's inner thighs, generating constant elevator pressure that compromises top-player base and posture. This enables explosive, high-percentage sweeps while providing pathways to back takes, leg entanglements, and direct submission attempts — making it a complete offensive system rather than a passive defensive shell.

How to execute the basic butterfly sweep (the position's highest-percentage attack at 39%): (1) Establish full butterfly guard — both hooks deep under opponent's thighs, sitting upright. (2) Secure an underhook on one side — drive your arm under opponent's armpit, hand reaching to their back. (3) Grip opponent's opposite sleeve or wrist with your free hand to prevent posting. (4) Break opponent's posture by pulling their chest to your chest, eliminating their base. (5) Angle your body 45 degrees toward the underhook side. (6) Drive the underhook-side hook upward explosively into the opponent's inner thigh. (7) Pull the sleeve/wrist grip across your body simultaneously. (8) Roll through the elevation, following the opponent over. (9) Land in [[Mount]] as opponent rolls. (10) Maintain chest contact throughout to prevent them recovering guard. When the basic sweep is defended, immediately chain to [[Elevator Sweep]] (grip their back, drive hook up), [[Arm Drag to Back]] (exploit extended arm to enter [[Back Control]]), or [[Butterfly Guard to X-Guard]] (as they stand).

Grip strategy is the primary determinant of which sweeps are available. In gi: collar grip (pull posture forward for sweeps), sleeve grip (prevents posting, enables elevator sweep), underhook (sets up arm drag and sumi gaeshi). In no-gi: wrist control replaces sleeve grip, head/neck control replaces collar grip, seatbelt grip transitions to back takes. The rule across both formats: always control the arm on the sweep-direction side to prevent their base post.

Against pressure passing — the most common counter to butterfly guard — maintain upright posture (do not allow yourself to be flattened), keep hooks actively pressing upward rather than passive, use frames (forearm or palm against opponent's hip or shoulder) to create space, and chain to [[Deep Half Guard]] or [[Butterfly Guard to X-Guard]] when pressure becomes too heavy to sustain. The key error is allowing yourself to be pushed flat: once flat, hooks lose elevation angle and sweeps become ineffective.

Butterfly guard bottom serves as a central hub in modern guard systems. It connects to [[X-Guard]] when opponents stand, to [[Deep Half Guard]] under forward pressure, and provides entries to [[Back Control]] through arm drags. In no-gi, the mechanical hook control works without gi friction, making this one of the most transferable guard positions across rulesets. Elite practitioners treat butterfly bottom not as a fixed position but as a launch point — constantly threatening, transitioning, and creating compound offensive dilemmas that force the opponent to commit to a defensive response.
