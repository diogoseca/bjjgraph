...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Use Standing Position",
  "description": "Complete guide to standing position in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
    ...
    },
    {
      ...
      "text": "From this position, attempt Arm Drag. This technique is attempted in 5% of exchanges from this position.",
      "position": 7
    },
    {
      "@type": "HowToStep",
      "name": "Execute Ankle Pick",
      "text": "From this position, attempt Ankle Pick. This technique is attempted in 3% of exchanges from this position.",
      "position": 8
    }
  ],
  "totalTime": "PT2M"
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "What happens if you gripping with excessive muscular tension and death grips that drain energy?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Rapid fatigue of forearms and hands, decreased grip endurance throughout match, compromised ability to maintain grips in later exchanges The correct approach is: Use strategic grip timing with relaxed hands until critical moments, employ efficient grip breaking techniques rather than pure strength battles"
      }
    }
  ]
}
