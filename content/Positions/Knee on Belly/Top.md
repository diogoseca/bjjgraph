...
Knee on Belly Top is a highly effective transitional control position (worth 2 IBJJF points) where the top practitioner places one knee across the opponent's torso while maintaining a wide base with the other leg extended. This position creates immense pressure on the bottom player's diaphragm and solar plexus, making it difficult to breathe and forcing defensive reactions. The top player maintains constant forward pressure while staying light on their feet, ready to transition to [[Positions/Mount]], [[Positions/Side Control]], or submission attacks including the [[Submissions/Baseball Bat Choke]], [[Submissions/Kimura]], and [[Transitions/Far Side Armbar from KOB|far-side armbar]]. When the opponent turns away from the pressure, the [[Transitions/Back Take from Top]] opens directly to [[Positions/Back Control]]. The [[Transitions/S-Mount Transition]] into [[Positions/Mount/S Mount]] is another high-percentage advancement that maintains submission pressure. Unlike more static positions like [[Positions/Mount|mount]] or [[Positions/Side Control|side control]], Knee on Belly requires active weight distribution and constant micro-adjustments to maintain effectiveness. The threat of submissions, transitions to mount, and back takes forces the bottom player into a reactive defensive posture, allowing the top player to dictate the pace and direction of the match.
