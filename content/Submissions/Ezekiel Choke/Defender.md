...
---
title: "Ezekiel Choke Defender | BJJ Defense Guide | BJJ Graph"
description: "How to defend against Ezekiel Choke in BJJ. Recognition, escape paths, and defensive strategies."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Defend Ezekiel Choke in BJJ",
  "description": "Step-by-step guide for defending and escaping Ezekiel Choke in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Two-hand frame against threading arm to prevent it from passing behind your head",
      "text": "As soon as you recognize the attacker gripping their own sleeve and beginning to feed the arm behind your head - this must happen during the threading phase before bilateral pressure is established If successful: The choke attempt is neutralized at the setup phase. Attacker remains in mount but must abandon the Ezekiel and choose a different attack, giving you time to work mount escape sequences",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Explosive bridge timed with the attacker's forward weight shift during choke setup",
      "text": "When the attacker commits their weight forward and removes one or both posting hands to establish the choke grips - their base is momentarily compromised during this weight transfer If successful: Disrupts the attacker's mount stability, potentially creating enough space for knee insertion and half guard recovery. In best case, the bridge rolls the attacker over for full reversal",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Turn head toward the threading arm and tuck chin to deny blade access to far-side carotid",
      "text": "When the arm has already begun threading but has not yet achieved deep positioning against the far carotid - this reduces the effective choking angle If successful: Reduces the choke to single-sided pressure which is insufficient for blood choke finish. Attacker must readjust blade position, creating a window for you to insert hands and block the re-threading attempt",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Strip the sleeve grip by peeling the attacker's gripping hand fingers from inside their own sleeve cuff",
      "text": "When the bilateral structure is partially established but the attacker has not yet begun squeezing. The sleeve grip is the fulcrum of the entire choke, and removing it eliminates the rigid lever If successful: Completely collapses the choking structure. Without the sleeve grip, the Ezekiel cannot generate sufficient bilateral pressure, and the attacker must re-establish the grip before continuing the attempt",
      "position": 4
    }
  ],
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the earliest recognition cue that an Ezekiel choke is being set up, and why is this the optimal moment for defensive intervention?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The earliest cue is the attacker gripping their own sleeve with four fingers inside the cuff, typically reaching across their body with the non-dominant hand. This is the optimal defensive moment because the choke cannot function without this sleeve grip serving as a rigid lever. Before the threading begins, you can address the grip directly or begin escape sequences while the attacker's hands are committed to grip establishment rather than maintaining mount. Once threading begins, your defensive options narrow with each second."
      }
    },
    {
      "@type": "Question",
      "name": "Why is it critical to tap early when caught in a properly established Ezekiel choke, and what are the risks of attempting to tough it out?",
      "acceptedAnswer": {
        "@type": "Answer",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Defender",
      "item": "https://bjjgraph.org/Submissions/Ezekiel-Choke/Defender"
    }
  ]
}
</script>
...
### 1. Waiting until bilateral pressure is applied to the neck before attempting any defense

- **Consequence**: Once the blade arm is deep, elbow is tight, and the frame arm crosses the neck, defensive options are extremely limited. The window for effective defense has passed, and escape probability drops below 15%.
- **Correction**: Defend during the threading phase when the attacker is feeding the arm behind your head. This is the critical window - focus on recognizing the sleeve grip and forward weight shift as your trigger for immediate defensive action.

### 2. Extending arms straight upward to push the attacker's chest or face away

- **Consequence**: Straight arm extension exposes both arms to armbar attack and does not address the Ezekiel mechanics. The attacker can abandon the choke and immediately transition to armbar on the extended limb.
- **Correction**: Keep elbows tight to your body and use short bent-arm frames against the attacker's shoulders or the threading arm specifically. Never fully extend arms while under mount - frame with skeletal structure, not reach.

### 3. Attempting to turn away from the choking pressure once bilateral compression is established

- **Consequence**: Turning away from an established Ezekiel exposes the back, allows the attacker to follow to technical mount, and often tightens the choke by changing the compression angle against the carotid.
- **Correction**: If the choke is already locked, turn toward the blade arm rather than away. This reduces blade effectiveness on the far carotid. Combine with two-hand grip stripping on the sleeve to collapse the lever structure.

### 4. Panicking and using random explosive movements without targeting specific aspects of the choke structure

- **Consequence**: Wastes critical energy without addressing the choke mechanics. Random bridging and arm flailing accelerate fatigue while the bilateral pressure remains intact, hastening unconsciousness.
- **Correction**: Remain calm and target specific structural elements: the sleeve grip, the threading arm, or the blade positioning. Each defensive action should address a specific component of the choke rather than being generalized resistance.
...
**Phase 1: Recognition and Positioning Awareness** - Identifying Ezekiel setup cues and establishing defensive posture
Partner establishes mount and slowly demonstrates the Ezekiel setup at 0% resistance. Practice recognizing each cue in sequence: sleeve grip, weight shift forward, arm threading behind head, frame arm crossing neck. Develop the habit of monitoring the attacker's hand positioning from bottom mount. Drill the defensive chin tuck and head positioning that denies blade access to the far carotid.

**Phase 2: Active Blocking During Threading Phase** - Disrupting the choke setup before bilateral pressure is established
Partner attempts the Ezekiel at 30-50% speed and force. Practice two-hand blocking of the threading arm, sleeve grip stripping, and head turning toward the blade arm. Focus on timing your defensive action with the earliest recognition cues rather than waiting for neck pressure. Drill the transition from blocking the choke to establishing frames for hip escape.

**Phase 3: Integrated Defense and Escape Under Pressure** - Combining Ezekiel defense with mount escape sequences against realistic resistance
Partner attacks with the Ezekiel at 75-100% resistance while also maintaining mount. Practice using the attacker's commitment to the choke as a window for elbow escape, bridge-and-roll, or hip escape sequences. Drill tapping immediately when caught in a locked choke, reinforcing the safety habit of early recognition that defense has failed. Alternate between successful defense and submission acceptance to build honest assessment of when to escape versus when to tap.
...
**Q1**: What is the earliest recognition cue that an Ezekiel choke is being set up, and why is this the optimal moment for defensive intervention?
**A**: The earliest cue is the attacker gripping their own sleeve with four fingers inside the cuff, typically reaching across their body with the non-dominant hand. This is the optimal defensive moment because the choke cannot function without this sleeve grip serving as a rigid lever. Before the threading begins, you can address the grip directly or begin escape sequences while the attacker's hands are committed to grip establishment rather than maintaining mount. Once threading begins, your defensive options narrow with each second.

**Q2**: Why is it critical to tap early when caught in a properly established Ezekiel choke, and what are the risks of attempting to tough it out? **[SAFETY-CRITICAL]**
**A**: The Ezekiel is a blood choke that compresses both carotid arteries, restricting blood flow to the brain. Once bilateral compression is properly established, unconsciousness can occur within 5-10 seconds without any warning signs beyond slight facial flushing. Attempting to tough it out risks going unconscious without the ability to tap, which means the choke may be held longer than necessary. There is no benefit to waiting once the choke is locked - early tapping preserves consciousness, prevents potential complications from extended blood flow restriction, and allows you to reset and continue training safely.

**Q3**: Your opponent has threaded the blade arm behind your head but has not yet established the frame arm across your neck - what is your best defensive response?
**A**: This is a critical mid-stage window where defense is still viable. Immediately use both hands to control the attacker's frame arm (the sleeve-gripping arm) before it crosses your neck. Simultaneously turn your head toward the blade arm side, tucking your chin to deny the blade access to your far-side carotid. With the bilateral structure incomplete, the choke cannot finish. Use this disruption to bridge or hip escape, as the attacker has one arm committed behind your head and reduced posting ability. The key is preventing the frame arm from completing the structure rather than trying to remove the already-threaded blade arm.

**Q4**: How does defending the Ezekiel choke integrate with your broader mount escape strategy rather than being treated as an isolated problem?
**A**: Every Ezekiel defense should simultaneously serve mount escape goals. When you use both hands to block the threading arm, those same frames can transition into elbow escape by turning your hips and inserting your knee. When you bridge to disrupt the choke setup, you are also testing the attacker's base for reversal. When the attacker commits hands to choke grips, their ability to block your hip escape is reduced. The highest-level defenders use the Ezekiel threat as an opportunity rather than just a problem - the attacker's commitment to the choke temporarily weakens their mount maintenance, creating escape windows that don't exist when they focus solely on positional control.
