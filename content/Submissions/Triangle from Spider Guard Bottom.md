...
---
title: "Triangle from Spider Guard Bottom | BJJ Submission | BJJ Graph"
description: "Master the Triangle Choke from Spider Guard Bottom. Complete guide covering arm isolation, leg positioning, finishing mechanics, and defensive strategies."
---
...
**Release Protocol**:
1. Release all leg pressure immediately upon any tap signal
2. Monitor partner's consciousness - release immediately if resistance suddenly stops or body goes limp
3. If in doubt, release and allow partner to recover before re-engaging
4. After release, allow partner time to recover circulation before continuing training
...
[[Triangle from Spider Guard Bottom/Attacker|→ Full Attacker Guide]]
...
[[Triangle from Spider Guard Bottom/Defender|→ Full Defender Guide]]
...
**Standard Double Sleeve Entry**: Classic triangle entry using double sleeve spider guard. Pull one sleeve across your centerline while pushing the opposite bicep away with your foot, then shoot the free leg over the isolated shoulder. The most mechanically reliable entry because both arms are fully controlled throughout the setup phase. (When to use: When you have established strong double sleeve grips with both feet actively placed on the opponent's biceps and the opponent is kneeling or in combat base)


**Single Lasso Spider Hybrid Entry**: Triangle entry from a position where one leg is in lasso configuration (threaded under the arm and over the shoulder) while the other maintains standard spider guard bicep hook. The lasso leg provides enhanced control on one side, making it easier to isolate the opposite arm for the triangle. Release the lasso and shoot the leg over for the triangle once the arm is isolated. (When to use: When the opponent has driven forward into your guard and you have established a lasso hook on one side, creating superior control for arm isolation on the opposite side)


**Collar-Sleeve Spider Entry**: Triangle setup using collar grip with one hand and sleeve grip with the other while one foot maintains spider guard bicep pressure. The collar grip breaks posture downward while the sleeve grip and foot work together to isolate one arm. Effective because the collar grip prevents the opponent from posturing out during the leg entry phase. (When to use: When the opponent has broken one sleeve grip and you establish a collar grip instead, maintaining hybrid control that supports the triangle entry through superior posture control)
...
Successful execution of Triangle from Spider Guard Bottom leads to → [[game-over|Game Over]]
