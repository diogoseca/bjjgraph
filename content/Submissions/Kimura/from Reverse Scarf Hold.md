...
---
title: "Kimura from Reverse Scarf Hold | BJJ Submission | BJJ Graph"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Kimura from Reverse Scarf Hold", "item": "https://bjjgraph.org/Submissions/Kimura-from-Reverse-Scarf-Hold" }
  ]
}
</script>
...
- [[Submissions/Americana]] - Alternative shoulder lock from same position using opposite rotation
...
Successful execution of Kimura from Reverse Scarf Hold leads to → [[game-over|Game Over]]
