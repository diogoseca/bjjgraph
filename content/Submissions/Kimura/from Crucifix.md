...
---
title: "Kimura from Crucifix | BJJ Submission | BJJ Graph"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Kimura from Crucifix", "item": "https://bjjgraph.org/Submissions/Kimura-from-Crucifix" }
  ]
}
</script>
...
- [[Submissions/Americana]] - Related shoulder lock using opposite rotation direction from similar control
...
Successful execution of Kimura from Crucifix leads to → [[game-over|Game Over]]
