...
---
title: "Suloev Stretch | BJJ Submission Family | BJJ Graph"
...
|---------------|-------------|-----------------|----------------|
| [[Suloev Stretch/from Half Guard|Half Guard]] | 60% | Posterior knee ligament damage (PCL tear or strain) |  |
...
- [[Transitions/Kneebar]] - Both target the knee joint through different mechanical approaches - kneebar hyperextends while Suloev Stretch compresses
- [[Submissions/Toe Hold]] - Complementary leg attack targeting the foot and ankle that chains from failed Suloev Stretch attempts
- [[Submissions/Calf Slicer]] - Closely related compression submission using similar calf compression principles with different body positioning
- [[Transitions/Heel Hook]] - Alternative leg attack from similar positions, often available when Suloev Stretch entry is defended
- [[Submissions/Straight Ankle Lock]] - Foundational leg lock sharing positional entries with the Suloev Stretch from half guard top
- [[Submissions/Achilles Lock]] - Related compression-based ankle attack available from similar leg entanglement positions
- [[Transitions/Estima Lock]] - Foot lock variant that can chain with Suloev Stretch entries during guard passing sequences
- [[Submissions/Banana Split]] - Groin and hip flexibility attack sharing similar control positions and leg manipulation concepts
- [[Submissions/Inside Heel Hook]] - High-percentage heel attack accessible from transitions where Suloev Stretch is defended
- [[Positions/Half Guard/Electric Chair]] - Related lockdown submission sharing half guard entries and leg control concepts
...
- [[Positions/Kneebar Control]] - Alternative leg attack position - Both target the knee joint but through different mechanical approaches
