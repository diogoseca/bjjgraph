...
---
title: "Ezekiel from Mount Attacker | BJJ Submission Guide | BJJ Graph"
description: "How to execute Ezekiel from Mount in BJJ. Attacking perspective with setup, execution, and finishing mechanics."
---
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Ezekiel from Mount Attacker",
  "description": "How to execute Ezekiel from Mount in BJJ. Attacking perspective with setup, execution, and finishing mechanics.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Graph",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjgraph.org/Submissions/Ezekiel-from-Mount/Attacker"
    }
  ]
}
</script>
...
### 1. Applying the choke with only arm strength instead of using body weight and structure
...
### 2. Sitting up too high or back on the hips during the choke attempt
...
### 3. Failing to control the opponent's head position before or during the choke
...
### 4. Gripping the sleeve too shallow or losing the sleeve grip during execution
...
### 5. Using explosive or jerking motions to apply the choke
...
### 6. Continuing to apply pressure after feeling a tap or seeing loss of resistance
...
### 7. Placing the forearm blade directly on the trachea instead of targeting carotids
...
**Phase 1: Mechanics Foundation** - Grip placement and forearm blade angle
Practice the sleeve grip and arm threading on a stationary, compliant partner from mount. Focus exclusively on achieving the correct 4-6 inch sleeve grip depth, proper 45-degree blade angle across the neck, and smooth hand placement behind the head. No finishing pressure - repeat the entry sequence 30-50 times per session until the grip and threading become automatic.

**Phase 2: Positional Integration** - Combining mount control with choke mechanics
Execute the full Ezekiel sequence against a compliant partner who provides light framing and head movement. Focus on maintaining forward weight distribution and mount stability throughout the entire choke entry and finishing sequence. Practice releasing and re-entering when mount position degrades. Introduce slow finishing pressure at 30-50% intensity with partner providing verbal feedback on blade positioning.

**Phase 3: Live Application** - Executing against progressive resistance
Apply the Ezekiel during specific training rounds starting from mount against partners who defend at 50%, then 75%, then full resistance. Introduce submission chains where failed Ezekiel attempts flow into armbar or americana attacks. Practice recognizing defensive patterns and selecting the correct follow-up. Develop timing for entry windows created by opponent's defensive reactions to other mount threats.

**Phase 4: Competition Finishing** - High-pressure finishing and chain integration
Full-speed application during open rolling and competition preparation rounds. Focus on finishing under fatigue and time pressure, chaining the Ezekiel with collar chokes and arm attacks as a complete mount offense system. Practice the Ezekiel from all mount variations including high mount, modified mount, and technical mount. Develop the ability to set up the Ezekiel using positional threats as bait.
