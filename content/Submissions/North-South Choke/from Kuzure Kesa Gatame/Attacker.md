...
---
title: "North-South Choke from Kuzure Kesa Gatame Attacker | BJJ Submission Guide | BJJ Graph"
description: "Step-by-step guide to finishing the North-South Choke from Kuzure Kesa Gatame. Learn entry mechanics, shoulder placement, hip sprawl finishing, and how to counter common defensive responses."
---


<body data-content-type="submissions">

> **SAFETY**: North-South Choke from Kuzure Kesa Gatame targets the Carotid arteries and trachea. Risk: Carotid artery compression leading to loss of consciousness. Release immediately upon tap.
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Execute North-South Choke from Kuzure Kesa Gatame in BJJ",
  "description": "Step-by-step guide for North-South Choke from Kuzure Kesa Gatame with safety protocols.",
  "step": [
    {
      "@type": "HowToStep",
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What anatomical structures does the North-South Choke from Kuzure Kesa Gatame primarily attack?",
      "acceptedAnswer": {
        "@type": "Answer",
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "North-South Choke from Kuzure Kesa Gatame Attacker",
  "description": "Step-by-step guide to finishing the North-South Choke from Kuzure Kesa Gatame. Learn entry mechanics, shoulder placement, hip sprawl finishing, and how to counter common defensive responses.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Graph",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjgraph.org/Submissions/North-South-Choke-from-Kuzure-Kesa-Gatame/Attacker"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "North-South Choke from Kuzure Kesa Gatame (Attacker) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Kuzure Kesa Gatame North/South choke",
      "description": "North-South Choke from Kuzure Kesa Gatame (Attacker) film study: Kuzure Kesa Gatame North/South choke, taught by Todd Blatchley.",
    ...
    },
    {
      ...
      "description": "North-South Choke from Kuzure Kesa Gatame (Attacker) film study: Marcelo Garcia - North South Choke, taught by Marcelo Garcia.",
...
<p class="section-subtitle">Watch North-South Choke from Kuzure Kesa Gatame (Attacker) in action — curated instructionals</p>
...
<p class="clip-credit"><strong>Kuzure Kesa Gatame North/South choke</strong> — taught by Todd Blatchley · 2:01 · <a href="https://www.youtube.com/watch?v=LurZB_PfUmA" rel="noopener">Watch on YouTube</a></p>
...
<p class="section-subtitle">What are the key principles for executing North-South Choke from Kuzure Kesa Gatame?</p>
...
<p class="section-subtitle">What do you need before attempting North-South Choke from Kuzure Kesa Gatame?</p>

- Established Kuzure Kesa Gatame with heavy chest pressure settled on opponent's chest and ribcage
...
<p class="section-subtitle">How do you execute North-South Choke from Kuzure Kesa Gatame step by step?</p>

1. **Consolidate Kuzure Kesa Gatame control**: Ensure your chest pressure is heavy on the opponent's chest with their near arm trapped under your armpit or pinned against their body. Your head should be pressing down on their face or upper chest, and your hips should be active on your toes ready for the transition. Settle your weight for 2-3 seconds to confirm full control before initiating. (Timing: 0-3 seconds)
...
<p class="section-subtitle">How might your opponent defend against North-South Choke from Kuzure Kesa Gatame?</p>

- **Frame on hip with free arm to block the rotational slide to north-south** (Effectiveness: High) - Your Response: Use your free hand to strip the frame by pushing their elbow toward their hip, or switch to a kimura attack on the framing arm. If the frame is established before you begin sliding, reset your Kuzure Kesa Gatame control and try again with better setup. → Leads to [[Positions/Side Control/Kuzure Kesa Gatame]]
...
<p class="section-subtitle">What mistakes should you avoid when executing North-South Choke from Kuzure Kesa Gatame?</p>
...
### 6. Rushing the transition before fully consolidating Kuzure Kesa Gatame control
...
- **Correction**: Spend 2-3 seconds confirming solid Kuzure Kesa Gatame with heavy chest pressure, trapped near arm, and heavy head position before initiating the choke entry sequence.
...
<p class="section-subtitle">How do you train North-South Choke from Kuzure Kesa Gatame (Attacker)?</p>

**Phase 1: Mechanics Isolation** - Arm threading and shoulder placement
Practice the choking arm thread from Kuzure Kesa Gatame on a fully cooperative partner. Focus on feeding the arm deep under the neck, finding the carotid pocket with your shoulder, and understanding the correct sprawl angle. No resistance, no finishing pressure. 20 repetitions per side.

**Phase 2: Transition Flow** - Full sequence from MSH to choke finish
Drill the complete transition from settled Kuzure Kesa Gatame through the rotational slide to north-south alignment and into the finishing position. Partner provides zero resistance but maintains realistic body positioning. Focus on maintaining constant chest contact throughout the movement and arriving in proper finishing position.
...
**Phase 4: Positional Sparring Integration** - Live application from Kuzure Kesa Gatame start
Start in Kuzure Kesa Gatame with full resistance. Attacker must read the situation to determine when the North-South Choke entry is available versus other attacks. Practice chaining with americanas and kimuras when the choke entry is defended. Rounds of 3 minutes with reset on escape or submission.
