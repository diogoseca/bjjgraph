...
---
title: "Body Triangle RNC | BJJ Submission | BJJ Graph"
description: "Master the Body Triangle RNC in BJJ. Complete finishing guide combining rear naked choke with body triangle compression for the highest-percentage back attack."
---
...
**Release Protocol**:
1. Release all pressure immediately upon any tap signal - both the RNC and body triangle
2. Release immediately if partner goes limp or shows any signs of unconsciousness including sudden body relaxation
3. If partner loses consciousness, release all pressure, place in recovery position, monitor breathing, and alert medical staff
4. If in doubt about partner's consciousness, release immediately - the position can always be re-established safely
...
[[Body Triangle RNC/Attacker|→ Full Attacker Guide]]
...
- **Verify body triangle security**: Confirm your figure-four leg configuration is tight around the opponent's lower ribs with your foot ...

- **Establish optimal upper body control**: Set your seat belt grip with the choking arm over the opponent's shoulder and control arm threaded u...

- **Break defensive hand fighting systematically**: Address the opponent's defensive grips using two-on-one wrist peels timed with body triangle pressur...

- **Create the choking angle**: Walk your hips slightly toward the choking arm side while maintaining full body triangle pressure. T...

- **Insert choking arm beneath the chin**: Slide your forearm blade-side under the opponent's chin using incremental advances rather than one e...

- **Lock the figure-four on the neck**: Thread your choking arm deep enough to place your hand on your opposite bicep muscle. Bring your rei...

- **Apply synchronized dual pressure**: Squeeze your elbows together to compress the carotid arteries while simultaneously increasing body t...

- **Monitor consciousness and complete the finish**: Watch for tap signals including hand taps, foot taps, verbal indication, and any distress sounds. Mo...


### Common Mistakes


- **Rushing to slide the choking arm under the chin before systematically breaking the opponent's defensive grips**
...
- **Releasing body triangle squeeze pressure while focusing exclusively on the choke mechanics**
...
- **Placing the forearm across the chin or jaw rather than targeting the throat and carotid arteries**
...
[[Body Triangle RNC/Defender|→ Full Defender Guide]]
...
**Classic Body Triangle to RNC**: Standard progression from established body triangle with seat belt grip. Break defensive grips systematically using body triangle pressure pulses, create choking angle through hip adjustment, and slide forearm under chin for the finish. (When to use: Default approach when you have established body triangle with good seat belt control and opponent is playing standard defensive posture with chin tucked and hands fighting.)


**Short Choke to RNC Switch**: Begin by threatening a short choke across the chin or jaw to force the opponent to lift their chin defensively. When they adjust chin position to address the jaw pressure, switch to the full RNC by sliding the forearm underneath the now-elevated chin. (When to use: When opponent maintains extremely tight chin tuck that prevents standard forearm insertion under the jaw and your grip breaking attempts are not creating sufficient neck access.)


**Gift Wrap to Body Triangle RNC**: Secure the gift wrap arm trap from body triangle position by threading their arm across their own body and controlling it behind their head. This eliminates one defensive arm entirely, making the RNC insertion virtually undefendable with only one hand remaining for defense. (When to use: When opponent commits one arm to attacking the body triangle lock or reaches back to fight your legs, creating the opportunity to trap that arm across their body.)
...
Successful execution of Body Triangle RNC leads to → [[game-over|Game Over]]
