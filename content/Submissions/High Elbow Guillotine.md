...
## Common Mistakes
- **Mistake**: Keeping elbow low and parallel to ground instead of elevated above shoulder line
...
- **Mistake**: Neglecting non-choking shoulder pressure and relying only on forearm squeeze
...
- **Mistake**: Allowing distance between hips and opponent's body during finish attempt
...
- **Mistake**: Jerking or spiking the submission with sudden explosive pressure
...
- **Mistake**: Failing to adjust when opponent turns into the choke successfully
...
- **Mistake**: Gripping over opponent's chin instead of around their neck
...
- **Mistake**: Looking away from opponent or failing to monitor their facial responses
...
- **Mistake**: Crossing feet while finishing from guard position
...
**Q9**: Your opponent starts to posture up while you have the high elbow guillotine locked - what grip adjustment prevents their escape?
...
- [[Snap Down]] - Setup sequence - creating the initial front headlock control from standing
