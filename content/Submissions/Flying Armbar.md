...
---
title: "Flying Armbar | BJJ Submission Family | BJJ Graph"
...
|---------------|-------------|-----------------|----------------|
| [[Flying Armbar/from Closed Guard|Closed Guard]] | 40% | Elbow hyperextension or ligament tears (opponent) |  |
...
- [[Submissions/Far Side Armbar]] - Ground-based armbar variant sharing core arm isolation and hip mechanics essential for the flying version
- [[Submissions/Armbar]] - Related arm lock attacking from opposite direction, useful chain when flying entry overshoots
- [[Submissions/Triangle Choke]] - Primary backup submission when flying armbar entry succeeds but arm escapes leg configuration
- [[Transitions/Arm Triangle]] - Alternative upper body submission available from scramble positions after failed aerial entries
- [[Submissions/Omoplata]] - Alternative shoulder attack from similar guard positions sharing leg-over-shoulder mechanics
- [[Submissions/Flying Kneebar]] - Related aerial leg lock requiring similar athletic ability, timing, and commitment to dynamic entry
- [[Submissions/Bicep Slicer]] - Compression submission that can be chained when opponent defends armbar by bending the elbow
- [[Submissions/Belly Down Armbar]] - Related armbar finish sharing hip and arm isolation mechanics applicable after aerial scramble
- [[Submissions/Kimura]] - Alternative shoulder lock available from guard positions used to set up flying armbar entries
- [[Transitions/Guillotine Choke]] - Standing submission sharing similar clinch-range setups and commitment to dynamic finishing
...
- [[Positions/Closed Guard]] - Common starting position for flying armbar setup when opponent stands to break guard
...
- [[Submissions/Omoplata]] - Alternative shoulder attack from similar guard positions sharing leg mechanics
- [[Submissions/Flying Kneebar]] - Related aerial leg lock requiring similar athletic ability and timing
- [[Positions/Armbar Control]] - Control position established after successful aerial entry requiring immediate stabilization
