...
---
title: "Arm Triangle from Scarf Hold | BJJ Submission | BJJ Graph"
description: "Master the Arm Triangle choke from Scarf Hold in BJJ. Expert guide covering setup mechanics, finishing details, defense strategies, and training progressions."
---
...
**Release Protocol**:
1. Release immediately upon any tap signal by opening the grip connection and removing arm pressure from the neck
2. If partner shows signs of distress but has not tapped, stop all pressure and verbally confirm their status before continuing
3. If in doubt about whether a tap occurred, always release—the position can be re-established safely
4. If partner loses consciousness, release immediately, place them in recovery position on their side, monitor breathing, and seek medical attention if they do not regain consciousness within 20 seconds
...
[[Arm Triangle from Scarf Hold/Attacker|→ Full Attacker Guide]]
...
- **Consolidate Scarf Hold Control**: Ensure solid scarf hold with your arm wrapped around the opponent's head, their near arm trapped und...

- **Drive Opponent's Arm Across Their Neck**: Use your chest pressure and free hand to push the opponent's trapped arm across their face and neck ...

- **Thread Choking Arm Around the Head**: Release the standard scarf hold head wrap and immediately thread your arm deeper around the opponent...

- **Connect Figure-Four or Gable Grip**: Reach through with the threading arm and connect your hands in a figure-four grip (one hand gripping...

- **Switch Hips to Chest-to-Chest Alignment**: Pivot your hips from the perpendicular scarf hold angle to face the opponent chest-to-chest. Walk yo...

- **Drop Shoulder and Set Compression Angle**: Lower your shoulder on the choking arm side into the crook of the opponent's neck, driving their tra...

- **Apply Progressive Squeeze for the Tap**: Squeeze your connected arms together while simultaneously walking your hips toward the opponent's he...
...
[[Arm Triangle from Scarf Hold/Defender|→ Full Defender Guide]]
...
**Standard Arm Drive Entry**: The classic entry where you use chest pressure and your free hand to drive the opponent's trapped arm across their face and neck from kesa gatame. Pin the arm against their neck before releasing head control to thread the choking arm around and connect the figure-four grip. (When to use: When opponent's trapped arm is relaxed or positioned near their face and you have a stable scarf hold with heavy chest pressure)


**Americana Defense Transition**: When the opponent defends an americana attempt by pulling their arm tight across their chest and turning inward, their forearm crosses their own neck line. Immediately abandon the americana and redirect to the arm triangle by threading your arm around the head and connecting the grip, converting their defensive reaction into a choke entry. (When to use: When opponent actively defends a shoulder lock by pulling their arm across their body toward the far shoulder)


**Push Defense Redirect**: When the bottom player pushes against your chest or head with their trapped arm to create escape space, redirect the pushing arm across their neck using the momentum of their own push. Guide the arm into position rather than fighting it, then secure the head wrap and connect grips before they can retract the arm. (When to use: When opponent pushes against your chest or face during scarf hold control, creating the arm positioning needed for the choke)
...
Successful execution of Arm Triangle from Scarf Hold leads to → [[game-over|Game Over]]
