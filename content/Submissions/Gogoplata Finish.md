...
---
title: "Gogoplata Finish | BJJ Submission | BJJ Graph"
description: "Master the Gogoplata Finish in BJJ. Complete guide covering shin-across-throat mechanics, finishing details, and safety protocols from rubber guard positions."
---
...
2. If opponent goes limp or stops responding, release immediately and alert training partners and instructor
3. If in doubt about whether a tap occurred, release and re-establish position if needed
4. After release, allow opponent adequate recovery time before resuming as tracheal submissions cause lingering discomfort
...
[[Gogoplata Finish/Attacker|→ Full Attacker Guide]]
...
- **Confirm Shin Alignment**: Verify that your shin is positioned perpendicular across the opponent's trachea, not angled across t...

- **Deepen Foot Position**: Use both hands to pull your own foot deeper behind the opponent's head, eliminating any slack in the...

- **Establish Finishing Grips**: Position both hands on your shin or ankle area with palms facing down, creating a strong pulling fra...

- **Elevate Hips Maximally**: Drive your hips upward toward the ceiling using core engagement and the posted foot of your non-chok...

- **Initiate Head Pull**: Begin pulling the opponent's head downward into your shin using both hands simultaneously. The pulli...

- **Progressive Tightening Sequence**: Incrementally increase compression by simultaneously deepening foot position, increasing hip elevati...

- **Monitor Opponent Response**: Watch and feel for tap signals while maintaining compression. Be aware of verbal taps, physical taps...

- **Complete the Finish**: Sustain the maximum compression achieved through the progressive tightening sequence until the oppon...


### Common Mistakes


- **Positioning the shin across the chin, jaw, or face instead of directly on the trachea**
...
- **Allowing hips to drop to mat level during the finishing sequence**
...
- **Using explosive jerking motions to pull the head into the shin rather than progressive tightening**
...
[[Gogoplata Finish/Defender|→ Full Defender Guide]]
...
**Standard Pull Finish**: The classic gogoplata completion from established Gogoplata Control. Both hands grip behind your own shin or ankle area, pulling the opponent's head down while elevating hips to drive the shin into the trachea. This is the highest-percentage variation because the control position is already established. (When to use: When you have full Gogoplata Control with deep foot position behind opponent's head and stable hip elevation)


**Overhook-Assisted Gogoplata**: Uses an overhook on the opponent's arm to create additional leverage and prevent them from hand-fighting the foot position. One arm overhooks while the other controls the shin, creating a tighter configuration that limits defensive options. Particularly effective against opponents who aggressively hand-fight the foot position. (When to use: When opponent actively uses their hands to fight your foot position behind their head)


**Mounted Gogoplata**: Executed from high mount by threading the shin across the throat from a top position. The attacker brings one leg up and across the opponent's throat while maintaining mount base with the other leg. Less common due to the unusual flexibility angle required from top, but devastating when opponent is flattened and unable to bridge. (When to use: When holding High Mount against a flattened opponent who has stopped defending upper body attacks)
...
Successful execution of Gogoplata Finish leads to → [[game-over|Game Over]]
