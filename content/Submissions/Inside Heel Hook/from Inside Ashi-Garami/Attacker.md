...
---
title: "Inside Heel Hook from Inside Ashi-Garami Attacker | BJJ Submission Guide | BJJ Graph"
description: "Learn to execute the Inside Heel Hook from Inside Ashi-Garami. Step-by-step finishing mechanics, grip sequences, and systematic attacking methodology for BJJ leg locks."
---


<body data-content-type="submissions">

> **SAFETY**: Inside Heel Hook from Inside Ashi-Garami targets the Knee and ankle joint. Risk: ACL (anterior cruciate ligament) tear from rotational force exceeding joint tolerance. Release immediately upon tap.
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Execute Inside Heel Hook from Inside Ashi-Garami in BJJ",
  "description": "Step-by-step guide for Inside Heel Hook from Inside Ashi-Garami with safety protocols.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Verify entanglement stability",
      "text": "Confirm your inside leg is positioned across opponent's near hip with your foot planted on their far side, creating rotational control. Verify your outside leg hooks behind their knee with instep engaged against the back of the knee joint. Check perpendicular body alignment and hip-to-hip connection before initiating any grip work toward the heel.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Dominate the knee line",
      "text": "Use your inside leg to drive across the opponent's hip, preventing their knee from rotating inward or outward past the defensive barrier. Your outside leg hook behind the knee should actively control knee flexion, keeping the leg bent and trapped. This knee line control eliminates the rotational escapes that are the defender's primary survival mechanism from this entanglement.",
      "position": 2
    },
    {
      "@type": "HowToStep",
    ...
    },
    {
      ...
      "text": "Begin rotating the heel toward the outside of opponent's hip by driving your elbows toward your own chest while your torso rotates slightly away from the opponent. Build tension gradually and progressively—never jerk or spike the rotation. Maintain hip pressure and leg hook control throughout to prevent any escape attempt during this critical phase.",
      "position": 6
    },
    {
      "@type": "HowToStep",
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "What control elements must be established before attempting the heel hook finish from Inside Ashi-Garami and why is the sequence important?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The elements in order are: (1) inside leg positioned across opponent's near hip with foot planted on far side controlling rotation, (2) outside leg hooked behind opponent's knee securing the trapped leg, (3) establish hip-to-hip connection with perpendicular body alignment, (4) control the knee line to prevent defensive rotation past the barrier, and (5) clear opponent's defensive grips and frames. The sequence matters because each element builds on the previous one—without the inside leg frame, hip pressure is unstable; without the outside hook, the leg can be extracted; without hip pressure, knee line control is ineffective. Skipping any element dramatically reduces finish probability and increases escape risk."
      }
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      "name": "What is the most common finishing error that reduces submission effectiveness from Inside Ashi-Garami?",
      "acceptedAnswer": {
        "@type": "Answer",
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Inside Heel Hook from Inside Ashi-Garami Attacker",
  "description": "Learn to execute the Inside Heel Hook from Inside Ashi-Garami. Step-by-step finishing mechanics, grip sequences, and systematic attacking methodology for BJJ leg locks.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Graph",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://bjjgraph.org/Submissions/Inside-Heel-Hook-from-Inside-Ashi-Garami"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjgraph.org/Submissions/Inside-Heel-Hook-from-Inside-Ashi-Garami/Attacker"
    }
  ]
}
</script>
...
<p class="section-subtitle">What are the key principles for executing Inside Heel Hook from Inside Ashi-Garami?</p>

- Establish complete positional control (inside leg across hip, outside leg behind knee, hip pressure, knee line) before reaching for the heel
...
<p class="section-subtitle">What do you need before attempting Inside Heel Hook from Inside Ashi-Garami?</p>

- Inside leg positioned across opponent's near hip with foot planted on their far side, controlling distance and preventing hip rotation
- Outside leg hooked behind opponent's knee with instep engaged, securing the trapped leg and preventing extraction or straightening
...
<p class="section-subtitle">How do you execute Inside Heel Hook from Inside Ashi-Garami step by step?</p>

1. **Verify entanglement stability**: Confirm your inside leg is positioned across opponent's near hip with your foot planted on their far side, creating rotational control. Verify your outside leg hooks behind their knee with instep engaged against the back of the knee joint. Check perpendicular body alignment and hip-to-hip connection before initiating any grip work toward the heel. (Timing: 2-3 seconds to audit all control points)
2. **Dominate the knee line**: Use your inside leg to drive across the opponent's hip, preventing their knee from rotating inward or outward past the defensive barrier. Your outside leg hook behind the knee should actively control knee flexion, keeping the leg bent and trapped. This knee line control eliminates the rotational escapes that are the defender's primary survival mechanism from this entanglement. (Timing: Continuous throughout the submission attempt)
...
<p class="section-subtitle">What mistakes should you avoid when executing Inside Heel Hook from Inside Ashi-Garami?</p>
...
- **Correction**: Follow the control hierarchy strictly: inside leg across hip, outside leg behind knee, hip pressure, knee line control, clear grips, THEN reach for heel. Position before submission every time.
...
- **Correction**: Before any grip work, ensure your inside leg drives across their hip and your outside leg hooks behind the knee preventing knee rotation. The knee line must be blocked throughout the entire sequence from grip to finish.
...
<p class="section-subtitle">How do you train Inside Heel Hook from Inside Ashi-Garami (Attacker)?</p>
...
From established Inside Ashi-Garami, practice the full sequence: verify leg hooks, dominate knee line, clear grips, secure heel, establish figure-four, apply controlled rotation. Partner provides light defensive grips (25-50% resistance). Focus on smooth transitions between steps without losing positional control.
...
**Phase 4: Live Situational Sparring** - Full-speed application from Inside Ashi-Garami with progressive resistance
Positional sparring starting from established Inside Ashi-Garami. Attacker works to finish, defender works to escape. Full resistance with strict safety protocols—attacker applies finishing rotation slowly even in live rounds. Reset on submission or escape. Build timing, pressure sensitivity, and competition-realistic application.
