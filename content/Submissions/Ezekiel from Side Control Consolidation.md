...
---
title: "Ezekiel from Side Control Consolidation | BJJ Submission | BJJ Graph"
description: "Master the Ezekiel choke from Side Control Consolidation in BJJ. Complete guide covering sleeve grip setup, finishing mechanics, and defensive counters."
---
...
**Release Protocol**:
1. Release all choking pressure immediately upon any tap signal without hesitation
2. If partner goes limp or stops responding, release immediately and place in recovery position
3. If in doubt whether a tap occurred, release and verify before re-engaging
4. Monitor partner for delayed symptoms including coughing, difficulty swallowing, or voice changes after release
...
[[Ezekiel from Side Control Consolidation/Attacker|→ Full Attacker Guide]]
...
[[Ezekiel from Side Control Consolidation/Defender|→ Full Defender Guide]]
...
**Standard Crossface Entry**: The fundamental setup using the existing crossface arm threaded under the opponent's head during normal side control consolidation. The crossface hand grips the own bicep while the free hand threads into the sleeve to complete the choke loop. This is the highest-percentage entry because it requires minimal positional adjustment from standard control. (When to use: When you have established solid crossface control and the opponent is focused on defending hip-based attacks like americana or kimura)


**Americana Bait to Ezekiel**: Threaten the americana on the near arm to draw the opponent's far hand across their body in defense. As they commit their defensive hand to protecting the shoulder, immediately abandon the americana and thread your free hand into the sleeve for the Ezekiel. The opponent's defensive hand is now out of position to block the choke entry. (When to use: Against opponents who aggressively defend the americana with their far hand, creating an opening at the neck)


**Fist Variation**: Instead of using the blade of the forearm across the throat, make a tight fist inside the sleeve and drive the knuckles directly into the soft tissue below the Adam's apple. This creates a more focused pressure point that produces a faster tap through tracheal discomfort, though it is less mechanically efficient as a blood choke. (When to use: When the opponent has a thick neck or strong chin tuck that prevents the forearm from accessing the carotid arteries effectively)
...
Successful execution of Ezekiel from Side Control Consolidation leads to → [[game-over|Game Over]]
