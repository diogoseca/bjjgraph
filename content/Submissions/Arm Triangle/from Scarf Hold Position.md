...
---
title: "Arm Triangle from Scarf Hold Position | BJJ Submission | BJJ Graph"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Arm Triangle from Scarf Hold Position", "item": "https://bjjgraph.org/Submissions/Arm-Triangle-from-Scarf-Hold-Position" }
  ]
}
</script>
...
Successful execution of Arm Triangle from Scarf Hold Position leads to → [[game-over|Game Over]]
