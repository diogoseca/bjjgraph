...
---
title: "Toe Hold from 50-50 Guard | BJJ Submission | BJJ Graph"
description: "Master the toe hold from 50-50 guard in BJJ. Learn figure-four grip mechanics, rotational finishing details, and key defensive counters for this leg lock."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Toe Hold from 50-50 Guard", "item": "https://bjjgraph.org/Submissions/Toe-Hold-from-50-50-Guard" }
  ]
}
</script>
...
- **Identify foot position and create access**: From 50-50 top position, assess the opponent's foot position within the entanglement. If their heel ...

- **Secure initial grip on toes and ball of foot**: With your primary hand (typically the hand on the same side as the targeted foot), cup across the op...

- **Thread the figure-four arm behind the ankle**: Pass your opposite arm behind the opponent's Achilles tendon and ankle, threading it through until y...

- **Lock the figure-four and consolidate control**: Secure the figure-four by gripping your own wrist with the threading hand (gable grip or wrist-to-wr...

- **Align hips for rotational pressure**: Position your hips so that hip extension will drive the foot into inward rotation (twisting the toes...

- **Apply controlled rotational pressure**: Slowly extend your hips away from the opponent while simultaneously pulling the foot toward your che...

- **Maintain pressure through defensive reactions**: As the opponent feels the pressure, they will attempt to rotate, grip fight, or bridge to relieve to...
...
**Standard figure-four toe hold**: Classic grip where the attacking hand cups across the toes and ball of the foot while the opposite arm threads behind the Achilles to complete the figure-four. Pressure is generated by pulling the foot toward your chest while extending your hips away from the opponent. (When to use: Default entry when opponent's foot is accessible and you have a clear path to thread the figure-four grip behind the ankle)


**Heel hook feint to toe hold**: Begin attacking the heel hook to force your opponent to hide their heel by tucking it inward. As they rotate the knee to protect the heel, their foot extends and the toes become accessible for the toe hold grip. The transition happens in the moment between their heel defense and repositioning. (When to use: Against opponents with strong heel hook defense who consistently hide the heel, creating a forced choice between heel exposure and foot exposure)


**Outside foot toe hold**: Instead of attacking the inside foot trapped in the entanglement, target the opponent's outside foot that may be posted or free. Requires releasing one leg from the 50-50 to access the outside foot, then securing the figure-four from a modified angle with your body perpendicular to the opponent. (When to use: When the inside foot is well defended but the opponent's outside foot is posted on the mat or accessible due to poor leg positioning)
