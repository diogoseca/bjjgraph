...
---
title: "Outside Heel Hook Attacker | BJJ Submission Guide | BJJ Graph"
description: "How to execute Outside Heel Hook in BJJ. Attacking perspective with setup, execution, and finishing mechanics from outside leg entanglements."
---
...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for Outside Heel Hook with safety protocols.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Establish outside ashi-garami position",
      "text": "Secure outside ashi-garami with your inside leg hooking over opponent's hip and your outside leg controlling their trapped leg from the outside. Your inside leg should prevent them from rotating their knee line toward you, which is their primary defense. Ensure you have broken their grips on your legs and that your position is stable before proceeding to heel control.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Cup the heel with both hands",
      "text": "Reach over the top of opponent's foot and cup their heel with both hands, creating a figure-four grip or similar secure configuration. Your forearm should run along the bottom of their foot with the heel secured in the crook of your elbow. The grip should be firm but the focus is on control, not pressure. Ensure the blade of the forearm is positioned across the Achilles tendon area for maximum control.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Extend hips to create leg straightness",
      "text": "Push your hips forward toward your opponent while maintaining heel control, creating extension in their trapped leg. This removes slack from the system and begins to load tension into the knee joint. The leg should become relatively straight but not hyperextended. Your inside leg must maintain constant pressure on their hip to prevent defensive rotation. This extension is crucial for the submission to function properly.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Position heel for rotational control",
      "text": "Adjust your grip so the heel is secured with maximum rotational potential. The heel should be cupped deep into the crook of your elbow, with your hands locked together (figure-four or gable grip). Your forearm becomes the lever that will rotate the foot. Ensure your chest is tight to the heel and foot, eliminating any space that would reduce control. The opponent's toes should be pointing slightly away from their centerline.",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Apply slow outside rotation to heel",
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the minimum application time for an outside heel hook in training, and why is this critical?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The minimum application time is 5-7 seconds of slow, progressive pressure. This is critical because knee ligament damage from heel hooks occurs extremely rapidly once the failure threshold is crossed. Unlike joint locks where there is some warning pain, heel hooks can cause catastrophic ACL, MCL, and meniscus tears with minimal warning. Slow application in training gives partners adequate time to recognize the danger and tap safely, preventing career-ending injuries."
      }
    },
    {
      "@type": "Question",
      "name": "Why must you control the opponent's hip with your inside leg before attempting the outside heel hook?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Controlling the opponent's hip with your inside leg prevents them from rotating their knee line inward toward you, which is their primary defensive movement. If they can rotate their knee line, they reduce the torque on the joint and can escape the submission. Additionally, hip control maintains your outside positioning which is essential for the mechanics of the outside heel hook to function properly. Without this control, the submission is ineffective and the position is vulnerable to escape or reversal."
      }
    },
    {
      "@type": "Question",
      "name": "What are the five primary structures at risk of injury during an outside heel hook?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "What is the correct direction of rotation for an outside heel hook and how does this differ from an inside heel hook?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "What should you do immediately if your training partner taps to your outside heel hook?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Why is hip extension important before applying rotational pressure in the outside heel hook?",
      "acceptedAnswer": {
        "@type": "Answer",
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Outside Heel Hook Attacker",
  "description": "How to execute Outside Heel Hook in BJJ. Attacking perspective with setup, execution, and finishing mechanics from outside leg entanglements.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Graph",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjgraph.org/Submissions/Outside-Heel-Hook/Attacker"
    }
  ]
}
</script>
...
### 1. Applying sudden or jerking rotation to the heel
...
### 2. Attempting submission before securing positional control
...
### 3. Failing to control opponent's hip with inside leg
...
### 4. Insufficient hip extension before rotation
...
### 5. Cupping the heel loosely or with improper grip configuration
...
### 6. Looking away from partner during finish
...
### 7. Rotating toward inside instead of outside
...
**Phase 1: Positional Control** - Outside ashi-garami maintenance without submissions
Establish and maintain outside ashi-garami position against progressive resistance. Focus exclusively on hip control with inside leg, leg triangle tightness, and preventing opponent's defensive rotation. No heel gripping or submission attempts. Build the positional foundation that all finishing mechanics depend on. Drill 5-minute rounds of position maintenance.

**Phase 2: Grip Mechanics and Extension** - Heel cup configuration and hip extension without rotation
From established outside ashi-garami, practice cupping the heel with proper figure-four grip and creating hip extension to remove slack. Partner remains passive. Focus on grip depth, forearm blade placement across Achilles, chest-to-heel connection, and full leg extension through hip drive. No rotational pressure applied. Build muscle memory for proper setup mechanics.

**Phase 3: Controlled Finishing** - Slow rotation with cooperative partner and immediate release
With a cooperative partner, practice the complete sequence from position to slow rotational finish at absolute minimum speed. Partner taps immediately upon feeling any pressure. Practice the release protocol after every repetition. Focus on maintaining all control points during rotation. Gradually increase partner's defensive movement while maintaining slow, controlled application speed.

**Phase 4: Chain Attacks and Live Application** - Submission chains and positional sparring from leg entanglements
Begin positional sparring from outside ashi-garami with partner defending at increasing resistance levels. When heel hook is defended, chain to kneebar, toe hold, inside ashi transition, or back take. Practice recognizing when to commit to the finish versus when to transition. Maintain strict safety protocols during all live training. Graduate to full leg lock sparring rounds with trusted partners only.
