...
---
title: "Triangle from De La Riva Attacker | BJJ Submission Guide | BJJ Graph"
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Triangle from De La Riva Attacker",
  "description": "How to execute Triangle from De La Riva in BJJ. Attacking perspective with setup, execution, and finishing mechanics.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Graph",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjgraph.org/Submissions/Triangle-from-De-La-Riva/Attacker"
    }
  ]
}
</script>
...
**Phase 2: Triangle Lock and Angle Creation** - Connecting the leg swim to the triangle lock, emphasizing the figure-four configuration and perpendicular angle
