...
description: "Master Triangle from Guard in BJJ. Complete safety guide covering setup, execution, and finish. Success rates: Beginner 35%, Intermediate 50%, Advanced 65%."
---
...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for Triangle from Guard with safety protocols.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Break Posture and Control Arm",
      "text": "From closed guard, establish a strong collar grip with one hand and sleeve grip with the other. Break the opponent's posture by pulling down on the collar while simultaneously pulling one arm across your centerline. The opponent's elbow should cross your body's midline, creating the angle needed for triangle entry. Use your legs to squeeze and assist in breaking posture if needed.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Create Angle and Swing Leg Over",
      "text": "While maintaining the broken posture, use your hips to create a 45-degree angle to the side of the arm you're attacking. Open your guard and immediately swing your leg (same side as the attacking arm) high over the opponent's shoulder and behind their head. The back of your knee should touch the side of their neck. Keep the other leg active on their hip to prevent them from posturing up or passing.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Lock the Triangle Configuration",
      "text": "Bring your opposite leg across to create the figure-four lock. Place your ankle behind the knee of the leg that's over their shoulder. Ensure the opponent's shoulder is pulled tight to your hip - this is critical as their own shoulder will be compressing one side of their neck. The trapped arm should be pulled across your body, keeping their elbow tight to your centerline.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Adjust Angle for Optimal Compression",
      "text": "Once locked, immediately adjust your angle to approximately 45 degrees from your opponent's centerline. This angle is crucial - being too square allows them to stack you, being too perpendicular reduces pressure. Scoot your hips toward the side of their trapped arm while simultaneously pulling their head down. Your legs should form a straight line from their shoulder through their neck.",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Secure Head Control",
      "text": "Grab behind the opponent's head with both hands, interlacing fingers or using a gable grip. Pull their head down toward your chest while keeping their trapped arm tight across your body. The pulling motion should be smooth and controlled, not jerking. Some practitioners prefer to control the arm at the wrist or triceps instead of grabbing the head directly.",
      "position": 5
    },
    {
      "@type": "HowToStep",
      "name": "Squeeze and Finish",
      "text": "Squeeze your knees together while simultaneously pulling down on the head and lifting your hips slightly. The pressure comes from three directions: legs squeezing together, hips lifting, and hands pulling head down. Apply pressure progressively over 3-5 seconds in training. Monitor partner's reaction closely and release immediately upon tap. The choke works by compressing both carotid arteries - one against their own shoulder, one against your leg.",
      "position": 6
    }
  ],
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 3, "name": "Triangle from Guard", "item": "https://bjjgraph.org/Submissions/Triangle-from-Guard"}
  ]
}
</script>
...
2. Pull opponent's head out of triangle while opening legs
3. Release arm trap and allow opponent to posture up
4. Check on partner's condition and ensure full recovery before continuing
5. Never maintain pressure after tap signal
...
**Triangle from Omoplata Entry**: When setting up omoplata and opponent defends by rolling forward, use momentum to swing top leg over their head into triangle. Can also triangle from failed omoplata when they pull arm out. (When to use: Part of closed guard submission chain. When opponent defends omoplata with predictable patterns, triangle becomes available.)

**Triangle from De La Riva Guard**: From De La Riva with sleeve and collar control, use DLR hook to off-balance opponent forward while simultaneously swinging opposite leg high over their shoulder into triangle position. (When to use: When playing open guard and opponent drives forward with too much pressure. DLR hook creates perfect angle for triangle entry.)

**Reverse Triangle from Guard**: Instead of trapping opponent's arm across your body, trap it on the outside and lock triangle in reverse orientation. Finish by turning to side and applying pressure at different angle. (When to use: When opponent keeps arm on outside and prevents traditional triangle. Reverse triangle creates different compression angle.)
...
**Q2**: What is the correct angle to finish the triangle and why is this angle important?
**A**: The correct finishing angle is approximately 45 degrees to the opponent's centerline, achieved by scooting your hips toward the side of their trapped arm. This angle is critical because being too square (0 degrees) allows the opponent to stack you and pressure your lower back, while being too perpendicular (90 degrees) reduces the compression on the neck. The 45-degree angle maximizes pressure on the carotid arteries while preventing effective defensive counters like stacking or posturing. This angle also aligns your legs optimally for squeezing and makes it nearly impossible for the opponent to turn or escape.

**Q3**: How should pressure be applied when finishing the triangle in training, and what is the critical safety concern? **[SAFETY-CRITICAL]**
**A**: In training, pressure must be applied progressively over 3-5 seconds minimum, never with sudden jerking or spiking motions. The choke should be squeezed smoothly by combining three actions: squeezing knees together, pulling head down, and slightly lifting hips. The critical safety concern is that this is a blood choke targeting the carotid arteries, not a neck crank. Jerking or violent application can cause cervical spine injury, neck strain, or panic. You must also release immediately upon any tap signal to prevent loss of consciousness. Competition speed should never be used in training, and beginners should only practice with cooperative drilling before live application.

**Q4**: What are the three components of creating maximum pressure in the triangle finish?
**A**: Maximum pressure comes from three simultaneous actions working together: (1) Squeezing the knees together to compress the legs around the neck, (2) Pulling the opponent's head down toward your chest using a grip behind their head or on their collar, and (3) Lifting your hips slightly to create upward pressure while maintaining the 45-degree angle. These three pressure vectors combine to compress both carotid arteries maximally - one against your leg and one against the opponent's own shoulder. Any one component alone is insufficient; all three must work in coordination.

**Q5**: Why must posture be broken before attempting the triangle, and what happens if you try to triangle someone in strong posture?
**A**: Posture must be broken first because an opponent in strong upright posture has their base established, their neck is protected, and they can easily prevent your leg from getting over their shoulder. If you attempt triangle entry against good posture, they will simply maintain base, block your leg with their free arm, and pass your guard. Breaking posture with collar and sleeve grips before entry accomplishes several things: brings their head and shoulders forward into range, compromises their base making them vulnerable to being swept or submitted, and creates the forward angle needed for your leg to swing over their shoulder. Patient posture breaking is the foundation of successful triangle entry.

**Q6**: What should you immediately do if your training partner taps while you have a triangle locked, and why is this response critical? **[SAFETY-CRITICAL]**
**A**: You must immediately release all pressure and open the triangle configuration the instant you feel or hear any tap signal. This means opening your legs, releasing the figure-four lock, pulling their head out of the triangle, and allowing them to posture up and recover. This immediate release is critical because the triangle is a blood choke that can cause loss of consciousness within seconds if pressure continues after tap. Maintaining pressure after tap serves no training purpose and creates serious injury risk including unconsciousness, panic, neck injury, or long-term damage to the training relationship. There is absolutely zero legitimate reason to hold a submission after tap in any training context.

**Q7**: If the opponent successfully stacks you during triangle finish, what adjustments should you make?
**A**: If the opponent succeeds in stacking you by driving forward and pressuring your shoulders toward the mat, you must immediately adjust your angle to become more perpendicular to their body (closer to 90 degrees from original 45-degree angle). Use your hands to push on their hip while simultaneously scooting your shoulders away from them to relieve the stack pressure. If the stack becomes too severe and you can't maintain effective triangle, transition to omoplata by releasing one leg and swinging it over their back while controlling their trapped arm. Fighting to maintain a badly stacked triangle wastes energy and increases lower back injury risk. Smooth transition to omoplata or armbar is more effective than stubbornly maintaining compromised triangle.

**Q8**: Your opponent starts to posture up while you have your leg over their shoulder but haven't locked the triangle yet - what finishing adjustment prevents escape?
**A**: The moment you feel them beginning to posture, immediately pull down hard on their head with both hands while simultaneously driving your hips upward to bring your ankle behind your knee for the lock. Speed is critical here - you must complete the lock before they achieve full posture. If they're already posturing, use your free leg to hook behind their far armpit or shoulder to prevent them from sitting back. Once locked even with them posturing, aggressively scoot your angle perpendicular and pull their head down to break their posture from the locked position. The locked triangle gives you significantly more control than the unlocked position.

**Q9**: What anatomical structures does the triangle choke target and how does proper mechanics ensure effective compression? **[SAFETY-CRITICAL]**
**A**: The triangle choke targets both carotid arteries on the sides of the neck, which supply blood to the brain. Proper mechanics compress these arteries from two directions: your leg compresses one carotid artery against the opponent's neck, while their own trapped shoulder compresses the other carotid artery against the opposite side of their neck. This bilateral compression cuts off blood flow to the brain, causing unconsciousness typically within 8-12 seconds if held at full pressure. The jugular veins are also compressed, preventing venous return. This is why proper shoulder-to-hip connection is essential - without their shoulder being pulled tight to your hip, you lose the second compression point and the choke becomes ineffective.

**Q10**: When is the point of no escape for the opponent in a properly locked triangle, and what indicators confirm you've reached this point? **[SAFETY-CRITICAL]**
**A**: The point of no escape occurs when three conditions are met simultaneously: the triangle is locked deep with ankle behind knee, the proper 45-degree angle is established with your hips scooted toward the trapped arm side, and the opponent's shoulder is pulled completely tight against your hip with their posture fully broken. Indicators confirming this point include: opponent's face beginning to change color (reddening or darkening), their breathing becoming labored or stopping, their escape attempts becoming weaker or more frantic, and their trapped arm having no leverage to extract. At this point, even experienced practitioners cannot escape and the finish is inevitable - which is why progressive pressure and tap awareness remain critical.

**Q11**: What grip adjustments should you make during the finishing sequence if your opponent is defending by tucking their chin?
**A**: Tucking the chin is largely ineffective against a properly applied triangle since it's a blood choke, not an air choke - but opponents still instinctively do it. If they tuck their chin, first ensure your angle is correct at 45 degrees and your lock is deep. Then switch your grip from behind their head to controlling their trapped arm at the wrist or triceps, pulling it tighter across your centerline. This increases the pressure of their own shoulder against their neck. You can also use one hand to cup under their chin and push it upward while maintaining head control with the other hand, though this isn't necessary if mechanics are correct. The key is not to fight the chin directly but to maximize shoulder compression.

**Q12**: In competition, what strategies maximize finishing percentage when the opponent is intelligently defending the triangle?
**A**: In competition against intelligent defense, implement a systematic approach: First, establish the lock quickly and create maximum angle immediately rather than gradually - speed of angle creation is more important than speed of entry. Second, attack their posture relentlessly using collar grips and head control, never allowing them to establish an upright defensive position. Third, use combination threats - when they defend the triangle, immediately threaten armbar on the trapped arm, which forces them to defend the arm and weakens their triangle defense. Fourth, if they're defending by hiding their arm, switch to omoplata attacks. Fifth, use wristlocks on the trapped hand as a finishing alternative. The triangle should be viewed as part of a submission system, not an isolated attack.
...
- Safety: Establish habit of progressive pressure application. Never squeeze at full intensity even with cooperative partner. Learn to recognize proper depth of lock (shoulder to hip) versus incorrect high lock (on face/head).

**Slow Practice with Cooperative Movement** (Week 3-4)
- Focus: Partner provides mild, predictable resistance. Practice breaking posture from closed guard, creating angle, and executing triangle entry at slow speed. Focus on smooth transitions between steps rather than speed or power.
- Resistance: Mild resistance
- Safety: Begin communication protocols - partner should verbally indicate when pressure is felt on neck. Practice immediate release upon tap. No squeezing to finish at this stage, stop when triangle is locked and positioned correctly.

**Entry Repetition with Positional Reset** (Week 5-8)
- Focus: Drill triangle entries from multiple guard variations (closed, spider, De La Riva, open). If entry succeeds, lock triangle but don't finish - instead release and reset to starting position. Build muscle memory for recognizing triangle opportunities.
- Resistance: Realistic resistance
- Safety: Partner should defend entry but not escape once triangle is locked. This allows you to feel correct triangle position without the pressure of finishing. Emphasize that speed of entry should never compromise control or safety.

**Controlled Finishing with Progressive Pressure** (Week 9-12)
- Focus: Begin finishing triangles in positional sparring, but apply pressure progressively over 5-7 seconds. Partner should tap when they feel significant pressure, not wait until uncomfortable. Focus on angle adjustment and understanding how squeeze, head pull, and hip lift work together.
- Resistance: Realistic resistance
- Safety: This is critical safety phase. Develop habit of progressive pressure over minimum 5 seconds. Partner must tap early to allow multiple repetitions safely. Never spike or jerk the choke. Both partners should verbally communicate pressure levels.

**Live Application with Transitions** (Week 13+)
- Focus: Apply triangle in live sparring from guard. When opponent defends, transition smoothly to armbar or omoplata. Practice the complete submission chain rather than forcing one technique. Develop ability to recognize when triangle isn't available and transition early.
- Resistance: Full resistance
- Safety: Reduce application time to 3-5 seconds minimum as technique improves. Continue monitoring partner's reactions. Never maintain triangle after tap regardless of adrenaline or competitive emotion. Respect tap immediately 100% of the time.

**Ongoing Refinement and Advanced Variations** (Ongoing)
- Focus: Explore advanced variations: reverse triangle, triangle from failed armbar, triangle from standing, inverted triangle. Develop ability to hit triangle from any guard position. Study high-level competitors' triangle entries and finishes.
- Resistance: Full resistance
- Safety: As proficiency increases, danger actually increases due to confidence. Maintain strict safety protocols especially with less experienced partners. Use advanced variations only with partners who understand the specific risks. Continue treating every triangle in training as a teaching opportunity, not a proving ground.
...
- [[Closed Guard]] - Primary starting position for triangle entries with optimal control
- [[Spider Guard]] - Alternative starting position using foot on bicep to create triangle angle
- [[Triangle Control]] - Position achieved when triangle is locked but not yet finished
- [[Armbar from Guard]] - Primary transition when opponent defends triangle by posturing or pulling arm
- [[Omoplata]] - Alternative transition when triangle is stacked or defended
- [[De La Riva Guard]] - Open guard position offering triangle entry opportunities
- [[Lasso Guard]] - Guard variation that creates triangle angles against standing opponents
- [[Rubber Guard]] - Flexibility-based guard system with excellent triangle setups
- [[Mission Control]] - Rubber guard position that creates direct triangle entries
- [[Armbar Finish]] - Primary alternative when opponent defends triangle by pulling arm
- [[Inverted Triangle]] - Variation applied from different angle when standard triangle is defended
...
Successful execution of Triangle from Guard leads to → [[game-over|Game Over]]
