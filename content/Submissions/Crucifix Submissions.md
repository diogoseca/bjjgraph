...
---
title: "Crucifix Submissions | BJJ Submission | BJJ Graph"
description: "Master crucifix submissions in BJJ. Complete guide covering arm isolation, choke setups, and finishing mechanics. Success rates: Beginner 35%, Intermediate 55%, Advanced 75%."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Execute Crucifix Submissions in BJJ",
  "description": "Step-by-step guide for Crucifix Submissions with safety protocols.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Establish crucifix control",
      "text": "From back control or turtle, secure one opponent arm between your legs while trapping the other arm with your upper body. Your legs should form a tight figure-four or similar configuration around the trapped arm, with your hips tight to the opponent's back. The opponent's free arm should be controlled with your hands or trapped under your body weight.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Flatten opponent and consolidate position",
      "text": "Drive your hips forward into the opponent's back while distributing your weight across their upper back and shoulders. This flattens the opponent to the mat and eliminates their ability to create space or posture. Keep constant pressure with your legs on the trapped arm while maintaining control of the free arm. Your chest should be heavy on their shoulder area.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Secure head or collar control for choke",
      "text": "With the opponent flattened and both arms controlled, use your hands to establish a collar grip or direct head control. For gi training, feed a lapel across the neck or establish a deep collar grip. For no-gi, slide your forearm under the chin or around the neck. Maintain all existing controls while establishing this grip - do not sacrifice arm isolation for the choke.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Apply choke or transition to armlock",
      "text": "Execute your chosen submission: For collar chokes, pull the collar tight across the carotid arteries while maintaining body pressure. For rear naked choke variations, slide your choking arm deep under the chin and secure with your other hand. For armlocks, shift your leg position on the trapped arm to create extension pressure on the elbow joint. Apply pressure slowly and progressively over 3-5 seconds minimum.",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Maintain position while increasing submission pressure",
      "text": "As you apply the submission, maintain all positional controls. Your hips stay tight to their back, your weight stays distributed across their shoulders, and both arms remain isolated. For chokes, gradually tighten the collar or arm pressure while keeping your body structure solid. For armlocks, incrementally extend the arm while controlling rotation with your legs.",
      "position": 5
    },
    {
      "@type": "HowToStep",
      "name": "Finish submission or switch attacks",
      "text": "Complete the submission by maintaining maximum pressure until tap, or if the opponent defends successfully, immediately switch to an alternative attack. Common switches include transitioning from choke to armlock, or from one choke variation to another. Never release all controls when switching - maintain at least the leg isolation on the trapped arm throughout all transitions.",
      "position": 6
    }
  ],
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What are the two fundamental arm controls that define the crucifix position?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The crucifix requires one arm trapped between your legs with a figure-four or similar tight leg configuration, while the other arm is controlled and isolated by your upper body or hands. Both arms must be simultaneously controlled and separated from the opponent's body to create the crucifix structure."
      }
    },
    {
      "@type": "Question",
      "name": "What anatomical structures are targeted by choke submissions from the crucifix position?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Crucifix chokes primarily target the carotid arteries on either side of the neck, restricting blood flow to the brain. This creates a blood choke that causes unconsciousness within seconds if not defended. Secondary pressure may affect the trachea (windpipe) which creates an air choke sensation but is less efficient for finishing. The ideal finish compresses the carotid arteries while minimizing tracheal pressure."
      }
    },
    {
      "@type": "Question",
      "name": "What indicators tell you the armlock from crucifix is properly positioned for the finish?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The armlock is ready for finish when: the opponent's elbow joint is positioned against your hip or thigh creating a fulcrum, your legs control the arm's rotation preventing them from turning the thumb up, the arm is isolated at roughly 90 degrees to their body, and you feel their shoulder beginning to elevate as you apply initial extension pressure. The breaking point is reached when further extension would hyperextend the elbow joint beyond its natural range."
      }
    },
    {
      "@type": "Question",
      "name": "Your opponent begins turning their chin toward your choking arm - what grip adjustment ensures the finish?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "When opponent turns their chin toward your choking arm, adjust by deepening your forearm penetration under their chin before they complete the turn. If they've already turned, switch to attacking the exposed side of the neck by threading your other arm under their chin from the opposite direction. Alternatively, abandon the choke temporarily and attack the now-exposed trapped arm with an armlock, using their defensive commitment against them."
      }
    },
    {
      "@type": "Question",
      "name": "What is the point of no escape for a properly applied crucifix choke?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The point of no escape occurs when your choking arm has penetrated deeply under the chin with the blade of your forearm across the carotid arteries, your other hand has secured behind the head or grabbed your own bicep completing the lock, and your body weight is committed forward preventing them from creating any space. Once the grip is locked and pressure begins, the opponent has approximately 3-5 seconds before unconsciousness regardless of their defensive efforts."
      }
    },
    {
      "@type": "Question",
      "name": "What common finishing error causes crucifix armlocks to fail even when the position is secured?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The most common finishing error is attempting to extend the arm before controlling rotation. When you extend without rotation control, the opponent can turn their thumb toward the ceiling and stack their shoulder, converting the hyperextension pressure into a more tolerable shoulder rotation. Correct this by using your legs to pin the arm with the thumb pointing down or outward, then applying extension while maintaining that rotational control throughout the finish."
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 3, "name": "Crucifix Submissions", "item": "https://bjjgraph.org/Submissions/Crucifix-Submissions"}
  ]
}
</script>
...
**Q2**: What anatomical structures are targeted by choke submissions from the crucifix position? **[SAFETY-CRITICAL]**
**A**: Crucifix chokes primarily target the carotid arteries on either side of the neck, restricting blood flow to the brain. This creates a blood choke that causes unconsciousness within seconds if not defended. Secondary pressure may affect the trachea (windpipe) which creates an air choke sensation but is less efficient for finishing. The ideal finish compresses the carotid arteries while minimizing tracheal pressure.

**Q3**: What indicators tell you the armlock from crucifix is properly positioned for the finish? **[SAFETY-CRITICAL]**
**A**: The armlock is ready for finish when: the opponent's elbow joint is positioned against your hip or thigh creating a fulcrum, your legs control the arm's rotation preventing them from turning the thumb up, the arm is isolated at roughly 90 degrees to their body, and you feel their shoulder beginning to elevate as you apply initial extension pressure. The breaking point is reached when further extension would hyperextend the elbow joint beyond its natural range.

**Q4**: Your opponent begins turning their chin toward your choking arm - what grip adjustment ensures the finish?
**A**: When opponent turns their chin toward your choking arm, adjust by deepening your forearm penetration under their chin before they complete the turn. If they've already turned, switch to attacking the exposed side of the neck by threading your other arm under their chin from the opposite direction. Alternatively, abandon the choke temporarily and attack the now-exposed trapped arm with an armlock, using their defensive commitment against them.

**Q5**: What is the point of no escape for a properly applied crucifix choke? **[SAFETY-CRITICAL]**
**A**: The point of no escape occurs when your choking arm has penetrated deeply under the chin with the blade of your forearm across the carotid arteries, your other hand has secured behind the head or grabbed your own bicep completing the lock, and your body weight is committed forward preventing them from creating any space. Once the grip is locked and pressure begins, the opponent has approximately 3-5 seconds before unconsciousness regardless of their defensive efforts.

**Q6**: What common finishing error causes crucifix armlocks to fail even when the position is secured?
**A**: The most common finishing error is attempting to extend the arm before controlling rotation. When you extend without rotation control, the opponent can turn their thumb toward the ceiling and stack their shoulder, converting the hyperextension pressure into a more tolerable shoulder rotation. Correct this by using your legs to pin the arm with the thumb pointing down or outward, then applying extension while maintaining that rotational control throughout the finish.

**Q7**: How do you safely apply progressive pressure during crucifix submissions in training? **[SAFETY-CRITICAL]**
**A**: Apply pressure in gradual increments over 5-7 seconds for chokes and 3-5 seconds for armlocks, pausing briefly between pressure increases to allow your partner time to recognize the submission and tap. Never jerk, crank, or spike pressure. Maintain constant communication and watch for distress signals. If partner stops moving or becomes limp during a choke, release immediately - they may have lost consciousness. Always err on the side of applying too slowly rather than too quickly.

**Q8**: What control adjustments maximize finishing percentage when opponent strongly defends the choke by tucking their chin?
**A**: When chin defense is strong, first attempt to wedge your forearm under the chin using small incremental movements rather than force. If this fails, transition your attack to the trapped arm with an immediate armlock threat. This forces the opponent to choose between defending their arm or their neck. As they shift focus to the arm defense, their chin often loosens, creating the choke opening. Alternatively, use collar grips in gi to work around the chin by attacking from the collar side rather than directly under.

**Q9**: What distinguishes a finishing-ready crucifix armlock from one that will likely fail?
**A**: A finishing-ready position shows: tight leg squeeze maintaining constant pressure on the trapped arm, elbow joint clearly positioned over your hip or thigh fulcrum, arm isolated at proper angle away from their body, thumb rotated away from the ceiling indicating proper rotational control, and your hips remaining tight to their back preventing escape space. A likely-to-fail position shows: loose leg control allowing arm movement, elbow floating without solid fulcrum, thumb pointing up allowing shoulder stack, or space between your hips and their back.

**Q10**: In competition, what strategies maximize crucifix submission success rate when time pressure exists?
**A**: Under time pressure, prioritize the highest-percentage attack for your opponent's body type and defensive tendencies. Against flexible opponents, favor chokes over armlocks. Chain attacks rapidly - threaten the neck to force arm defense, then immediately attack the opened arm. Use your weight aggressively by driving hips forward and staying heavy. If one submission is defended, switch instantly without resetting. Accept that failing to finish still maintains a dominant position with point advantage rather than abandoning control for a desperate finish attempt.

**Q11**: What is the correct release protocol if your training partner goes unconscious from a crucifix choke? **[SAFETY-CRITICAL]**
**A**: Immediately release all choking pressure and leg controls completely. Roll partner onto their back if not already supine. Elevate their legs slightly above heart level. Monitor breathing - unconscious partners should resume breathing within 10-20 seconds. If breathing doesn't resume, begin rescue breathing. Stay calm and never shake or slap the person. Call for instructor assistance immediately. Once conscious, have partner rest and do not allow them to immediately resume training. Document the incident and review what caused the delayed tap.

**Q12**: How does hip position affect the breaking mechanics of the crucifix armlock?
**A**: Hip position determines the lever arm and fulcrum placement for the armlock. Hips tight to opponent's back positions your thigh or hip bone directly under their elbow, creating an efficient fulcrum that requires minimal force for maximum extension pressure. Hips too far away reduces leverage and allows the opponent's arm to slip free. Hips too high changes the angle and may result in shoulder pressure rather than clean elbow hyperextension. The ideal position feels like your hip bone is directly under their elbow with your body weight driving forward into the extension.
...
- [[Back Control to Crucifix]] - Primary entry transition from back control to crucifix position
- [[Crucifix from Turtle]] - Common entry when opponent is in defensive turtle position
- [[Gift Wrap]] - Arm control position that often transitions into crucifix
- [[Turtle]] - Defensive position providing crucifix entry opportunities
...
- [[Back Control]] - Primary entry position for establishing crucifix
...
Successful execution of Crucifix Submissions leads to → [[game-over|Game Over]]
