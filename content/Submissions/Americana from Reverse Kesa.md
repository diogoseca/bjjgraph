...
---
title: "Americana from Reverse Kesa | BJJ Submission | BJJ Graph"
description: "Master the Americana from Reverse Kesa-Gatame. Complete guide covering shoulder lock mechanics, finishing details, defensive escapes, and training drills."
---
...
**Release Protocol**:
1. Release figure-four grip immediately upon any tap signal
2. Slowly return partner's arm to natural resting position without jerking
3. If in doubt whether partner tapped, release immediately - position can always be re-established
4. Check on training partner's shoulder comfort and mobility after release before continuing
...
[[Americana from Reverse Kesa/Attacker|→ Full Attacker Guide]]
...
- **Consolidate Reverse Kesa-Gatame Control**: Ensure your Reverse Kesa-Gatame is fully consolidated before initiating the submission. Your chest m...

- **Secure Wrist Control on Target Arm**: With the opponent's near arm secured under your armpit, slide your inside hand (the hand closer to t...

- **Pin the Wrist to the Mat**: Drive the opponent's wrist down toward the mat beside their body, approximately at hip level with th...

- **Thread the Figure-Four Grip**: With the wrist securely pinned, thread your outside arm (farther from their head) underneath their e...

- **Establish Optimal Lock Angle**: Adjust the opponent's arm to approximately 90 degrees at the elbow with their upper arm roughly perp...

- **Apply Initial Rotational Pressure**: Begin rotating the opponent's hand toward the mat in a controlled paintbrush arc motion while keepin...

- **Maintain Chest Pressure Through the Finish**: As you increase rotational pressure, ensure your chest remains heavy on the opponent's shoulder. The...

- **Adjust for Resistance or Chain to Alternate Attack**: If the opponent resists by attempting to straighten their arm, immediately switch to a Kimura grip b...


### Common Mistakes


- **Attempting the Americana before fully consolidating Reverse Kesa-Gatame control**
...
- **Using arm strength instead of body weight to apply the rotational lock**
...
- **Allowing the opponent's elbow to lift off the mat during the finishing sequence**
...
[[Americana from Reverse Kesa/Defender|→ Full Defender Guide]]
...
**Standard Figure-Four Americana**: Classic Americana attack from established Reverse Kesa-Gatame. Isolate the near arm already trapped under your armpit, pin the wrist to the mat, thread the figure-four grip under the tricep, and apply rotational pressure. Works best when opponent is flat and defensive. (When to use: When the opponent's arm is already trapped under your armpit and they are not actively fighting wrist control.)


**Wrist-Pin First Setup**: When the opponent actively resists arm isolation, use your chest weight to compress their shoulder while driving their wrist to the mat with both hands initially. Once the wrist is pinned, release one hand to thread the figure-four while maintaining pin pressure with the other. This two-stage approach overcomes initial grip fighting resistance. (When to use: When the opponent is actively grip fighting and preventing standard wrist isolation attempts.)


**Kimura-to-Americana Switch**: Begin with a Kimura grip on the near arm (gripping behind the wrist with figure-four over the top). When the opponent bends their arm defensively to counter the Kimura, switch your grip configuration underneath to convert to the Americana. The Kimura threat forces the arm bend that creates the optimal Americana angle. (When to use: When the opponent straightens their arm to defend the Americana, attack Kimura first, then switch back when they bend to defend.)
...
Successful execution of Americana from Reverse Kesa leads to → [[game-over|Game Over]]
