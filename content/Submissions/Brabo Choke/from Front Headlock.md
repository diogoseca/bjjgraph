...
---
title: "Brabo Choke from Front Headlock | BJJ Submission | BJJ Graph"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Brabo Choke from Front Headlock", "item": "https://bjjgraph.org/Submissions/Brabo-Choke-from-Front-Headlock" }
  ]
}
</script>
...
Successful execution of Brabo Choke from Front Headlock leads to → [[game-over|Game Over]]
