...
## Common Mistakes
- **Mistake**: Threading arm too shallow, failing to reach deep across neck
...
- **Mistake**: Applying sudden jerking pressure instead of progressive compression
...
- **Mistake**: Losing head control while attempting arm thread
...
- **Mistake**: Gripping too high on own arm instead of deep bicep grip
...
- **Mistake**: Continuing pressure after tap signal or loss of resistance
...
- **Mistake**: Raising hips too high during finish, allowing opponent to escape underneath
...
**Q5**: What are the key differences between the Brabo Choke and the Darce Choke, and when might you choose one over the other?
**A**: The Brabo and Darce are closely related with subtle differences in entry angle and finishing mechanics. The Brabo traditionally refers to threading under the near arm from front headlock when opponent's arm is tight to their body, while Darce often implies threading from side control or when the arm is slightly away from body. Some practitioners use the terms interchangeably. The practical difference is angle of entry: Brabo setup assumes opponent is defending with tight elbows from bottom, while Darce assumes you're attacking from a top control position. Choose based on which entry presents itself in the scramble or position you're attacking from.
