...
---
title: "Cross Collar Choke from KOB | BJJ Submission | BJJ Graph"
description: "Master the Cross Collar Choke from Knee on Belly. Complete guide to gi choke mechanics, grip placement, and finishing details from this dominant position."
---
...
**Release Protocol**:
1. Release all choking pressure immediately upon any tap signal — do not complete the squeeze
2. If opponent goes limp or loses consciousness, release immediately and place them in recovery position on their side
3. If in doubt whether a signal was a tap, release immediately — the position can always be re-established
...
[[Cross Collar Choke from KOB/Attacker|→ Full Attacker Guide]]
...
- **Consolidate Knee on Belly position**: Establish stable KOB with knee on opponent's solar plexus, base leg posted wide, and initial collar-...

- **Secure first deep collar grip**: Release the near-side collar grip and re-insert your hand deep into the collar — thumb inside, four ...

- **Increase knee pressure to force reaction**: Drive additional weight through your knee into their solar plexus by shifting your hips forward and ...

- **Insert second hand into opposite collar**: During the defensive window created by the pressure increase, feed your free hand into the opposite ...

- **Set elbow position and begin tightening**: Bring both elbows down tight against the opponent's chest, eliminating any slack in the collar fabri...

- **Execute the finishing squeeze**: Pull your fists apart and down toward the mat behind their neck while expanding your chest forward. ...

- **Maintain pressure and monitor for tap**: Hold the choking position with consistent progressive pressure while actively monitoring for any tap...
...
[[Cross Collar Choke from KOB/Defender|→ Full Defender Guide]]
...
**Standard Deep Grip Entry**: Establish the first grip deep in the near-side collar with thumb inside while maintaining KOB pressure. Increase knee pressure to force reaction, then feed the second hand into the opposite collar during the defensive window. Classic high-percentage entry requiring patience and grip depth. (When to use: When opponent is flat on their back absorbing KOB pressure without actively defending the collar)


**Armbar Feint to Cross Collar**: Threaten the armbar by gripping the wrist and shifting weight as if transitioning to the arm attack. When opponent pulls their arm tight to defend, the collar opens and the first grip can be inserted while their defensive focus is on the arm. Second grip follows immediately during the confusion. (When to use: When opponent is actively defending collar grips but leaving arms extended to push against KOB pressure)


**Baseball Bat Grip Transition**: Begin with a baseball bat choke grip setup (both hands on the same lapel). If opponent defends the baseball bat by stripping the second hand, redirect the freed hand to the opposite collar for the cross collar finish. Uses the first attack as a setup for the second. (When to use: When opponent has developed strong defense against the baseball bat choke and their hands are committed to that defense)
...
Successful execution of Cross Collar Choke from KOB leads to → [[game-over|Game Over]]
