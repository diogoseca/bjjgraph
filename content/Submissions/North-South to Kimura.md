...
---
title: "North-South to Kimura | BJJ Submission | BJJ Graph"
description: "Master the North-South to Kimura transition in BJJ. Complete guide covering setup, execution, and finishing mechanics. Success rates: Beginner 45%, Intermediate 60%, Advanced 75%."
---
...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for North-South to Kimura with safety protocols.",
  "step": [
    {
      "@type": "HowToStep",
    ...
    },
    {
      ...
      "text": "Pull the opponent's near arm away from their body by lifting their wrist while maintaining wrist control. Their natural reaction will be to push or frame against your hips. Use this reaction to your advantage by allowing slight extension of their arm while preventing them from pulling the elbow back to their body. Your grip on their wrist should be firm but not squeezing excessively.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Thread for Figure-Four Grip",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 3, "name": "North-South to Kimura", "item": "https://bjjgraph.org/Submissions/North-South-to-Kimura"}
  ]
}
</script>
...
**Q2**: Why is perpendicular body positioning critical for the north-south kimura finish?
**A**: Perpendicular body positioning maximizes leverage by creating the optimal angle for rotational pressure on the shoulder joint. When your body is perpendicular to the opponent's torso with hips angled toward the trapped arm, you can use your entire body weight and hip drive to generate finishing pressure. This positioning also prevents the opponent from rolling or bridging effectively to escape. Parallel positioning reduces leverage significantly and allows easier defensive options for the opponent including rotation and hip escape movements.

**Q3**: What are the primary injury risks if the north-south kimura is applied too quickly or aggressively? **[SAFETY-CRITICAL]**
**A**: Rapid or aggressive application of the north-south kimura can cause several serious shoulder injuries: rotator cuff tears (affecting the supraspinatus, infraspinatus, teres minor, or subscapularis muscles with 3-12 month recovery and potential surgery), shoulder dislocation requiring 6-12 weeks minimum recovery with risk of chronic instability, labrum tears including SLAP lesions requiring 4-6 months and often surgical repair, AC joint separation with 4-8 week recovery, and glenohumeral ligament damage requiring 6-12 weeks healing. These injuries can be career-ending and cause permanent damage if the submission is applied recklessly.

**Q4**: How should you generate finishing pressure for the north-south kimura - with arm strength or hip pressure?
**A**: Finishing pressure should be generated primarily through forward hip drive and body positioning, not arm strength. Your arms maintain the structural integrity of the figure-four grip while your hips drive forward and down to create the rotational force on the shoulder. This method provides smoother, safer, and more effective pressure compared to muscling the submission with arm strength. Using arms alone leads to jerky movements that increase injury risk and reduce control. Hip-driven pressure allows for more precise control and progressive application of force.

**Q5**: What is the correct release protocol when your training partner taps to the north-south kimura? **[SAFETY-CRITICAL]**
**A**: Upon receiving the tap signal, immediately stop all rotational pressure on the shoulder. Release the figure-four grip and wrist control smoothly without jerking or pulling away suddenly. Allow the arm to return naturally to neutral anatomical position. Do not pull or push the arm as you release - let it move freely to wherever is comfortable for your partner. After release, check verbally with your training partner to ensure they are okay. The release must be immediate and controlled to prevent injury even after the tap has occurred.

**Q6**: What defensive reaction from the opponent makes the north-south kimura particularly effective?
**A**: The opponent's natural tendency to push or frame against the top player's hips and torso when pinned in north-south creates the ideal setup for the kimura. This defensive framing extends their arm away from their body, allowing you to isolate and control the wrist easily. The extended arm position provides excellent access for threading your far arm underneath to secure the figure-four grip. Essentially, their defensive reaction to create space and prevent chest pressure directly sets up the submission opportunity, making this a high-percentage technique against common north-south defenses.

**Q7**: Your opponent begins to bridge explosively as you initiate the rotation - what is the critical adjustment to maintain control and complete the finish?
**A**: When opponent bridges during rotation, ride the bridge by keeping your hips low and following their upward movement rather than fighting it. Maintain the figure-four grip throughout the bridge and actually use their energy expenditure against them by increasing rotational pressure as they settle back down from the failed bridge. Keep your weight distributed across their chest through your hips and torso to limit bridge effectiveness. The key is staying connected and heavy rather than trying to pin them through strength alone - their bridge will fatigue them while you conserve energy and maintain the submission threat.

**Q8**: At what point during the finishing sequence should the opponent's arm reach the breaking point, and what are the warning signs you must watch for? **[SAFETY-CRITICAL]**
**A**: The breaking point approaches when the opponent's wrist is rotated toward their head with their elbow pushed away from their body at roughly a 90-degree angle. Warning signs include: increased resistance in the shoulder joint indicating tissue stretching, opponent's body tensing or arching, facial expressions showing pain or distress, any verbal indication of discomfort, or sudden cessation of defensive movement indicating they may be in shock. In training, you must watch for these signs and stop well before the breaking point - the tap should come at 70-80% of maximum pressure. Never test the absolute limit in training.

**Q9**: What grip adjustment should you make if your opponent's arm is particularly sweaty or slippery during no-gi competition?
**A**: When grips are compromised by sweat, secure a deeper figure-four by gripping higher on your own forearm rather than at the wrist. This creates a tighter, more secure configuration less susceptible to slippage. Additionally, pin their wrist against your chest or shoulder for additional friction and control. You can also use your chest pressure to help pin their arm in place while adjusting grips. The key is maintaining constant pressure throughout any grip adjustment - never release completely and re-grip, as this creates escape windows.

**Q10**: How do you recognize when to abandon the kimura attempt and transition to an alternative attack?
**A**: Abandon the kimura when: the opponent successfully grabs their belt, pants, or opposite arm and you cannot break the grip after 2-3 attempts; they've created enough space through bridging to begin a significant escape sequence; they've partially turned their body negating your perpendicular angle; or you feel your own grip fatiguing. The ideal transitions are to an armbar (if you maintain wrist control and can swing your leg over), north-south choke (if they're focused on defending arms), or simply re-consolidating north-south control to reset. Never force a submission that isn't there - better to maintain position and attack again.

**Q11**: What is the biomechanical reason the shoulder joint is particularly vulnerable in the kimura position? **[SAFETY-CRITICAL]**
**A**: The shoulder joint is vulnerable in the kimura because the submission applies external rotation and extension forces to a joint designed primarily for flexion and internal rotation in its most powerful configurations. The rotator cuff muscles (supraspinatus, infraspinatus, teres minor, subscapularis) are stretched beyond their normal range while the glenohumeral ligaments are loaded in their weakest orientation. The figure-four grip creates a long lever arm that multiplies the rotational force applied to these relatively small structures. Unlike the elbow or knee which have defined stopping points, the shoulder's ball-and-socket design allows rotation until soft tissue failure occurs.

**Q12**: During competition, your opponent is defending well and time is running out - how do you accelerate the finish without compromising safety? **[SAFETY-CRITICAL]**
**A**: To accelerate the finish safely under time pressure: increase your chest pressure to further restrict their breathing and movement capacity, making defense more difficult; use your base to drive your entire body weight into the rotation rather than just arm strength; angle your hips more aggressively toward the trapped arm to maximize leverage; and chain quick transitions between kimura and armbar threats to force defensive errors. Even in competition, the rotation should still take 2-3 seconds minimum - the acceleration comes from superior positioning and pressure, not from jerking or spiking the submission. Prioritize the win but never at the cost of seriously injuring your opponent.
...
- [[Kimura Trap]] - Control position using kimura grip structure for submission chains
- [[Gift Wrap]] - Alternative arm control position from north-south leading to back take
- [[Overhook Control]] - Fundamental control concept for maintaining arm isolation from top
- [[Mount]] - Alternative dominant position with similar submission opportunities
- [[Back Control]] - Alternative target position if kimura defense allows back take
