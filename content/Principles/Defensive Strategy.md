...
**Quarter Guard**: Defensive strategy governs when to use quarter guard as a last-ditch recovery position versus when to commit fully to reguarding, balancing energy conservation against the risk of complete guard pass based on match situation and opponent's passing pressure.
...
- [[Turtle]] (Position) - Represents the primary defensive recovery position used when implementing energy conservation elements of defensive strategy, requiring strategic decisions about reguarding versus standing.
