...
Terminal state in BJJ where a match ends via submission tap. The sink node of the grappling state machine - every submission finish leads here, ending the round.
