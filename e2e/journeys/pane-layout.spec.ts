 ...
 * Integration mutation checks: removing horizontal inset fails desktop reflow (0px shift);
 * portalling the card outside the wrap fails elementFromPoint at the phone overlap; removing
 * pane-to-More pause transfer fails the held-pause assertion. Companion camera and keyboard
 * specs reject removed camera inset and landing takeover of the shared answer slot.
 */
