...
const NG_SOUND_CATALOG = [
  ...
  { beat: "hesitated", label: "Initiative lost", group: "Decision", voice: "auto-lock", durationMs: 260, context: "The decision window expires. You froze, so the opponent takes the exchange.", character: "A compact targeting chirp closes the hand \u2014 the turn is no longer yours." },
  ...
  { beat: "list_shared", label: "Constellation transmitted", group: "Sharing", voice: "constellation-lock", durationMs: 520, context: "A class list is shared: the link is copied (or handed to the share sheet).", character: "A set of points locks together and departs as one signal." },
  { beat: "list_opened", label: "Constellation received", group: "Sharing", voice: "holo-open", durationMs: 480, context: "A received /l/<code> link resolves and its techniques light up on arrival.", character: "A projected panel unfolds around the arriving selection." },
