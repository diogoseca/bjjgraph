...
const NG_PATCHES = {
  ...
  belt_test_won: { major: 1, id: "fanfare-capstone", notes: [[523, 523, 0.16, 0, "square", 0.22], [659, 659, 0.16, 0.14, "square", 0.22], [784, 784, 0.16, 0.28, "square", 0.24], [1047, 1047, 0.35, 0.42, "square", 0.28], [784, 784, 0.16, 0.85, "square", 0.2], [1047, 1047, 0.3, 1.0, "square", 0.24], [1319, 1319, 0.6, 1.15, "square", 0.28], [1568, 1568, 0.9, 1.5, "sine", 0.24]] },
  ...
  challenge_completed: { id: "challenge-tick", notes: [[620, 740, 0.09, 0, "sine", 0.14]] },
  patch_earned: { major: 1, id: "patch-handshake", notes: [[160, 120, 0.12, 0, "triangle", 0.22], [520, 650, 0.18, 0.08, "sine", 0.14]] },
  coin_earned: { major: 1, id: "coin-rubber", notes: [[240, 180, 0.09, 0, "triangle", 0.18], [720, 680, 0.08, 0.07, "sine", 0.1]] },
