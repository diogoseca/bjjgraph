...
const NG_SOUND_CATALOG = [
  ...
  { beat: "stripe_earned", label: "Degree pulse", group: "Progression", voice: "degree-pulse", durationMs: 920, context: "Proof increases enough to earn a belt stripe.", character: "Four precise energy marks illuminate in sequence." },
  { beat: "belt_unlocked", label: "Belt ascension", group: "Progression", voice: "ascension", durationMs: 1680, priority: 3, context: "A new belt becomes available.", character: "A long rising field crosses into a brighter register." },
  ...
  { beat: "path_opened", label: "Path hologram", group: "Interface", voice: "holo-open", durationMs: 360, context: "The Belt Path opens.", character: "A quiet glassy plane comes online." },
...
const NG_VOICES = {
  ...
  "momentum-rise": { tones: [[620, 860, .16, 0, "triangle", .17, -.4, 2600, 6200], [860, 1180, .22, .11, "sine", .16, .4, 4200, 7800]], echo: [.105, .16] },
  ...
  "filament-snap": { tones: [[620, 158, .3, 0, "sawtooth", .12, .45, 2600, 240], [260, 92, .28, .07, "triangle", .15, -.3, 820, 160]], noise: [[.24, 0, .045, .65, -.65, 3600, 240, "bandpass"]] },
  ...
  "degree-pulse": { major: 1, tones: [[440, 660, .13, 0, "sine", .12, -.6, 2400, 6200], [523, 784, .14, .13, "sine", .13, -.2, 3200, 7200], [660, 990, .15, .26, "sine", .14, .2, 4200, 8200], [784, 1175, .3, .39, "sine", .14, .6, 5200, 9200]], echo: [.13, .2] },
  "ascension": { major: 1, tones: [[110, 220, 1.12, 0, "sine", .2, 0, 260, 1200], [330, 990, .78, .28, "triangle", .1, -.4, 1200, 7200], [523, 1568, .62, .52, "sine", .11, .45, 2400, 9800]], noise: [[1.12, .08, .055, -.85, .85, 480, 9800, "highpass"]], echo: [.18, .24] },
