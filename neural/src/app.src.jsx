...
class Component extends DCLogic {
  ...
  ingest(data) {
    ...
    const nodes = data.nodes.map((n, i) => {
      ...
      return { idx: i, id: n.id, x: n.x, y: n.y, t: n.t, ty: n.ty, s: n.s || null, dom, col: this.domColor(dom), deg: 0, lit: -99, posId: n.posId || null, fromPositionId: n.fromPositionId || null, fromRole: n.fromRole || null, cal: n.cal || null, familyHub: n.familyHub || null, o: typeof n.o === "number" ? n.o : null, role: n.role || null, pairId: n.pairId || null };
    });
    const adj = nodes.map(() => []);
    const links = [];
