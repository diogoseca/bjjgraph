...
On demand: one deck's cards, one node's dossier, `source/quartz/static/neural/systems.json`,
`source/quartz/static/neural/concepts.json` (the Principles + Learning index — each concept's readable body is a dossier in the SAME
