...
Usage:
    python scripts/generate_category_hub_pages.py
    python scripts/generate_category_hub_pages.py --category Positions
    python scripts/generate_category_hub_pages.py --dry-run
"""
