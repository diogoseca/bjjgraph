...
All located in `/scripts/link_optimizer/`:
...
**Report saved**: `/reports/link_optimizer/broken_links_report.json`
...
```bash
claude --print --model sonnet --dangerously-skip-permissions < input.txt
```
...
- `/scripts/link_optimizer/README.md`
- `/scripts/link_optimizer/QUICKSTART.md`
- `/scripts/link_optimizer/SUMMARY.md`
