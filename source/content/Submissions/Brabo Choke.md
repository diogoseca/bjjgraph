...
- [[Darce Setup]] - Primary transition - same arm threading mechanics applied from different positions
- [[Darce from Turtle]] - Parallel technique - Brabo and Darce often available from same turtle attack
- [[Front Headlock to Darce]] - Entry sequence - systematic approach to threatening Brabo/Darce from front headlock
- [[Anaconda Setup]] - Alternative choke - if Brabo angle is blocked, Anaconda threading may be available
- [[Anaconda from Turtle]] - Complementary attack - threaten both Brabo and Anaconda from turtle to create dilemma
- [[Head Control]] - Fundamental principle - head control establishes all front headlock submissions
- [[Shoulder Pressure]] - Finishing principle - shoulder drive creates finishing pressure for Brabo
- [[Grip Fighting]] - Entry principle - winning grip battle allows arm threading for Brabo
- [[Submission Chains]] - System principle - Brabo functions as part of front headlock submission system
