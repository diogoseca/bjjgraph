...
- [[Triangle Setup]] - Common combination—triangle threats set up armbar opportunities
- [[Posture Breaking]] - Essential prerequisite principle for successful armbar entry
- [[Hip Movement]] - Critical principle for creating angle and generating finishing pressure
- [[Submission Chains]] - Armbar from guard is cornerstone of guard submission chain systems
- [[Triangle to Armbar]] - Natural transition when opponent defends triangle
- [[Closed Guard to Triangle]] - Complementary attack that creates armbar opportunities
- [[Triangle to Omoplata]] - Part of the same submission chain system
- [[Grip Fighting]] - Essential for establishing arm control before armbar attempt
- [[Guard Retention]] - Maintains guard position during armbar attempts if opponent defends
- [[Omoplata to Sweep]] - Connected technique in guard attack sequences
- [[Ryan Hall Triangle System]] - Strategic framework incorporating armbar as key component
