...
- [[Guillotine Defense]] - Von Flue is the ultimate counter-defense to guillotine
- [[Half Guard]] - Common position where Von Flue can be applied during passing
- [[Shoulder Pressure]] - Key principle used to execute the choke
- [[Side Control Escape]] - What opponent should attempt instead of holding guillotine
- [[Guard Pass]] - Often in progress when Von Flue opportunity presents itself
- [[North-South]] - Alternative position where similar shoulder pressure can be applied
- [[Defensive Posture]] - Principle violated by opponent when they hold guillotine from bottom
