...
#bjj #submission #kimura #joint-lock #shoulder-lock #closed-guard #guard-attacks 
...
- [[Kimura Control]] - Control position that enables this submission and multiple transitions
- [[Kimura Trap]] - System that builds entire offensive game around the Kimura grip
...
- [[Guard Retention]] - Fundamental skill required to maintain position for Kimura setups
- [[Closed Guard]] - Primary starting position for this submission variation
- [[Rolling Kimura]] - Dynamic variation that follows opponent's rolling defense
- [[Armbar from Guard]] - Alternative finish when opponent straightens arm defending Kimura
- [[Sweep Mechanics]] - Fundamental principle that integrates with Kimura grip for sweeping
- [[Guard Bottom Transition]] - General transition category that includes Kimura-based attacks
