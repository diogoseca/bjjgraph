...
- [[Mount to Armbar]] - Primary transition sequence from mount position to armbar finish
- [[Triangle to Armbar]] - Common submission chain when triangle is defended
- [[Triangle Setup]] - Alternative submission from similar control positions
- [[Submission Chains]] - Strategic principle of linking armbars with other submissions
- [[Submission Control Position]] - Fundamental principle emphasizing position before submission
- [[Leverage Principles]] - Biomechanical concepts underlying armbar effectiveness
- [[Hip Movement]] - Essential principle for generating finishing force in armbars
- [[Positional Hierarchy]] - Framework for understanding when to attempt armbars vs. maintain position
- [[Omoplata to Sweep]] - Alternative attack when armbar is defended by opponent rolling
- [[Guard Pass]] - Opponent's counter-strategy that creates armbar opportunities
- [[Crucifix]] - Alternative control position with armbar finishing options
- [[North-South]] - Position with specific armbar variations and entries
