...
- [[Omoplata from Guard]] - Alternative finish when opponent defends triangle by turning opposite direction; completes triangle-armbar-omoplata system
...
- [[Triangle Setup]] - Transition technique covering various entries into triangle position from closed guard and other guards
- [[Triangle to Armbar]] - Specific transition technique when opponent defends triangle; essential follow-up creating submission dilemma
- [[Triangle to Omoplata]] - Alternative transition when opponent turns away from armbar; completes the three-way submission system
