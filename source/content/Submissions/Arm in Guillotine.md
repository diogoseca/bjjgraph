...
- [[Front Headlock Series]] - Broader system that includes arm-in guillotine as key option
- [[Marcelo Garcia Guillotine System]] - Expert system featuring high-level arm-in guillotine applications
- [[Guillotine Setup]] - Entry technique for establishing the arm-in configuration
- [[Guillotine Defense]] - Understanding defenses improves offensive application
- [[Front Headlock to Guillotine]] - Primary transition path to arm-in guillotine
- [[Snap Down to Front Headlock]] - Common setup creating arm-in opportunities
- [[Submission Chains]] - Conceptual framework for linking arm-in guillotine with other attacks
- [[Guard Pull]] - Tactical transition often combined with arm-in guillotine from standing
- [[Posture Breaking]] - Essential principle for creating guillotine opportunities
- [[Head Control]] - Fundamental control principle underlying all guillotine variations
- [[Chin Protection]] - Defensive principle that arm-in guillotine must overcome
