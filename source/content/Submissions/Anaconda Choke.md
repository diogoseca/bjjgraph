...
## Is Anaconda Choke Dangerous? Complete Safety Guide
...
- **Error**: Applying the choke from top position without rolling to side [Low DANGER]
...
- **Error**: Shallow threading of choking arm under opponent's neck [Low DANGER]
...
- **Error**: Failing to trap opponent's arm against their neck [Low DANGER]
...
- **Error**: Jerking or cranking the choke with explosive force [CRITICAL DANGER]
...
- **Error**: Using palm-to-palm grip instead of Gable or RNC grip [Low DANGER]
...
- **Error**: Extending hips away from opponent during finish [Low DANGER]
...
- **Error**: Forgetting to monitor partner for consciousness during finish [CRITICAL DANGER]
...
**Marce Choke (Modified Anaconda)**: Similar setup to Anaconda but instead of rolling to side with figure-four, you transition to North-South position and apply pressure from top. Named after Marcelo Garcia, this variation works when opponent's base is too strong to roll them. (When to use: When opponent has strong base and prevents your roll, or in gi when you can use lapel control)
