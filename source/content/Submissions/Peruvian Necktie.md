...
- [[Front Headlock Series]] - Primary system for entries and setup variations
- [[Front Headlock to Guillotine]] - Alternative finish from same position when arm not trapped
- [[Darce Setup]] - Parallel choke option using arm-in configuration
- [[Anaconda Setup]] - Alternative front headlock finish using opposite arm configuration
- [[Japanese Necktie Setup]] - Similar leg-threading choke from different entry position
- [[Snap Down to Front Headlock]] - Primary standing entry to establish front headlock control
- [[Turtle to Back Take]] - Alternative attack option when Peruvian Necktie is defended
- [[Grip Fighting]] - Essential skill for establishing and maintaining front headlock control
- [[Head Control]] - Fundamental principle underlying all front headlock attacks
- [[Submission Chains]] - Strategic framework for transitioning between front headlock submissions
