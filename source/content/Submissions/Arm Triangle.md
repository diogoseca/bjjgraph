...
- [[Mount Control]] - Alternative setup position when opponent frames
- [[Kuzure Kesa-Gatame]] - Modified scarf hold position allows similar setup
- [[Pressure Application]] - Core principle governing effective finishing pressure
- [[Shoulder Pressure]] - Essential mechanical principle for choke completion
- [[Cross Face Control]] - Prerequisite control for isolating near arm
- [[Submission Chains]] - Connects to other head/arm chokes in sequence
- [[Arm Triangle from Turtle]] - Common transition when opponent turtles defensively
