...
---
title: "Cross Collar Choke | BJJ Submission | BJJ Graph"
description: "Master the Cross Collar Choke in BJJ. Complete guide covering gi grips, proper hand placement, and finishing mechanics. Success rates: Beginner 35%, Intermediate 50%, Advanced 65%."
---
...
## Is Cross Collar Choke Dangerous? Complete Safety Guide
...
- **Error**: Gripping too shallow on the collar [Low DANGER]
...
- **Error**: Attacking the trachea instead of carotid arteries [CRITICAL DANGER]
...
- **Error**: Telegraphing the second grip too obviously [Low DANGER]
...
- **Error**: Pulling straight back instead of scissoring [Low DANGER]
...
- **Error**: Losing positional control while focusing on grips [Medium DANGER]
...
- **Error**: Holding the choke past the tap signal [CRITICAL DANGER]
...
- **Error**: Using arms only without engaging full body [Low DANGER]
...
- [[Posture Breaking]] - Essential principle for creating choke opportunities from guard
- [[Grip Fighting]] - Critical skill for establishing and maintaining deep collar grips
- [[Guard Pull]] - Transition that creates standing Cross Collar Choke opportunities
- [[Collar Control]] - Fundamental principle underlying all collar choke mechanics
- [[Submission Chains]] - Strategic concept for linking Cross Collar attempts with other attacks
- [[Ezekiel from Mount]] - Alternative choke finish from mount when collar grips are defended
- [[Closed Guard to Triangle]] - Primary backup attack when opponent defends Cross Collar with frames
- [[Mount to Armbar]] - Common follow-up when opponent defends Cross Collar by straightening arms
