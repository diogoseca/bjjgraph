---
title: "Kimura | BJJ Submission Guide | BJJ Graph"
...
1. **Setup Requirements**: Establish position (Side Control, Half Guard Top, or Guard Bottom)
2. **Initial Movement**: Control opponent's wrist/forearm with same-side grip
3. **Opponent Response**: Opponent may attempt to pull arm back or posture
4. **Adaptation**: Thread other arm under opponent's upper arm near tricep
5. **Positioning**: Connect to figure-four grip by grabbing own wrist, establish perpendicular angle
6. **Pressure Application**: Bring opponent's hand toward lower back, keep elbow tight to body
7. **Completion**: Apply rotational pressure to shoulder, control body until submission
