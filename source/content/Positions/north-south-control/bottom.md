...
---
title: "North South Control Bottom | BJJ Position Guide | BJJ Graph"
description: "Defensive position requiring explosive bridging and precise timing to escape perpendicular chest pressure and prevent arm isolation leading to submissions."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Escape North South Control Bottom",
  "description": "Step-by-step guide to escaping and defending North South Control position in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What happens if you pushing against consolidated chest pressure with straight arms?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Depletes energy rapidly without creating escape angles, arms become exhausted and vulnerable to submission The correct approach is: Use short explosive bridges timed with opponent's weight shifts rather than sustained pushing"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you allowing both arms to be controlled simultaneously?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Creates complete helplessness with no ability to frame or defend submissions The correct approach is: Keep at least one arm mobile and defensive, never allow opponent to pin both arms at the same time"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you bridging directly upward rather than at an angle?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Opponent easily rides the bridge without losing balance, no escape angle is created The correct approach is: Bridge at 45-degree angles toward opponent's knees to create off-balancing effect"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you waiting too long before attempting escape?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Opponent fully consolidates weight and position, making escape exponentially more difficult The correct approach is: Begin defensive framing and escape attempts immediately as North-South is being established"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you exposing back while attempting to turn?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Opponent takes back control with hooks, worse position than North-South The correct approach is: Turn toward opponent into turtle position, keeping back protected from hook insertion"
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "North South Control Bottom",
  "description": "Defensive position requiring explosive bridging and precise timing to escape perpendicular chest pressure and prevent arm isolation leading to submissions.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Graph",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "North South Control Bottom",
      "item": "https://bjjgraph.org/Positions/North-South-Control-Bottom"
    }
  ]
}
</script>
...
### 1. Pushing against consolidated chest pressure with straight arms
...
### 2. Allowing both arms to be controlled simultaneously
...
### 3. Bridging directly upward rather than at an angle
...
### 4. Waiting too long before attempting escape
...
### 5. Exposing back while attempting to turn
...
### North-South Escape Timing Drill

Partner maintains moderate North-South pressure while bottom player practices explosive bridge timing during simulated transition attempts. Focus on recognizing weight shift windows and executing bridges at precise moments.

**Duration**: 5 minutes


### Arm Protection Drill

Top player attempts to isolate and control near-side arm while bottom player maintains defensive frames and prevents grip establishment. Emphasizes active arm defense under pressure.

**Duration**: 3 minutes


### Bridge-to-Turtle Sequence

Bottom player practices explosive bridge and turn combination to convert North-South to turtle position. Top player provides increasing resistance as technique improves.
...
- **[[Side Control]]** - Previous position before North-South transition
