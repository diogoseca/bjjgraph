...
---
title: "100 Kilos Top | BJJ Position Guide | BJJ Graph"
description: "Master 100 Kilos Top attacks in BJJ. Devastating pressure position with crushing chest control, submission setups, and position advancement strategies."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Attack from 100 Kilos Top",
  "description": "Step-by-step guide to attacking and submitting from 100 Kilos position in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
    ...
    },
    {
      ...
      "text": "From this position, execute Armbar from Mount to transition to Armbar Control. Success rate for advanced practitioners: 70%.",
      "position": 6
    }
  ],
  "totalTime": "PT2M"
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What happens if you using muscular tension to apply pressure rather than relaxing and using body weight?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Rapidly exhausts you while providing less effective pressure on opponent The correct approach is: Relax your muscles and let your skeleton do the work - drop dead weight onto their chest rather than actively pushing"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you staying in position too long without recognizing your own fatigue accumulation?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Your fatigue accumulates to point where subsequent positions and submissions are compromised The correct approach is: Set mental timer for 30-60 seconds maximum - transition to sustainable position before energy is depleted"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you failing to spread legs wide enough for stable base?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Creates unstable platform requiring muscular effort to maintain balance, increasing energy expenditure The correct approach is: Extend legs as wide as comfortable with knees on mat, creating tripod structure for complete relaxation"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you positioning chest too high on opponent's body (shoulders/neck) or too low (abdomen)?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Reduces breathing restriction effectiveness and allows opponent to create frames or turn away The correct approach is: Target your chest directly on opponent's sternum and upper rib cage where respiratory expansion is most restricted"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you not having clear transition plan before entering position?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Wastes the fatigue you create because you don't capitalize on their weakened state The correct approach is: Before establishing 100 kilos, identify your primary transition targets based on opponent's typical responses"
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "100 Kilos Top",
      "item": "https://bjjgraph.org/Positions/100-Kilos-Top"
    }
  ]
}
</script>
...
## What is 100 Kilos from the Top?
...
- **[[Frame Creation]]** → [[Closed Guard]] (Opponent Success: 20%)
- **[[Elbow Escape]]** → [[Half Guard]] (Opponent Success: 30%)
- **[[Shrimp Escape]]** → [[Open Guard]] (Opponent Success: 35%)
...
- **[[Back Take Generic]]** → [[Back Control]]
  - Opponent turns to their side in panic escape attempt
- **[[Kimura from Side Control]]** → [[Kimura Control]]
  - Opponent extends arm to frame against chest pressure
- **[[Transition to North-South]]** → [[North-South]]
  - Opponent bridges and creates space under hips
...
- **[[Kesa Gatame]]** - Parent position - traditional scarf hold that 100 kilos is derived from
- **[[Modified Scarf Hold]]** - Similar position with different pressure emphasis and sustainability
- **[[Side Control]]** - Common transition target when exiting 100 kilos position
- **[[North-South]]** - High-percentage transition from 100 kilos when opponent bridges
- **[[Mount]]** - Primary advancement target when opponent's defensive structure breaks
- **[[Knee on Belly]]** - Alternative pressure position with different mechanics
- **[[Pressure Application]]** - Core concept governing this position's effectiveness
- **[[Energy Management System]]** - Critical concept for understanding position's sustainability limitations
- **[[Weight Distribution]]** - Essential principle for maximizing pressure effectiveness
- **[[Control Maintenance]]** - Framework for understanding position retention
- **[[Positional Hierarchy]]** - Context for position's role in overall BJJ strategy
