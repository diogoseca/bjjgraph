...
description: "Master Kimura Control in BJJ. Strategic guide covering grip mechanics, sweep opportunities, submission threats, and transitions from both bottom and top perspectives."
---
...
- **[[Kimura Trap]]** - Advanced systematic approach building comprehensive attack chains around Kimura grip structure

- **[[Americana Control]]** - Similar shoulder lock control using different grip configuration, often available from same positions

- **[[Omoplata Control]]** - Alternative shoulder lock control that emerges when opponent defends Kimura by driving forward

- **[[Triangle Control]]** - Common transition when opponent posts to defend Kimura, creating triangle entry opportunities

- **[[Gift Wrap]]** - Control position that can evolve into Kimura grip from back control scenarios

- **[[Overhook Control]]** - Related arm control that shares similar principles of isolating and controlling opponent's arm

- **[[Half Guard]]** - Common position where Kimura Control is established from both top and bottom perspectives

- **[[Closed Guard]]** - Primary guard position for securing initial Kimura grip from bottom

- **[[North-South]]** - Top position that frequently transitions to Kimura Control for submission finishing

- **[[Side Control]]** - Dominant position where Kimura Control can be established and finished from top

- **[[Turtle]]** - Transitional position where Kimura grip provides strong control and attack options

- **[[Front Headlock]]** - Control position that can integrate Kimura grip for enhanced control and submission threats
