...
---
title: "Piranha Guard Bottom | BJJ Position Guide | BJJ Graph"
...
<script type="application/ld+json">
{
  ...
  "step": [
    ...
    },
    {
      ...
      "text": "From this position, execute Collar Drag to transition to Back Control. Success rate for advanced practitioners: 65%.",
      "position": 2
    },
    {
      "@type": "HowToStep",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "Piranha Guard Bottom",
      "item": "https://bjjgraph.org/Positions/Piranha-Guard-Bottom"
    }
  ]
}
</script>
...
- **[[Guard Opening Sequence]]** → [[Combat Base]] (Opponent Success: 45%)
...
- **[[Berimbolo Entry]]** → [[Back Control]]
  - Opponent commits weight forward attempting to clear legs and pass
- **[[Omoplata Sweep]]** → [[Omoplata Control]]
  - Opponent posts arm to stabilize base during sweep defense
- **[[Collar Drag]]** → [[Back Control]]
  - Opponent steps forward attempting to disengage from lapel entanglement
...
Partner gives progressive resistance starting at 50% and building to 75%. Execute chain of Pendulum Sweep → Flower Sweep → Omoplata Sweep → Berimbolo based on opponent's defensive reactions. Develop ability to read defenses in real-time and flow smoothly between attacks while maintaining collar control throughout entire sequence.
...
- **[[Keenan Cornelius Lapel Guard System]]** - Systematic approach to lapel guards that includes Piranha Guard concepts and related techniques
...
- **[[Guard Retention Concepts]]** - Fundamental concepts that apply to maintaining and recovering Piranha Guard under pressure
