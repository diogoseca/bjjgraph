...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Use 100 Kilos Position Top in BJJ",
  "description": "Complete guide to executing techniques and transitions from 100 Kilos Position Top.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Execute Neck Crank Submission",
      "text": "From 100 Kilos Position Top, execute Neck Crank Submission to advance your position.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Execute Neck Crank Control",
      "text": "From 100 Kilos Position Top, execute Neck Crank Control to advance your position.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Execute Mounted Arm Triangle",
      "text": "From 100 Kilos Position Top, execute Mounted Arm Triangle to advance your position.",
      "position": 3
    }
  ],
  "tool": [
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is a key principle of 100 Kilos Position Top?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "**Maximum Pressure Through Structure**: Use skeletal alignment and body weight rather than muscle tension to apply crushing pressure, preserving your own energy while exhausting opponent"
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "100 Kilos Position Top",
  "description": "Master 100 Kilos Position (Cem Quilos) in BJJ. Crushing pressure pin from modified scarf hold. Success: Beginner 40%, Intermediate 60%, Advanced 75%.",
  "url": "https://bjjgraph.org/Positions/100-Kilos-Position-Top",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Graph",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "100 Kilos Position Top",
      "item": "https://bjjgraph.org/Positions/100-Kilos-Position-Top"
    }
  ]
}
</script>
