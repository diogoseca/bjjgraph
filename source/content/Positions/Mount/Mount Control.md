...
description: "Master mount control in BJJ. Complete guide covering offensive attacks, defensive escapes, weight distribution, and submission setups from the dominant mount position."
---
...
[[Mount Control/Bottom|→ Full Bottom Guide]]
...
[[Mount Control/Top|→ Full Top Guide]]
...
- **[[High Mount]]** - Advanced mount variation with knees higher on torso for increased submission access

- **[[Technical Mount]]** - Asymmetric mount variation with one leg extended for armbar access

- **[[S Mount]]** - Transitional position between mount and armbar with leg configuration resembling letter S

- **[[Mounted Triangle]]** - Submission control position combining mount pressure with triangle choke mechanics

- **[[Mounted Crucifix]]** - Arm isolation position from mount creating multiple submission pathways

- **[[Side Control]]** - Common transition point when moving to or escaping from mount

- **[[Knee on Belly]]** - Alternative top position used when mount control is threatened

- **[[Back Control]]** - Superior position accessible when opponent turns during mount escape attempts

- **[[Closed Guard]]** - Primary recovery position when successfully escaping mount bottom

- **[[Half Guard]]** - Intermediate position during incomplete mount escapes from bottom
