...
---
title: "Mount Control Bottom | BJJ Position Guide | BJJ Graph"
description: "Comprehensive guide to surviving and escaping mount bottom position. Learn defensive framing, hip escape mechanics, and systematic escape sequences used by top competitors."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Escape Mount Control Bottom",
  "description": "Step-by-step guide to escaping and defending Mount Control position in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Execute Upa Escape",
      "text": "From this position, execute Upa Escape to transition to Closed Guard. Success rate for advanced practitioners: 65%.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Execute Elbow Escape",
      "text": "From this position, execute Elbow Escape to transition to Half Guard. Success rate for advanced practitioners: 70%.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Execute Hip Escape",
      "text": "From this position, execute Hip Escape to transition to Closed Guard. Success rate for advanced practitioners: 60%.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Execute Bridge and Roll",
      "text": "From this position, execute Bridge and Roll to transition to Mount Control Top. Success rate for advanced practitioners: 55%.",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Execute Shrimp Escape",
      "text": "From this position, execute Shrimp Escape to transition to Half Guard. Success rate for advanced practitioners: 65%.",
      "position": 5
    },
    {
      "@type": "HowToStep",
      "name": "Execute Frame and Shrimp",
      "text": "From this position, execute Frame and Shrimp to transition to Closed Guard. Success rate for advanced practitioners: 60%.",
      "position": 6
    }
  ],
  "totalTime": "PT2M"
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What happens if you extending arms fully to push opponent's chest creates immediate armbar vulnerability?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Opponent transitions to technical mount or S-mount for armbar finish The correct approach is: Maintain bent elbows with forearms creating frames against opponent's hips and biceps"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you flat bridging without hip angle creation fails to off-balance opponent?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Energy expenditure without positional improvement, leading to exhaustion under pressure The correct approach is: Bridge at 45-degree angle toward opponent's posted hand while trapping arm and leg on same side"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you attempting escape movements while opponent has stable base and centered weight?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Failed escape attempts that worsen position as opponent advances to high mount The correct approach is: Wait for weight shifts during submission attempts or position adjustments before initiating escapes"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you turning to side or exposing back in panic response to mount pressure?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Immediate back exposure allowing opponent to establish hooks and seat belt control The correct approach is: Maintain face-up position while using systematic escape sequences through half guard"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you crossing arms over centerline or allowing gift wrap control during defensive movements?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Arm isolation enabling Americana attacks or gift wrap position leading to back take The correct approach is: Keep elbows inside opponent's knee line with hands protecting neck and maintaining frames"
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "Mount Control Bottom",
      "item": "https://bjjgraph.org/Positions/Mount-Control-Bottom"
    }
  ]
}
</script>
...
- **[[Americana from Mount]]** → [[Americana Control]] (Opponent Success: 60%)
- **[[Armbar from Mount]]** → [[Armbar Control]] (Opponent Success: 55%)
- **[[Mount to Armbar]]** → [[Technical Mount]] (Opponent Success: 50%)
- **[[Cross Collar Choke]]** → [[Won by Submission]] (Opponent Success: 45%)
- **[[Ezekiel from Mount]]** → [[Won by Submission]] (Opponent Success: 40%)
- **[[Transition to Mount]]** → [[High Mount]] (Opponent Success: 65%)
- **[[Arm Triangle]]** → [[Won by Submission]] (Opponent Success: 50%)
...
- **[[Frame and Shrimp]]** → [[Half Guard]]
  - Opponent attempts to advance to high mount by walking knees upward
- **[[Bridge and Roll]]** → [[Mount Control Top]]
  - Opponent leans forward to establish collar grips or attempt ezekiel choke
- **[[Elbow Escape]]** → [[Closed Guard]]
  - Opponent's weight centers on chest without grapevine hooks established
...
- **[[Mount Escape Hierarchy]]** - Systematic framework prioritizing escape techniques based on opponent positioning
- **[[Mount Escape Series]]** - Linked escape sequences combining multiple techniques
- **[[Hip Movement]]** - Fundamental principle enabling all mount escape mechanics
- **[[Defensive Framing]]** - Core concept for maintaining space and preventing submission setups
- **[[Bridge and Roll]]** - Primary reversal technique from mount bottom
- **[[Elbow Escape]]** - Fundamental escape to half guard from mount
- **[[Shrimp Escape]]** - Hip escape variation creating guard recovery angles
- **[[Half Guard]]** - Common intermediate position during mount escape progression
- **[[Defensive Position]]** - Alternative defensive posture when mount escape fails
