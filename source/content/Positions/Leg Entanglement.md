...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Use Leg Entanglement",
  "description": "Complete guide to leg entanglement in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "What happens if you ignoring positional hierarchy and going directly for low-percentage submissions from neutral entanglements?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Failed submission attempts that result in loss of position and opportunity to finish The correct approach is: Follow the systematic approach of establishing dominant entanglement first, then transitioning to better variants before committing to submission attempts"
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "Leg Entanglement",
      "item": "https://bjjgraph.org/Positions/Leg-Entanglement"
    }
  ]
}
</script>
