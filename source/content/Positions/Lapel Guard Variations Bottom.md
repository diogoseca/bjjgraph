...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Use Lapel Guard Variations Bottom in BJJ",
  "description": "Complete guide to executing techniques and transitions from Lapel Guard Variations Bottom.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Execute Guard Retention",
      "text": "From Lapel Guard Variations Bottom, execute Guard Retention to advance your position.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Execute De La Worm Sweep",
      "text": "From Lapel Guard Variations Bottom, execute De La Worm Sweep to advance your position.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Execute Lapel Lasso Sweep",
      "text": "From Lapel Guard Variations Bottom, execute Lapel Lasso Sweep to advance your position.",
      "position": 3
    }
  ],
  "tool": [
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is a key principle of Lapel Guard Variations Bottom?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "**Multi-Layered Control Integration**: Seamlessly blend lapel control with hooks, frames, and traditional guard elements for comprehensive constraint"
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Lapel Guard Variations Bottom",
  "description": "Master Lapel Guard Variations in BJJ. Advanced configurations including de la worm, lapel lasso, and hybrid lapel systems. Success rates: Beginner 25%, Intermediate 42%, Advanced 60%.",
  "url": "https://bjjgraph.org/Positions/Lapel-Guard-Variations-Bottom",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Graph",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "Lapel Guard Variations Bottom",
      "item": "https://bjjgraph.org/Positions/Lapel-Guard-Variations-Bottom"
    }
  ]
}
</script>
