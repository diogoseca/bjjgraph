...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What happens if you remaining static in turtle position instead of maintaining constant movement?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Allows opponent to establish heavy pressure, secure grips, and systematically advance to back control or other dominant positions The correct approach is: Keep hips in constant motion, shifting weight between knees and using small directional changes to prevent opponent from settling into controlling positions"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you failing to actively fight opponent's grip attempts on collar or wrists?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Permits opponent to establish seat belt control or cross-face, leading directly to back takes or crucifix positions with high finishing percentages The correct approach is: Aggressively strip grips using opposite hand, prioritize defending far-side underhook, and keep hands close to body when not actively fighting grips"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you allowing elbows to flare away from body creating space for hooks?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Gives opponent clear pathway to insert hooks for back control or establish body triangle, dramatically increasing submission danger The correct approach is: Maintain tight connection between elbows and ribs, only extending arms when actively posting or fighting grips, immediately retract to defensive position"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you posting head on mat or looking up excessively?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Exposes neck to guillotine attacks and front headlock controls while compromising base and making granby roll escapes more difficult The correct approach is: Keep chin tucked to chest, head positioned between shoulders as protective wedge, maintain awareness through peripheral vision rather than lifting head"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you moving in predictable linear patterns that opponent can anticipate?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Allows opponent to time attacks and transitions based on predictable movement patterns, reducing effectiveness of defensive mobility The correct approach is: Use circular and rotational movement, vary timing and direction of hip shifts, create unpredictable scramble situations that favor defensive position"
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "Crackhead Control Bottom",
      "item": "https://bjjgraph.org/Positions/Crackhead-Control-Bottom"
    }
  ]
}
</script>
...
#bjj #position #turtle #bottom #defensive #10th-planet #eddie-bravo #crackhead-control #guard-recovery #scramble 
