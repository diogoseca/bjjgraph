...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Use Defensive Position",
  "description": "Complete guide to defensive position in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Execute Shrimp Escape",
      "text": "From this position, execute Shrimp Escape to transition to Closed Guard. Success rate for advanced practitioners: 70%.",
      "position": 1
    },
    {
      "@type": "HowToStep",
    ...
    },
    {
      ...
      "text": "From this position, execute Hip Escape to transition to Butterfly Guard. Success rate for advanced practitioners: 68%.",
      "position": 6
    },
    {
      "@type": "HowToStep",
    ...
    },
    {
      ...
      "text": "From this position, execute Guard Replacement to transition to Spider Guard. Success rate for advanced practitioners: 62%.",
      "position": 8
    }
  ],
  "totalTime": "PT2M"
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What happens if you flat positioning with back completely on mat?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Eliminates ability to shrimp or bridge, makes opponent's weight maximally effective, prevents escape movements and allows opponent to settle position permanently The correct approach is: Maintain curved spine with one shoulder slightly elevated, creating constant angle that enables hip movement and prevents opponent from fully settling weight"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you arm extension away from body to push opponent?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Exposes arms to isolation attacks including kimura, americana, and armbars, eliminates structural integrity of frames, wastes energy pushing against superior leverage The correct approach is: Keep elbows connected to ribs and hips, create frames with forearm bones perpendicular to opponent's pressure rather than pushing with muscles"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you frame collapse under sustained pressure?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Allows opponent to close distance and establish submission attacks, eliminates space needed for escape movements, creates panic response and energy depletion The correct approach is: Build frames with skeletal structure rather than muscle strength, adjust frame angles as pressure changes, create new frames before abandoning old ones"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you holding breath or irregular breathing patterns?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Triggers panic response in central nervous system, depletes energy reserves rapidly, impairs decision-making and technical execution, signals distress to opponent The correct approach is: Establish controlled breathing rhythm immediately upon entering defensive position, exhale during pressure application, maintain steady breath cycle throughout escape attempts"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you excessive strength application without technical foundation?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Depletes energy reserves without positional improvement, creates openings for opponent counters, reinforces bad habits, prevents development of proper technique The correct approach is: Focus on timing, leverage, and incremental movements rather than explosive strength, use opponent's pressure and momentum against them through proper positioning"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you chin elevation exposing neck to choke attacks?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Provides immediate access to carotid arteries and trachea for chokes, signals inexperience to opponent, creates submission opportunities from dominant positions The correct approach is: Tuck chin firmly to chest, create collar protection with shoulders, maintain neck defense as primary priority even during escape attempts"
      }
    }
  ]
}
...
- **[[Mount Control]]** → [[Mount]]
- **[[Back Control Establishment]]** → [[Back Control]]
- **[[Transition to North-South]]** → [[North-South]]
- **[[Kimura Control]]** → [[Kimura Control]]
...
- **[[Frame and Shrimp]]** → [[Half Guard]]
  - Opponent attempts to flatten or consolidate side control pressure
- **[[Granby Roll]]** → [[Turtle]]
  - Opponent overcommits forward weight during passing attempt
- **[[Hip Escape]]** → [[Knee Shield Half Guard]]
  - Opponent shifts weight to isolate near side arm
- **[[Technical Standup]]** → [[Standing Position]]
  - Opponent creates distance or stands to disengage
...
- **[[Shrimp Escape]]** - Fundamental transition from defensive position to guard recovery
- **[[Frame and Shrimp]]** - Combined technique for creating space and movement under pressure
- **[[Technical Standup]]** - Alternative escape pathway from defensive positions
- **[[Back Defense Protocol]]** - Systematic defensive strategy when back is taken
- **[[Defensive Strategy]]** - Overarching conceptual approach to survival situations
- **[[Space Creation]]** - Core principle enabling transitions from defensive positions
- **[[Pin Escape Methodology]]** - Systematic approach to escaping from pinning positions
