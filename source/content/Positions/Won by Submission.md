...
description: "Terminal state in BJJ where practitioner successfully forces opponent to submit. Learn tap protocols, finish mechanics, safety procedures, and paths to victory."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Use Won by Submission",
  "description": "Complete guide to won by submission in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Execute Match Victory Acknowledgement",
      "text": "From this position, execute Match Victory Acknowledgement to transition to Standing Position. Success rate for advanced practitioners: 100%.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Execute Position Reset for Training",
      "text": "From this position, execute Position Reset for Training to transition to Standing Position. Success rate for advanced practitioners: 100%.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Execute Technical Discussion",
      "text": "From this position, execute Technical Discussion to transition to Standing Position. Success rate for advanced practitioners: 100%.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Execute Continue Rolling from Reset",
      "text": "From this position, execute Continue Rolling from Reset to transition to Standing Position. Success rate for advanced practitioners: 100%.",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Execute Review Submission Mechanics",
      "text": "From this position, execute Review Submission Mechanics to transition to Standing Position. Success rate for advanced practitioners: 98%.",
      "position": 5
    },
    {
      "@type": "HowToStep",
      "name": "Execute Partner Safety Check",
      "text": "From this position, execute Partner Safety Check to transition to Standing Position. Success rate for advanced practitioners: 100%.",
      "position": 6
    }
  ],
  "totalTime": "PT2M"
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What happens if you continuing to apply pressure after tap is received?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Serious injury to training partner, loss of trust, potential expulsion from academy, legal liability, and violation of fundamental BJJ safety protocols The correct approach is: Release submission immediately upon any tap signal - develop automatic response to tap recognition through drilling proper release protocols"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you applying submissions explosively without gradual pressure buildup?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Injuries occur before opponent can tap, damaged training relationships, reputation as unsafe partner, and missed learning opportunities The correct approach is: Apply all submissions with controlled, progressive pressure over 3-5 seconds minimum, giving opponent clear opportunity to recognize and tap to submission"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you failing to recognize non-standard tap signals (foot taps, verbal)?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Injuries to opponents who cannot tap with hands, safety violations, and lack of awareness during critical moments The correct approach is: Train awareness for all tap modalities - foot taps when hands trapped, verbal taps when immobilized, body convulsions indicating unconsciousness from chokes"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you celebrating victory before ensuring opponent is safe and okay?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Appears disrespectful, misses opportunity to check on partner's wellbeing, and violates BJJ etiquette and safety culture The correct approach is: Immediately check on training partner after submission, ensure they are uninjured, offer assistance standing up, and show respect before any celebration"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you not understanding proper tap protocols in different contexts (training vs competition)?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Confusion about when to release submissions, potential safety issues, and misunderstanding of competitive vs cooperative training environments The correct approach is: Learn distinction between training (tap early and often for safety/learning) and competition (fight to avoid tap within safety limits) contexts"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you applying neck cranks or spine locks without proper control and experience?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Catastrophic spinal injuries, permanent damage, paralysis risk, and violation of safety standards in most training environments The correct approach is: Only practice neck cranks and spine submissions under expert supervision with experienced partners who understand risks and proper tap timing"
      }
    }
  ]
}
...
- **[[Request Technical Explanation]]** → [[Standing Position]]
...
- **[[Immediate Release Protocol]]** → [[Standing Position]]
  - Any tap signal detected from opponent including hand tap, foot tap, or verbal submission
- **[[Position Maintenance After Release]]** → [[Standing Position]]
  - Training partner requests to review submission mechanics or restart from standing
...
- **[[Rear Naked Choke]]** - Most common submission finish from back control positions
- **[[Triangle Choke]]** - High-percentage submission from guard positions
- **[[Armbar from Mount]]** - Fundamental submission from dominant top position
- **[[Kimura]]** - Versatile submission available from multiple control positions
- **[[Heel Hook]]** - Modern leg lock submission requiring advanced safety awareness
- **[[Back Control]]** - Highest percentage position for submission finishes
- **[[Mount]]** - Dominant position with multiple submission attack paths
- **[[Triangle Control]]** - Control position leading to triangle choke submission
- **[[Lost by Submission]]** - Opposing terminal state from defender's perspective
- **[[Guillotine Choke]]** - Common submission finish from front headlock control
- **[[Armbar from Guard]]** - Classic submission from bottom position guard control
- **[[Side Control]]** - Controlling position with multiple submission transitions
