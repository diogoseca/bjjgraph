...
- [[Maintain Closed Guard]] → [[Closed Guard Bottom]] (Success Rate: 45%)
- [[Establish Dominant Grips]] → [[Submission Setup]] (Success Rate: 40%)
- [[Break Posture]] → [[Closed Guard Top]] (Success Rate: 35%)
- [[Hip Movement]] → [[Sweep Setup]] (Success Rate: 30%)
- [[Collar Grip Control]] → [[Cross Collar Choke]] (Success Rate: 25%)

## Offensive Transitions (Available From This State)
- [[Standing Guard]] → [[Open Guard Top]] (Success Rate: Beginner 35%, Intermediate 50%, Advanced 65%)
- [[Knee Pin Break]] → [[Combat Base]] (Success Rate: Beginner 30%, Intermediate 45%, Advanced 60%)
- [[Double Lapel Break]] → [[Headquarters Position]] (Success Rate: Beginner 25%, Intermediate 40%, Advanced 55%)
- [[Log Splitter Break]] → [[Open Guard Top]] (Success Rate: Beginner 20%, Intermediate 35%, Advanced 50%)
- [[Stack Break]] → [[Standing Position]] (Success Rate: Beginner 25%, Intermediate 40%, Advanced 55%)
- [[Combat Base Transition]] → [[Combat Base]] (Success Rate: Beginner 30%, Intermediate 45%, Advanced 60%)
- [[Two-on-One Break]] → [[Open Guard Top]] (Success Rate: Beginner 20%, Intermediate 35%, Advanced 50%)
- [[Pressure Pass Setup]] → [[Pressure Passing]] (Success Rate: Beginner 25%, Intermediate 40%, Advanced 55%)
...
- Execute [[Grip Breaking Sequence]] → [[Standing Guard]] (Probability: 50%)
- Or Execute [[Two-on-One Break]] → [[Open Guard Top]] (Probability: 45%)

Else if opponent attempts to break posture:
- Execute [[Base Maintenance]] → [[Two-on-One Break]] (Probability: 40%)
- Or Execute [[Double Lapel Break]] → [[Headquarters Position]] (Probability: 35%)

Else if opponent elevates hips for sweep:
- Execute [[Base and Frame]] → [[Combat Base Transition]] (Probability: 45%)
- Or Execute [[Stack Break]] → [[Standing Position]] (Probability: 40%)

Else if opponent maintains neutral closed guard:
- Execute [[Double Lapel Break]] → [[Headquarters Position]] (Probability: 40%)
- Or Execute [[Knee Pin Break]] → [[Combat Base]] (Probability: 35%)
...
[[Closed Guard Top]] → [[Standing Guard]] → [[Open Guard Top]] → [[Headquarters Position]] → [[Knee Cut Pass]] → [[Side Control]]
...
[[Closed Guard Top]] → [[Stack Break]] → [[Standing Position]] → [[Pressure Pass Setup]] → [[Double Under Pass]] → [[Side Control]]

Alternative passing path:
[[Closed Guard Top]] → [[Log Splitter Break]] → [[Open Guard Top]] → [[Pressure Pass Setup]] → [[Smash Pass]] → [[Side Control]]
