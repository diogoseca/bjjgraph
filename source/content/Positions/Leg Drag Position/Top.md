...
---
title: "Leg Drag Position Top | BJJ Position Guide | BJJ Graph"
description: "Control and finish the leg drag position with systematic passing sequences, pressure application, and back-taking opportunities from this dominant passing position."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Attack from Leg Drag Position Top",
  "description": "Step-by-step guide to attacking and submitting from Leg Drag Position position in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What happens if you overcommitting weight to chest pressure without controlling far hip?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Opponent can granby roll underneath or invert to escape The correct approach is: Balance chest pressure with far hip control using arm or head position"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you staying too square to opponent instead of perpendicular?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Opponent can turn into you and recover guard or half guard easily The correct approach is: Maintain perpendicular angle with head tight to their body"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you allowing opponent to establish butterfly hook with free leg?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Hook provides lever to lift and escape, negating leg drag control The correct approach is: React immediately to butterfly hook attempt with knee slice or pressure adjustment"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you lifting chest pressure prematurely during passing transition?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Creates space for opponent to recover guard structures The correct approach is: Maintain pressure throughout transition, only releasing when control is established in next position"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you ignoring opponent's turn away movement?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Misses high-percentage back take opportunity The correct approach is: Recognize turn away immediately and transition to back step or back take"
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "Leg Drag Position Top",
      "item": "https://bjjgraph.org/Positions/Leg-Drag-Position-Top"
    }
  ]
}
</script>
...
## What is Leg Drag Position from the Top?
...
### 1. Overcommitting weight to chest pressure without controlling far hip
...
### 2. Staying too square to opponent instead of perpendicular
...
### 3. Allowing opponent to establish butterfly hook with free leg
...
### 4. Lifting chest pressure prematurely during passing transition
...
### 5. Ignoring opponent's turn away movement
...
### 6. Static pressure without positional progression
...
### Leg Drag to Multiple Finishes

Establish leg drag position and practice transitioning between knee slice, back step, and pressure pass finishes. Partner provides 50% resistance. Focus on maintaining control throughout transitions.
...
Partner plays various guards (butterfly, De La Riva, open guard). Practice entering leg drag position from each guard structure. Emphasize angle creation and initial control establishment.

**Duration**: 5 minutes


### Pressure Management Drill

Hold leg drag position while partner attempts specific escapes (butterfly hook, granby roll, half guard recovery). Focus on adjusting pressure and position to shut down each escape without losing control.

**Duration**: 3 minutes


### Back Take Recognition

Partner in leg drag bottom randomly turns away during the round. Practice immediate recognition and back step transition. Develop sensitivity to opponent's turning movement.
...
- **[[Headquarters Position]]** - Common entry position to leg drag
- **[[Side Control]]** - Primary finishing position from leg drag pass
- **[[Back Control]]** - Alternative finish when opponent turns away
