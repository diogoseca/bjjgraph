...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Use Scramble Position",
  "description": "Complete guide to scramble position in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "What happens if you poor grip fighting allowing opponent to establish dominant controls?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Opponent secures collar grips, wrist control, or head position that facilitates their positional advancement The correct approach is: Actively fight for superior grips while breaking opponent's connections, prioritizing collar, head, and wrist control"
      }
    }
  ]
}
