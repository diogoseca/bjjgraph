...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Attack from Game Over Top",
  "description": "Step-by-step guide to attacking and submitting from Game Over position in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
    ...
    },
    {
      ...
      "text": "From this position, execute Armbar from Mount to transition to Won by Submission. Success rate for advanced practitioners: 70%.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Execute Triangle Choke",
      "text": "From this position, execute Triangle Choke to transition to Won by Submission. Success rate for advanced practitioners: 65%.",
      "position": 3
    },
    {
      "@type": "HowToStep",
    ...
    },
    {
      ...
      "text": "From this position, execute Heel Hook to transition to Won by Submission. Success rate for advanced practitioners: 65%.",
      "position": 6
    }
  ],
  "totalTime": "PT2M"
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What happens if you attempting submissions from poor positions without establishing control first?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Low success rate and high risk of position reversal or escape during submission attempt The correct approach is: Follow position-before-submission principle—establish mount, back, or side control before attacking finishes"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you not recognizing when submission is fully locked and releasing pressure prematurely?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Opponent escapes when submission was actually complete, missing finish opportunity The correct approach is: Maintain consistent pressure and body position once submission is locked—wait for tap rather than assuming success"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you attacking single submissions without chains when opponent defends?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Predictable attacks that skilled opponents defend easily, missing alternative finish opportunities The correct approach is: Train submission combinations where defense of one creates vulnerability to another—triangle to armbar, armbar to triangle, kimura to armbar chains"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you continuing to apply submission pressure after opponent taps?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Partner injury and dangerous reputation making training partners avoid rolling with you The correct approach is: Release immediately upon any tap signal—verbal, hand tap, foot tap, or any unusual movement suggesting distress"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you telegraphing submission attempts with obvious setup movements?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Opponent recognizes attack early and defends before submission control is established The correct approach is: Disguise submission setups within position transitions—enter submissions during opponent's movements when awareness is divided"
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "Game Over Top",
      "item": "https://bjjgraph.org/Positions/Game-Over-Top"
    }
  ]
}
</script>
...
### [[Armbar from Mount]] → [[Won by Submission]]
...
- **[[Emergency Counter]]** → [[Guard Opening Sequence]] (Opponent Success: 15%)
- **[[Tap Out]]** → [[Lost by Submission]] (Opponent Success: 100%)
...
- **[[Position Retention]]** → [[Mount]]
  - Opponent escapes submission but attacker maintains dominant position for re-attack
- **[[Recapture Control]]** → [[Back Control]]
  - Opponent begins escape sequence but attacker adjusts to restore submission threat
...
- Execute **[[Attack Rear Naked Choke]]** → [[Won by Submission]] (Probability: 65%)
- Execute **[[Switch to Armbar from Back]]** → [[Won by Submission]] (Probability: 55%)


**If opponent extends arms in closed guard bottom:**
- Execute **[[Triangle Choke]]** → [[Won by Submission]] (Probability: 60%)
- Execute **[[Armbar from Guard]]** → [[Won by Submission]] (Probability: 55%)
- Execute **[[Omoplata]]** → [[Won by Submission]] (Probability: 45%)


**If opponent is flat in mount with arms near face:**
- Execute **[[Armbar from Mount]]** → [[Won by Submission]] (Probability: 70%)
- Execute **[[Ezekiel Choke]]** → [[Won by Submission]] (Probability: 50%)


**If opponent is turtled and defending back exposure:**
- Execute **[[Crucifix Submissions]]** → [[Won by Submission]] (Probability: 55%)
- Execute **[[Darce Choke]]** → [[Won by Submission]] (Probability: 50%)


**If legs are entangled in ashi garami variations:**
- Execute **[[Heel Hook]]** → [[Won by Submission]] (Probability: 65%)
- Execute **[[Straight Ankle Lock]]** → [[Won by Submission]] (Probability: 50%)
- Execute **[[Kneebar]]** → [[Won by Submission]] (Probability: 45%)
...
- **[[Won by Submission]]** - Terminal state reached when achieving Game Over Top successfully
- **[[Submission Position]]** - Principle defining positions with high submission probability
- **[[Submission Chains]]** - Principle for connecting multiple submissions into inescapable sequences
- **[[Back Control]]** - Highest percentage position for reaching Game Over Top
- **[[Mount]]** - Dominant position offering multiple Game Over Top pathways
