...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Escape Game Over Bottom",
  "description": "Step-by-step guide to escaping and defending Game Over position in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Execute Tap Out",
      "text": "From this position, execute Tap Out to transition to Lost by Submission. Success rate for advanced practitioners: 100%.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Execute Armbar Defense",
      "text": "From this position, execute Armbar Defense to transition to Defensive Position. Success rate for advanced practitioners: 35%.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Execute Triangle Escape",
      "text": "From this position, execute Triangle Escape to transition to Defensive Position. Success rate for advanced practitioners: 30%.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Execute Guillotine Defense",
      "text": "From this position, execute Guillotine Defense to transition to Defensive Position. Success rate for advanced practitioners: 35%.",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Execute Kimura Defense",
      "text": "From this position, execute Kimura Defense to transition to Defensive Position. Success rate for advanced practitioners: 30%.",
      "position": 5
    },
    {
      "@type": "HowToStep",
      "name": "Execute RNC Defense",
      "text": "From this position, execute RNC Defense to transition to Back Control. Success rate for advanced practitioners: 30%.",
      "position": 6
    }
  ],
  "totalTime": "PT2M"
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What happens if you waiting too long to tap out of competitive pride or ego?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Joint injury, ligament damage, or loss of consciousness causing training interruption The correct approach is: Tap the moment escape becomes mechanically impossible—training longevity matters more than single match"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you not recognizing submission is fully locked and attempting impossible escape?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Severe injury from resisting joint locks at structural limit or passing out from chokes The correct approach is: Study submission mechanics to recognize lock completion versus setup phase where escape exists"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you panicking under submission pressure and making situation worse?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Wasted energy, poor decision-making, and potential injury from spastic movements The correct approach is: Practice calm breathing under submission pressure in training to develop composed assessment ability"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you failing to tap because hands are controlled and not using verbal or foot tap?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Unnecessary injury when alternative tap signals are available and valid The correct approach is: Train all tap methods—verbal tap and foot tap are equally valid submission signals"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you tapping too early when genuine escape is still possible?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Lost opportunities and failure to develop late-stage escape skills The correct approach is: Develop kinesthetic awareness of escape windows through positional sparring focused on submission defense"
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "Game Over Bottom",
      "item": "https://bjjgraph.org/Positions/Game-Over-Bottom"
    }
  ]
}
</script>
...
- **[[Foot Tap]]** → [[Lost by Submission]] (Opponent Success: 100%)
...
- **[[Emergency Escape]]** → [[Scramble Position]]
  - Explosive movement in the brief window before submission is fully locked—high injury risk
...
- **[[Lost by Submission]]** - Terminal state reached when tapping from Game Over Bottom
- **[[Submission Defense]]** - Principle for preventing progression to Game Over Bottom
- **[[Defensive Position]]** - Generic defensive state where Game Over Bottom is being threatened
- **[[Rear Naked Choke]]** - Common submission creating Game Over Bottom from back control
- **[[Armbar from Mount]]** - High percentage submission creating Game Over Bottom from mount
- **[[Triangle Choke]]** - Guard submission frequently leading to Game Over Bottom
- **[[Heel Hook]]** - Leg lock submission with rapid Game Over Bottom progression
- **[[Kimura]]** - Shoulder lock submission threatening Game Over Bottom from multiple positions
