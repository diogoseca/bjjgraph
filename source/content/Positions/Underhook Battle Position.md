...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Use Underhook Battle Position in BJJ",
  "description": "Complete guide to executing techniques and transitions from Underhook Battle Position.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Execute Body Lock Pass",
      "text": "From Underhook Battle Position, execute Body Lock Pass to advance your position.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Execute Duck Under",
      "text": "From Underhook Battle Position, execute Duck Under to advance your position.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Execute Arm Drag",
      "text": "From Underhook Battle Position, execute Arm Drag to advance your position.",
      "position": 3
    }
  ],
  "tool": [
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is a key principle of Underhook Battle Position?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Underhook control provides significant offensive and defensive advantages"
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Underhook Battle Position",
  "description": "Master Underhook Battle Position in BJJ. Complete guide covering control, entries, and transitions. Success rates: Beginner 45%, Intermediate 60%, Advanced 75%.",
  "url": "https://bjjgraph.org/Positions/Underhook-Battle-Position",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Graph",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "Underhook Battle Position",
      "item": "https://bjjgraph.org/Positions/Underhook-Battle-Position"
    }
  ]
}
</script>
