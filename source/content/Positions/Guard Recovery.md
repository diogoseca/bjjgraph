...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Use Guard Recovery in BJJ",
  "description": "Complete guide to executing techniques and transitions from Guard Recovery.",
  "step": [
    {
      "@type": "HowToStep",
    ...
    {
      "@type": "HowToStep",
      "name": "Execute Butterfly Guard Recovery",
      "text": "From this position, execute Butterfly Guard Recovery to transition to Butterfly Guard.",
      "position": 5
    },
    {
      "@type": "HowToStep",
