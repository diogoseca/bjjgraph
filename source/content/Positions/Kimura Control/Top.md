...
---
title: "Kimura Control Top | BJJ Position Guide | BJJ Graph"
description: "Master Kimura Control from top in BJJ. Dominant control position with direct submission threat (50-80%) and transitions to mount, back control. Pressure-based shoulder lock system."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Attack from Kimura Control Top",
  "description": "Step-by-step guide to attacking and submitting from Kimura Control position in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Execute Kimura from Side Control",
      "text": "From this position, execute Kimura from Side Control to transition to Kimura. Success rate for advanced practitioners: 80%.",
      "position": 1
    },
    {
      "@type": "HowToStep",
    ...
    },
    {
      ...
      "text": "From this position, execute Kimura to Back Take to transition to Back Control. Success rate for advanced practitioners: 70%.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Execute North-South to Kimura",
      "text": "From this position, execute North-South to Kimura to transition to North-South. Success rate for advanced practitioners: 75%.",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Execute Kimura from Turtle",
      "text": "From this position, execute Kimura from Turtle to transition to Kimura. Success rate for advanced practitioners: 70%.",
      "position": 5
    },
    {
      "@type": "HowToStep",
      "name": "Execute Rolling Kimura",
      "text": "From this position, execute Rolling Kimura to transition to Mount. Success rate for advanced practitioners: 65%.",
      "position": 6
    }
  ],
  "totalTime": "PT2M"
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What happens if you allowing opponent to create space by elevating hips while maintaining grip?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Opponent escapes hip control and recovers guard or half guard position despite Kimura grip remaining intact The correct approach is: Keep hips low and heavy on opponent, using knee or free hand to control their near hip and prevent space creation—pressure maintenance equals position retention"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you rushing to finish submission without first isolating arm and removing defensive frames?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Opponent successfully defends by keeping elbow connected to body or using free hand to defend, then works systematic grip break and escape The correct approach is: Systematically remove opponent's defensive structures first: break frames, isolate arm, control hips, then apply submission mechanics when structure is fully compromised"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you maintaining static position without transitioning when opponent successfully defends submission?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Position becomes stalemate with neither submission nor advancement occurring, wasting energy and opportunity while opponent works escape The correct approach is: When opponent successfully defends Kimura finish, immediately transition to mount, back, or north-south rather than forcing failed submission attempt"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you releasing grip to establish better position before submission is defended?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Lose valuable control and submission threat, allowing opponent to recover defensive posture and escape to better position The correct approach is: Maintain Kimura grip during all transitions—use grip as anchor for positional advancement rather than releasing prematurely"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you failing to control opponent's near hip allowing them to roll into the grip?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Opponent successfully rolls to relieve shoulder pressure, potentially reversing position or escaping to turtle while neutralizing submission threat The correct approach is: Use free hand, knee, or hip position to control opponent's near hip throughout control, preventing rolling escape and maintaining perpendicular angle"
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "Kimura Control Top",
      "item": "https://bjjgraph.org/Positions/Kimura-Control-Top"
    }
  ]
}
</script>
...
- **[[Grip Break]]** → [[Side Control]] (Opponent Success: 30%)
...
- **[[Kimura to Back Take]]** → [[Back Control]]
  - Opponent rolls away from pressure to defend shoulder, exposing back
- **[[North-South to Kimura]]** → [[North-South]]
  - Opponent defends by flattening arm, creating opportunity for north-south transition
- **[[Rolling Kimura]]** → [[Mount]]
  - Opponent attempts rolling escape, creating opportunity for rolling kimura to mount
- **[[Kimura from Mount]]** → [[Kimura]]
  - Successfully advance to mount while maintaining grip for enhanced finishing leverage
...
- **[[Kimura Trap]]** - Systematic approach building comprehensive attack chains from this control
- **[[Side Control]]** - Primary position where Kimura Control Top is established and finished
- **[[North-South]]** - Key transition position for enhanced Kimura finishing leverage
- **[[Mount]]** - Dominant advancement option while maintaining Kimura grip
- **[[Back Control]]** - High-percentage transition when opponent defends by rolling away
- **[[Kimura]]** - Primary submission finish from this control position
- **[[Kimura from Side Control]]** - Direct submission technique from this control
- **[[Kimura from Mount]]** - Enhanced finishing position after positional advancement
