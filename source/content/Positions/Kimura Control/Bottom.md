...
---
title: "Kimura Control Bottom | BJJ Position Guide | BJJ Graph"
description: "Master Kimura Control from bottom in BJJ. Defensive position with exceptional sweep potential (40-70%) and submission threat. Transform defensive scenarios into offensive opportunities."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Escape Kimura Control Bottom",
  "description": "Step-by-step guide to escaping and defending Kimura Control position in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Execute Kimura Sweep",
      "text": "From this position, execute Kimura Sweep to transition to Side Control. Success rate for advanced practitioners: 70%.",
      "position": 1
    },
    {
      "@type": "HowToStep",
    ...
    },
    {
      ...
      "text": "From this position, execute Kimura to Back Take to transition to Back Control. Success rate for advanced practitioners: 55%.",
      "position": 3
    },
    {
      "@type": "HowToStep",
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What happens if you releasing or loosening kimura grip under pressure to adjust position?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Opponent escapes grip entirely and consolidates to dominant position (side control or mount) with full weight and pressure control The correct approach is: Maintain death grip on wrist and figure-four lock even when adjusting hips or creating angles—grip maintenance takes absolute priority over positional adjustment"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you allowing opponent to settle their weight chest-to-chest without active hip movement?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Position becomes purely defensive with no sweep or submission opportunities as opponent's weight pins bottom player and neutralizes Kimura mechanics The correct approach is: Keep hips in constant motion using shrimps, bridges, and angle changes to prevent opponent from establishing stable pressure while maintaining grip structure"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you failing to frame with free arm against opponent's hips or shoulders?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Opponent advances to full mount or side control consolidation despite Kimura grip as there's no distance management or secondary control point The correct approach is: Use free arm dynamically to frame against hips when creating space or against shoulders when preventing forward pressure—coordinate frames with hip movement"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you attempting to finish kimura submission without first off-balancing or controlling opponent's base?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Opponent easily defends by widening base and maintaining posture, then systematically works to escape grip or pass guard while submission threat is neutralized The correct approach is: Use Kimura grip as control mechanism first—off-balance opponent, compromise their base, then transition to finishing mechanics when structure is broken"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you keeping legs static or inactive during kimura control from bottom?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Opponent easily passes around legs or establishes leg control leading to mount or side control as lower body provides no defensive barrier The correct approach is: Integrate butterfly hooks, knee shields, or closed guard legs to complement upper body Kimura control and create comprehensive defensive structure"
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "Kimura Control Bottom",
      "item": "https://bjjgraph.org/Positions/Kimura-Control-Bottom"
    }
  ]
}
</script>
...
## What is Kimura Control from the Bottom?
...
- **[[Base Widening]]** → [[Half Guard]] (Opponent Success: 50%)
- **[[Pressure Pass]]** → [[Mount]] (Opponent Success: 35%)
- **[[Grip Break]]** → [[Side Control]] (Opponent Success: 40%)
...
- **[[Rolling Kimura]]** → [[Mount]]
  - Opponent rolls to defend shoulder pressure or escape grip
- **[[Kimura to Back Take]]** → [[Back Control]]
  - Opponent turns away to escape Kimura pressure exposing back
- **[[Triangle Setup]]** → [[Triangle Control]]
  - Opponent posts free hand near hip creating triangle opportunity
- **[[Technical Standup]]** → [[Standing Position]]
  - Opponent backs away to defend Kimura creating space to stand
...
- **[[Kimura Trap]]** - Comprehensive system built around this control position with multiple attack chains
- **[[Half Guard]]** - Common position where Kimura Control is established from bottom
- **[[Closed Guard]]** - Primary guard position for securing initial Kimura grip
- **[[Kimura]]** - Primary submission threat from this control position
- **[[Triangle Control]]** - Common transition when opponent defends Kimura by posting
