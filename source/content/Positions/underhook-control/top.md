...
---
title: "Underhook Control Top | BJJ Position Guide | BJJ Graph"
description: "Master top underhook control in BJJ. Complete guide to offensive pressure, pass consolidation, and submission setups from top underhook position with proven strategies."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Attack from Underhook Control Top",
  "description": "Step-by-step guide to attacking and submitting from Underhook Control position in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Execute Underhook Pass",
      "text": "From this position, execute Underhook Pass to transition to Side Control. Success rate for advanced practitioners: 80%.",
      "position": 1
    },
    {
      "@type": "HowToStep",
    ...
    },
    {
      ...
      "text": "From this position, execute Crossface Pass to transition to Side Control. Success rate for advanced practitioners: 80%.",
      "position": 3
    },
    {
      "@type": "HowToStep",
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What happens if you pulling upward on the underhook instead of driving downward pressure?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Lifting creates space underneath your body, allowing bottom player to elevate their hip, create angles, and execute sweeps or guard recovery. Your pressure becomes neutralized completely The correct approach is: Drive underhook pressure downward toward the mat continuously. Think of pushing opponent's shoulder into the ground rather than pulling them toward you. Weight drives through the underhook connection"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you neglecting crossface control while focusing entirely on underhook?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Bottom player establishes head control or inside position, enabling them to turn into you for sweeps or create off-balancing opportunities. Underhook alone provides incomplete control The correct approach is: Coordinate underhook with crossface pressure where your shoulder drives into opponent's face. This dual control eliminates their ability to turn and creates complete upper body domination"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you allowing hips to rise high above opponent's hips during underhook control?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "High hips create space for bottom player to shrimp, recover guard, or insert knee shields. Your pressure becomes ineffective and passes stall The correct approach is: Keep your hips low and driving toward opponent's hips. Maintain heavy hip pressure that pins them flat while your underhook controls their upper body"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you maintaining static underhook position without advancing or creating new angles?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Bottom player adapts to static pressure, establishes defensive frames, and neutralizes your passing attempts. Referees may penalize for stalling in competition The correct approach is: Use underhook as foundation for continuous advancement. Chain together knee cuts, leg weaves, and position transitions rather than holding static pressure"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you exposing your own neck by overcommitting to underhook pressure without protecting head position?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Bottom player establishes guillotine grips or front headlock control, creating dangerous submission threats that force you to abandon your pass The correct approach is: Maintain head position tight to opponent's shoulder or far side of their body. Never allow space for them to insert their arm around your neck during underhook advances"
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "Underhook Control Top",
      "item": "https://bjjgraph.org/Positions/Underhook-Control-Top"
    }
  ]
}
</script>
...
# Underhook Control Top

#Position #Top Position #Underhook #Half Guard Top #Passing Strategy #Pressure Control 
...
## What is Underhook Control from the Top?
...
- **[[Deep Half Entry]]** → [[Deep Half Guard]] (Opponent Success: 50%)
- **[[Rolling Back Take]]** → [[Back Control]] (Opponent Success: 35%)
- **[[Re-Guard]]** → [[Closed Guard]] (Opponent Success: 45%)
...
- **[[Darce Setup]]** → [[D'arce Control]]
  - When bottom player drives forward with underhook, exposing their neck
- **[[Crossface Pass]]** → [[Side Control]]
  - When bottom player focuses on fighting underhook, neglecting far side defense
- **[[Back Take Generic]]** → [[Back Control]]
  - When bottom player turns away to escape underhook pressure, exposing their back
...
- **[[Half Guard]]** - Primary position where top underhook control enables pressure passing and position advancement
- **[[Side Control]]** - Target position accessed through successful underhook-based passes
- **[[Quarter Guard]]** - Transitional passing position where underhook control prevents guard recovery
- **[[Headquarters Position]]** - Pressure passing position that integrates with underhook control for pass completion
- **[[Overhook Control]]** - Alternative overhook control that opponents use to defend against underhook passes
- **[[Underhook Pass]]** - Primary passing technique directly enabled by top underhook control
- **[[Kimura to Back Take]]** - Counter-technique when bottom player establishes their own underhook
- **[[Crossface Pass]]** - Complementary passing technique that combines with underhook for complete control
