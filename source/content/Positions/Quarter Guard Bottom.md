...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Use Quarter Guard Bottom in BJJ",
  "description": "Complete guide to executing techniques and transitions from Quarter Guard Bottom.",
  "step": [
    {
      "@type": "HowToStep",
...
<script type="application/ld+json">
{
  ...
  "description": "Master Quarter Guard Bottom in BJJ. Complete guide covering quarter guard control and sweeps. Success rates vary by skill level.",
  "url": "https://bjjgraph.org/Positions/Quarter-Guard-Bottom",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Graph",
