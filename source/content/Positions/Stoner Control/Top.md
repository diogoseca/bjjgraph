...
---
title: "Stoner Control Top | BJJ Position Guide | BJJ Graph"
description: "Defend against Stoner Control from top position in BJJ. Complete guide covering escape strategies for both rubber guard and lockdown variations with systematic defensive frameworks."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Attack from Stoner Control Top",
  "description": "Step-by-step guide to attacking and submitting from Stoner Control position in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Execute Overhook Escape to Posture Recovery",
      "text": "From this position, execute Overhook Escape to Posture Recovery to transition to Closed Guard. Success rate for advanced practitioners: 55%.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Execute Rubber Guard Clear to Pass",
      "text": "From this position, execute Rubber Guard Clear to Pass to transition to Side Control. Success rate for advanced practitioners: 50%.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Execute Lockdown Escape to Half Guard Pass",
      "text": "From this position, execute Lockdown Escape to Half Guard Pass to transition to Side Control. Success rate for advanced practitioners: 60%.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Execute Stack Defense to Guard Pass",
      "text": "From this position, execute Stack Defense to Guard Pass to transition to Side Control. Success rate for advanced practitioners: 55%.",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Execute Crossface to Combat Base",
      "text": "From this position, execute Crossface to Combat Base to transition to Combat Base. Success rate for advanced practitioners: 65%.",
      "position": 5
    },
    {
      "@type": "HowToStep",
      "name": "Execute Knee Slice Pass",
      "text": "From this position, execute Knee Slice Pass to transition to Side Control. Success rate for advanced practitioners: 50%.",
      "position": 6
    }
  ],
  "totalTime": "PT2M"
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What happens if you posting aggressively with free hand near bottom player's hips attempting to create base?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Immediately triggers high-percentage triangle setup or sweep mechanics, leading to submission or position loss The correct approach is: Keep free hand posted on mat away from bottom player's hips, or establish crossface control to limit their offensive options"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you pulling trapped arm straight backward with force attempting to rip free from overhook?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Bottom player uses pulling momentum to set up arm triangle or tighten overhook control, worsening position The correct approach is: Wait for transition moments when overhook loosens, then extract arm using circular motion combined with posture recovery"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you driving weight aggressively forward attempting to flatten bottom player?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Triggers omoplata sweeps in rubber guard or Electric Chair submission in lockdown, leading to immediate reversal or finish The correct approach is: Maintain measured pressure while working systematically on posture recovery and overhook escape, avoiding forward commitment"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you focusing exclusively on extracting trapped arm while ignoring leg control?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Bottom player maintains posture break with leg control making arm extraction impossible, prolonging bad position The correct approach is: Address both controls simultaneously - work crossface or head control to limit mobility while clearing rubber guard or breaking lockdown"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you staying static in position hoping bottom player fatigues or releases pressure?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Bottom player has time to perfect control and set up submissions methodically, increasing finish probability over time The correct approach is: Work actively on systematic escapes using proper timing and technique, creating movement that prevents bottom player from settling control"
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "Stoner Control Top",
      "item": "https://bjjgraph.org/Positions/Stoner-Control-Top"
    }
  ]
}
</script>
...
## What is Stoner Control from the Top?
...
- **[[Invisible Collar Transition]]** → [[Invisible Collar]]
...
- **[[Crossface Control]]** → [[Combat Base]]
  - Bottom player's rubber guard leg drops slightly or lockdown pressure decreases during transition attempts
- **[[Stack Defense]]** → [[Closed Guard]]
  - Bottom player attempts omoplata or triangle transition creating forward movement opportunity
...
- **[[Closed Guard]]** - Recovery position after escaping overhook
- **[[Combat Base]]** - Target position for posture recovery
- **[[Side Control]]** - Goal position after successful pass
- **[[Half Guard]]** - Intermediate position during lockdown escape
- **[[Triangle Control]]** - Required defense skill when bottom player attacks triangle
- **[[Omoplata Control]]** - Essential technique against bottom player's sweep attempts
- **[[Guard Passing Concepts]]** - Framework for systematic passing after escape
- **[[Posture Recovery]]** - Fundamental principle for escaping position
