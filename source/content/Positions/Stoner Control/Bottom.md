...
---
title: "Stoner Control Bottom | BJJ Position Guide | BJJ Graph"
description: "Master Stoner Control Bottom in BJJ. Advanced 10th Planet control position with rubber guard and lockdown variations, featuring deep overhook control and multiple submission pathways."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Escape Stoner Control Bottom",
  "description": "Step-by-step guide to escaping and defending Stoner Control position in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
    ...
    },
    {
      ...
      "text": "From this position, execute Transition to Invisible Collar to transition to Invisible Collar. Success rate for advanced practitioners: 80%.",
      "position": 3
    },
    {
      "@type": "HowToStep",
    ...
    },
    {
      ...
      "text": "From this position, execute Electric Chair Transition to transition to Electric Chair. Success rate for advanced practitioners: 65%.",
      "position": 5
    },
    {
      "@type": "HowToStep",
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What happens if you allowing leg control to release or drop below effective control position?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Opponent recovers posture easily and begins passing sequence or escapes guard control entirely The correct approach is: Maintain constant pressure with rubber guard leg high behind head or active lockdown squeeze throughout all transitions"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you securing shallow overhook with arm only partially under opponent's armpit?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Opponent easily pulls arm free, posts for base, or initiates passing attacks without significant resistance The correct approach is: Thread arm impossibly deep under opponent's armpit until shoulder contacts ribcage, grip around back of shoulder or lat for maximum control"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you remaining flat on back instead of elevating hips actively?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Reduces effectiveness of leg pressure, allows opponent to settle weight and establish base, limits mobility for submission setups The correct approach is: Keep hips elevated throughout position creating upward angle that amplifies leg pressure while maintaining freedom to adjust angles for attacks"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you holding static position without progressing to submissions or sweeps?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Opponent develops escape strategy over time, fatigue sets in for bottom player, referee may penalize for stalling The correct approach is: Use Stoner Control as transition checkpoint rather than destination, immediately chain toward attacks within 3-5 seconds of establishing position"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you attempting position without adequate hip flexibility or lockdown proficiency?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Cannot maintain proper control angles, position feels forced and uncomfortable, increased injury risk to joints The correct approach is: Develop flexibility gradually through consistent stretching, master prerequisite positions like Mission Control before attempting advanced variations"
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "Stoner Control Bottom",
      "item": "https://bjjgraph.org/Positions/Stoner-Control-Bottom"
    }
  ]
}
</script>
...
## What is Stoner Control from the Bottom?
...
- **[[Overhook Defense]]** → [[Rubber Guard]]
- **[[Knee Slice Pass]]** → [[Side Control]]
- **[[Crossface Pass]]** → [[Side Control]]
- **[[Lockdown Defense]]** → [[Half Guard]]
...
- **[[Omoplata to Sweep]]** → [[Omoplata Control]]
  - Opponent drives weight forward or attempts stack pressure
- **[[Electric Chair Submission]]** → [[Electric Chair]]
  - Opponent attempts to pull leg free from lockdown by driving backward
- **[[Truck Entry]]** → [[Truck]]
  - Opponent turns into underhook to prevent sweep or back take
...
- **[[Rubber Guard]]** - Parent position for rubber guard variation
- **[[Mission Control]]** - Prerequisite rubber guard checkpoint
- **[[Lockdown]]** - Foundational control for half guard variation
- **[[Triangle Control]]** - Primary submission transition from rubber guard
- **[[Omoplata Control]]** - Primary sweep and submission option
- **[[Electric Chair]]** - Primary submission from lockdown variation
- **[[Truck]]** - Back attack pathway from lockdown
- **[[Invisible Collar]]** - Advanced rubber guard progression
- **[[Chill Dog]]** - Parallel 10th Planet rubber guard position
- **[[10th Planet Rubber Guard System]]** - Parent systematic framework
- **[[Gogoplata]]** - Advanced submission option from rubber guard
