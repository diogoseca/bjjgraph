...
---
title: "Headquarters Control Bottom | BJJ Position Guide | BJJ Graph"
description: "Master defensive headquarters position in BJJ. Strategic frame-based guard retention with 60% retention rate. Learn sweep timing, re-guards, and pressure management from bottom."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Escape Headquarters Control Bottom",
  "description": "Step-by-step guide to escaping and defending Headquarters Control position in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Execute Underhook Sweep from Half",
      "text": "From this position, execute Underhook Sweep from Half to transition to Standing Position. Success rate for advanced practitioners: 65%.",
      "position": 1
    },
    {
      "@type": "HowToStep",
    ...
    },
    {
      ...
      "text": "From this position, execute Re-Guard from Headquarters to transition to Butterfly Guard. Success rate for advanced practitioners: 75%.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Execute Old School Sweep",
      "text": "From this position, execute Old School Sweep to transition to Standing Position. Success rate for advanced practitioners: 60%.",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Execute Shin Shield Recovery",
      "text": "From this position, execute Shin Shield Recovery to transition to Open Guard. Success rate for advanced practitioners: 80%.",
      "position": 5
    },
    {
      "@type": "HowToStep",
      "name": "Execute Lockdown Sweeps",
      "text": "From this position, execute Lockdown Sweeps to transition to Lockdown. Success rate for advanced practitioners: 55%.",
      "position": 6
    }
  ],
  "totalTime": "PT2M"
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What happens if you allowing frames to become passive or collapsed under pressure?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Opponent easily flattens you and completes pass with minimal resistance The correct approach is: Constantly pump and reset frames actively, treating them as dynamic tools not static barriers—if one frame weakens, immediately establish alternative frame"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you keeping shoulders flat on mat instead of maintaining active elevated posture?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Loss of hip mobility and ability to create angles, making all escapes and sweeps significantly harder The correct approach is: Keep shoulders elevated with active core engagement, maintaining ability to shift weight and adjust frames throughout the position"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you fighting opponent's pressure head-on with strength rather than using angles?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Exhaustion without progress as you try to bench press heavier opponent's weight The correct approach is: Create angles with hip movement, redirect pressure rather than opposing it directly, time movements when opponent commits weight"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you failing to maintain inside leg connection allowing leg weave or complete pass?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Opponent easily steps over and clears both legs, completing pass unopposed The correct approach is: Always maintain inside leg hook or frame preventing opponent from establishing both-leg control, treating inside leg as critical anchor"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you holding frames rigidly in same position without adjusting to opponent's movements?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Opponent finds timing to collapse or bypass static frames, as they're predictable The correct approach is: Constantly adjust frame positions based on opponent's pressure direction—frames must be dynamic and responsive, not frozen"
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Headquarters Control Bottom",
  "description": "Master defensive headquarters position in BJJ. Strategic frame-based guard retention with 60% retention rate. Learn sweep timing, re-guards, and pressure management from bottom.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Graph",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "Headquarters Control Bottom",
      "item": "https://bjjgraph.org/Positions/Headquarters-Control-Bottom"
    }
  ]
}
</script>
...
#bjj #position #headquarters #bottom #half-guard #defensive #guard-retention #frame-management 
...
- **[[Hip Escape]]** → [[Open Guard]]
  - Opponent commits weight forward attempting to flatten you
- **[[Deep Half Entry]]** → [[Deep Half Guard]]
  - Opponent secures underhook and attempts to drive through with heavy pressure
...
- **[[Half Guard]]** - Related position—similar structural concepts
- **[[Knee Shield Half Guard]]** - Related position—common transition target
- **[[Deep Half Guard]]** - Common transition target from bottom headquarters
- **[[Underhook Control]]** - Frequent micro-position within headquarters bottom
- **[[Combat Base]]** - Opponent's common base structure when passing
- **[[Guard Retention Concepts]]** - Core defensive principle applied in this position
- **[[Frame Management]]** - Essential concept for maintaining this position
- **[[Hip Escape Mechanics]]** - Critical movement pattern for escapes and re-guards
- **[[Butterfly Guard]]** - Common re-guard target when creating distance
- **[[Open Guard]]** - Alternative guard recovery option
