...
---
title: "Headquarters Control Top | BJJ Position Guide | BJJ Graph"
description: "Master offensive headquarters position in BJJ. Dominant half guard passing with systematic pressure and multiple passing pathways. 70% advancement success rate for advanced practitioners."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Attack from Headquarters Control Top",
  "description": "Step-by-step guide to attacking and submitting from Headquarters Control position in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
    ...
    },
    {
      ...
      "text": "From this position, execute Headquarters Pass to transition to Side Control. Success rate for advanced practitioners: 70%.",
      "position": 2
    },
    {
      "@type": "HowToStep",
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What happens if you sitting back on heels instead of maintaining forward hip pressure and chest-to-chest contact?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Creates space for opponent to recover guard, insert knee shield, or attempt sweeps without pressure constraint The correct approach is: Keep hips low and forward with chest pressure constant, driving weight through opponent's upper body while maintaining heavy shoulder contact"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you losing crossface or underhook control while attempting to pass, allowing opponent to turn in and create angles?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Opponent regains offensive capability, can establish underhook or recover full guard, negating passing progress The correct approach is: Maintain dominant upper body control throughout passing sequence, never sacrificing crossface or underhook until pass is completed"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you positioning trapped leg too close to opponent, allowing easy sweep or off-balancing attempts?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Vulnerable to basic half guard sweeps, old school sweeps, or lockdown-based attacks that exploit poor leg position The correct approach is: Keep trapped leg positioned defensively with foot away from opponent's hip, maintaining strong base and pressure distribution"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you forcing the same passing sequence repeatedly without reading opponent's reactions and adjusting strategy?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Opponent anticipates and counters the single-dimension attack, leading to stalled position or reversal The correct approach is: Use systematic approach with multiple passing options, flowing between techniques based on opponent's defensive reactions"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you rising too high during passing attempt, elevating center of gravity and reducing pressure effectiveness?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Loss of control and pressure allows opponent to create space, recover guard, or execute sweeps The correct approach is: Maintain low base throughout passing sequences, generating pressure through proper hip positioning rather than height"
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "Headquarters Control Top",
      "item": "https://bjjgraph.org/Positions/Headquarters-Control-Top"
    }
  ]
}
</script>
...
- **[[Electric Chair Submission]]** → [[Electric Chair]] (Opponent Success: 15%)
...
- **[[Knee Cut Pass]]** → [[Side Control]]
  - Opponent extends leg or loses knee shield connection
- **[[Back Take Generic]]** → [[Back Control]]
  - Opponent turns to their side exposing back
- **[[Kimura from Half Guard]]** → [[Kimura Control]]
  - Opponent reaches for underhook or extends arm
- **[[Darce Choke]]** → [[D'arce Control]]
  - Opponent drives into underhook creating space for arm insertion
...
- **[[Half Guard]]** - Opposing position—bottom player's perspective of same engagement
- **[[Knee Shield Half Guard]]** - Common defensive structure opponent uses against headquarters control
- **[[Lockdown]]** - Alternative bottom player strategy from half guard requiring different control approach
- **[[Deep Half Guard]]** - Position opponent may transition to when escaping headquarters pressure
- **[[Z-Guard]]** - Variation of half guard bottom player may use with knee shield emphasis
- **[[Side Control]]** - Primary passing destination from headquarters control
- **[[Leg Drag Control]]** - Alternative passing position accessible from headquarters
- **[[Pressure Pass]]** - Technical concept—passing methodology fundamental to headquarters effectiveness
- **[[Half Guard Pass]]** - Transition technique—generic passing approach from headquarters position
- **[[Kimura from Half Guard]]** - Submission threat—primary submission opportunity from headquarters control
- **[[Darce Choke]]** - Submission threat—opportunistic submission when opponent turns in
- **[[Underhook Control]]** - Critical grip battle determining control hierarchy
