...
- [[Head Pop Escape]] → [[Neutral Standing]] (Success Rate: 30%)
- [[Granby Roll]] → [[Guard Recovery]] (Success Rate: 25%)
- [[Arm Drag Counter]] → [[Back Control]] (Success Rate: 20%)
- [[Limp Arm and Base]] → [[Single Leg Entry]] (Success Rate: 15%)
- [[Sprawl Counter]] → [[Turtle Position]] (Success Rate: 10%)
...
- [[Transition to North-South]] → [[North-South]] (Success Rate: Beginner 20%, Intermediate 35%, Advanced 50%)
- [[Japanese Necktie]] → [[Side Control]] (Success Rate: Beginner 25%, Intermediate 40%, Advanced 55%)
- [[Arm-in Guillotine]] → [[Mount]] (Success Rate: Beginner 30%, Intermediate 45%, Advanced 60%)
...
- Or Execute [[Snap Down]] → [[Turtle Top]] (Probability: 55%)

Else if opponent attempts to stand:
- Execute [[Go Behind]] → [[Back Control]] (Probability: 50%)
- Or Execute [[Snap Down]] → [[Turtle Top]] (Probability: 55%)

Else if opponent turns away:
- Execute [[Switch to Back Control]] → [[Back Control]] (Probability: 60%)
