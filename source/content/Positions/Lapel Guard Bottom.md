...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Use Lapel Guard Bottom in BJJ",
  "description": "Complete guide to executing techniques and transitions from Lapel Guard Bottom.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Execute Lapel Drag Sweep",
      "text": "From Lapel Guard Bottom, execute Lapel Drag Sweep to advance your position.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Execute Side Control Top",
      "text": "From Lapel Guard Bottom, execute Side Control Top to advance your position.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Execute Lapel Wrap Sweep",
      "text": "From Lapel Guard Bottom, execute Lapel Wrap Sweep to advance your position.",
      "position": 3
    }
  ],
  "tool": [
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is a key principle of Lapel Guard Bottom?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "**Lapel Extraction and Control**: Learn to efficiently extract opponent's lapel and establish initial control without exposing yourself to passes"
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  ...
  "description": "Master Lapel Guard Bottom in BJJ. Fundamental gi-based guard using opponent's lapel for control and attacks. Success rates: Beginner 30%, Intermediate 48%, Advanced 65%.",
  "url": "https://bjjgraph.org/Positions/Lapel-Guard-Bottom",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Graph",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "Lapel Guard Bottom",
      "item": "https://bjjgraph.org/Positions/Lapel-Guard-Bottom"
    }
  ]
}
</script>
