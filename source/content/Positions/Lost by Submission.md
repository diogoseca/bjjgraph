...
---
title: "Lost by Submission | BJJ Position Guide | BJJ Graph"
description: "Terminal state in BJJ representing match loss via submission. Analysis of common finishing positions, defensive failures, and tap-out mechanics across all submission categories."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Use Lost by Submission",
  "description": "Complete guide to lost by submission in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Execute Match Reset After Tap",
      "text": "From this position, execute Match Reset After Tap to transition to Standing Position. Success rate for advanced practitioners: 100%.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Execute New Match Start",
      "text": "From this position, execute New Match Start to transition to Guard Opening Sequence. Success rate for advanced practitioners: 100%.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Execute Training Reset",
      "text": "From this position, execute Training Reset to transition to Closed Guard. Success rate for advanced practitioners: 100%.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Execute Positional Restart",
      "text": "From this position, execute Positional Restart to transition to Side Control. Success rate for advanced practitioners: 100%.",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Execute Standing Restart",
      "text": "From this position, execute Standing Restart to transition to Clinch. Success rate for advanced practitioners: 100%.",
      "position": 5
    },
    {
      "@type": "HowToStep",
      "name": "Execute Guard Position Reset",
      "text": "From this position, execute Guard Position Reset to transition to Open Guard. Success rate for advanced practitioners: 100%.",
      "position": 6
    }
  ],
  "totalTime": "PT2M"
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What happens if you refusing to tap due to ego or competitive pressure?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Serious injury including torn ligaments, broken bones, or unconsciousness The correct approach is: Tap immediately when submission is locked and no technical escape exists"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you waiting too long to tap on joint locks?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Joint damage requiring weeks or months of recovery time The correct approach is: Tap as soon as hyperextension begins, not when pain becomes unbearable"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you attempting explosive escape from locked submission?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Accelerated injury as force works against the joint or neck The correct approach is: Recognize point of no return and tap rather than fight locked position"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you not tapping clearly enough for opponent to recognize?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Opponent continues applying pressure causing injury The correct approach is: Use multiple loud taps on opponent's body or mat, or clear verbal 'TAP' call"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you ignoring warning signs of blood choke (tunnel vision, graying vision)?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Loss of consciousness leading to potential injury from fall or continued pressure The correct approach is: Tap immediately when visual symptoms appear, typically 3-5 seconds before unconsciousness"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you attempting to defend submission after positional control is lost?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Wasted energy and increased injury risk as submission gets tighter The correct approach is: Focus on positional escape before submission enters attacking range"
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "Lost by Submission",
      "item": "https://bjjgraph.org/Positions/Lost-by-Submission"
    }
  ]
}
</script>
...
- **[[Preventive Tap]]** → [[Guard Opening Sequence]]
  - Submission locked with no escape available
- **[[Verbal Submission]]** → [[Guard Opening Sequence]]
  - Loss of consciousness imminent from strangle
...
- **[[Won by Submission]]** - Opposite terminal state representing successful submission attack
- **[[Back Control]]** - Highest percentage position leading to submission finish
- **[[Mount]]** - Dominant position with multiple submission pathways
- **[[Triangle Control]]** - Common submission control position from guard
- **[[Armbar Control]]** - High-percentage joint lock control position
- **[[Inside Ashi-Garami]]** - Modern leg entanglement with heel hook threat
- **[[Rear Naked Choke]]** - Most common match-ending submission from back control
- **[[Submission Defense]]** - Conceptual framework for preventing this terminal state
- **[[Tap Out]]** - Physical transition technique to reach this state safely
- **[[Escape Hierarchy]]** - Systematic approach to avoiding submission situations
