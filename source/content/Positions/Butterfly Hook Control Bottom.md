...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Use Butterfly Hook Control Bottom in BJJ",
  "description": "Complete guide to executing techniques and transitions from Butterfly Hook Control Bottom.",
  "step": [
    {
      "@type": "HowToStep",
...
<script type="application/ld+json">
{
  ...
  "description": "Master Butterfly Hook Control Bottom in BJJ. Complete guide covering butterfly hooks and sweeps. Success rates vary by skill level.",
  "url": "https://bjjgraph.org/Positions/Butterfly-Hook-Control-Bottom",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Graph",
