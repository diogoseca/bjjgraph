...
---
title: "Underhook Control Bottom | BJJ Position Guide | BJJ Graph"
description: "Master bottom underhook control in BJJ. Complete guide to defensive escapes, offensive sweeps, and back takes from bottom underhook position with competition-proven techniques."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Escape Underhook Control Bottom",
  "description": "Step-by-step guide to escaping and defending Underhook Control position in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
    ...
    },
    {
      ...
      "text": "From this position, execute Underhook Sweep to transition to Side Control. Success rate for advanced practitioners: 70%.",
      "position": 2
    },
    {
      "@type": "HowToStep",
    ...
    },
    {
      ...
      "text": "From this position, execute Half Guard to Back Take to transition to Back Control. Success rate for advanced practitioners: 60%.",
      "position": 4
    },
    {
      "@type": "HowToStep",
    ...
    },
    {
      ...
      "text": "From this position, execute Butterfly Guard to X-Guard to transition to X-Guard. Success rate for advanced practitioners: 65%.",
      "position": 6
    }
  ],
  "totalTime": "PT2M"
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What happens if you maintaining shallow underhook that only reaches opponent's bicep or elbow area?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Opponent easily establishes crossface control and drives shoulder pressure into your face, flattening you to the mat and nullifying offensive opportunities The correct approach is: Drive your underhook deeply past opponent's armpit with hand reaching their far shoulder blade. Use hip movement to maintain depth and prevent opponent from extracting their arm backward"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you keeping inside hip flat on the mat while holding underhook?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Opponent flattens you completely, eliminating hip mobility necessary for sweeps or guard recovery. Static position allows opponent to consolidate control and advance The correct approach is: Use underhook frame to elevate inside hip off the mat. Maintain dynamic hip positioning with ability to shrimp, turn, or drive forward. Never allow both hips flat simultaneously"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you neglecting non-underhook hand, allowing it to hang passively?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Opponent establishes crossface control with their far arm, driving your head away and creating angle for pass. Crossface nullifies underhook advantages completely The correct approach is: Non-underhook hand must actively frame against opponent's hip, knee, or far arm. This secondary frame prevents crossface and completes defensive structure"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you holding static underhook without attempting sweeps or positional improvements?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Opponent adapts to your static position, establishes counter-grips, and neutralizes your offensive potential. Referees may penalize for stalling in competition The correct approach is: Treat underhook as launching point for immediate action. Continuously attempt sweeps, back takes, or guard recovery rather than holding position statically"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you pulling down on underhook instead of driving upward and forward?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Pulling down collapses your own structure and brings opponent's weight onto you. Creates crushing pressure that prevents hip movement and offensive options The correct approach is: Drive underhook upward toward ceiling while driving your body forward and into opponent. This lifting action off-balances opponent and creates sweep opportunities"
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "Underhook Control Bottom",
      "item": "https://bjjgraph.org/Positions/Underhook-Control-Bottom"
    }
  ]
}
</script>
...
## What is Underhook Control from the Bottom?
...
- **[[Knee Cut Pass]]** → [[Side Control]] (Opponent Success: 50%)
- **[[Whizzer]]** → [[Overhook Control]] (Opponent Success: 45%)
- **[[Kimura to Back Take]]** → [[Back Control]] (Opponent Success: 40%)
...
- **[[Rolling Back Take]]** → [[Back Control]]
  - When opponent drives forward excessively, creating momentum for roll-under
- **[[Arm Drag to Back]]** → [[Back Control]]
  - When opponent posts their far hand forward to base, exposing their back
- **[[Technical Standup]]** → [[Standing Position]]
  - When opponent maintains distance and avoids engaging with underhook frame
...
- **[[Half Guard]]** - Primary bottom position where underhook control provides sweep and back take opportunities
- **[[Deep Half Guard]]** - Advanced underhook position accessed by rolling under from standard underhook control
- **[[Dogfight Position]]** - Scramble position where both players compete for dominant underhook positioning
- **[[Butterfly Guard]]** - Open guard system that integrates underhook control for sweep mechanics
- **[[Old School Sweep]]** - Classic sweep directly enabled by deep bottom underhook control
- **[[Rolling Back Take]]** - Back exposure technique using underhook as primary control and leverage point
- **[[Quarter Guard]]** - Transitional guard position where underhook control prevents pass completion
