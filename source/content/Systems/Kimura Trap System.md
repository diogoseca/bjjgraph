...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 3, "name": "Kimura Trap System", "item": "https://bjjgraph.org/Systems/Kimura-Trap-System"}
  ]
}
</script>
...
- [[Kimura Control]] (Position) - Primary control position from which the entire system operates
- [[Kimura Trap]] (Position) - Specific positional variation emphasizing the trap mechanics
...
- [[Kimura from Side Control]] (Submission) - Most common entry point for the system from top position
- [[Kimura from Half Guard]] (Submission) - Alternative entry from bottom position with sweep integration
- [[Kimura from Turtle]] (Submission) - High-percentage entry when opponent turtles defensively
