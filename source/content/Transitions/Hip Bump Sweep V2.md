...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "What should you do if the opponent posts their right arm wide to defend the hip bump sweep?",
      "acceptedAnswer": {
        "@type": "Answer",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 3, "name": "Hip Bump Sweep V2", "item": "https://bjjgraph.org/Transitions/Hip-Bump-Sweep-V2"}
  ]
}
</script>
...
#bjj #transition #sweep #closed guard #fundamental #beginner friendly #mount attack 

> **Quick Answer**: Hip Bump Sweep V2 transitions from [[Closed Guard]] to [[Mount]]. Success rates: Beginner 30%, Intermediate 50%, Advanced 70%.
...
- **Error**: Attempting sweep without fully breaking opponent's posture
...
- **Error**: Posting hand placed too close to hip or at wrong angle
...
- **Error**: Releasing guard too early before establishing angle
...
- **Error**: Bumping straight up instead of at an angle
...
- **Error**: Losing control of opponent's arm during execution
...
- **Error**: Insufficient hip elevation during the bump
...
- **Error**: Forgetting to drive head into opponent's shoulder
...
**Q3**: What should you do if the opponent posts their right arm wide to defend the hip bump sweep?
...
- [[Posture Breaking]] - Essential prerequisite concept - must be mastered before effective hip bump execution
- [[Sweep Mechanics]] - Conceptual foundation explaining the biomechanical principles behind the technique
...
- [[Guard Recovery]] - Relevant concept when sweep is partially defended and guard must be re-established
