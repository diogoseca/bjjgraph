...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for Side Control to Mount from Side Control/Top. Possible outcomes: Mount/Top (75%), Side Control/Top (15%), Side Control/Bottom (10%).",
  "step": [
    {
      "@type": "HowToStep",
...
- [[Mount Control]] - Follow-up - maintaining the achieved position
- [[Side Control to Mount]] - Alternative transition approach with different mechanics
...
- [[Upa Escape]] - Defensive technique opponent employs against mount transition
