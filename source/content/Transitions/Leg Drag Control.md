---
title: "Leg Drag Control | BJJ Technique | BJJ Graph"
description: "Master Leg Drag Control in BJJ. Step-by-step execution to dominant position. Success: Beginner 30%, Intermediate 50%, Advanced 70%."
transition_id: "T152"
transition_name: "Leg Drag Control"
alternative_names: ["Leg Drag", "Leg Weave Control"]
...
schema_tools:
  ...
  - "Training partner"
  - "Mat space"
tags: ["bjj", "transition", "guard_pass", "leg_drag", "advanced", "dynamic"]
related_positions: ["Open Guard Top", "Side Control Top", "Leg Drag Position"]
...
1. **Setup Requirements**: Establish open guard top with grips on leg or pants
2. **Initial Movement**: Grip one leg and begin to move it across opponent's centerline
3. **Opponent Response**: Opponent tries to maintain guard structure or turn to face you
4. **Adaptation**: Drive leg aggressively across while moving your body to the side angle
5. **Completion**: Secure dragged leg position, establish upper body control
6. **Consolidation**: Choose between back take or side control based on opponent's reaction
