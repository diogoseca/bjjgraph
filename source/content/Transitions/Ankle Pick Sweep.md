...
- **Error**: Attacking the ankle before establishing upper body control
...
- **Error**: Pulling straight back instead of at a diagonal angle
...
- **Error**: Gripping the ankle too high on the shin or calf
...
- **Error**: Not following through with the sweep motion
...
- **Error**: Remaining seated instead of coming up on top immediately
...
- **Error**: Using only arm strength without engaging core and back muscles
...
- **Error**: Telegraphing the sweep by reaching for the ankle too early
...
- [[Single Leg X Sweep]] - Alternative - targets same leg but with different control scheme
