...
- **Error**: Pulling head straight back instead of maintaining posture and circling
...
- **Error**: Allowing trapped arm to extend away from body
...
- **Error**: Dropping posture and letting opponent break you down forward
...
- **Error**: Neglecting to establish base with free arm
...
- **Error**: Panicking and using explosive, uncontrolled movements
...
- **Error**: Trying to stack without maintaining posture first
...
- [[Guard Recovery]] - Common ending position after successful escape
- [[Closed Guard]] - Primary position where triangle threats originate
- [[Triangle Choke]] - Submission being escaped - understanding offense improves defense
- [[Hip Escape]] - Alternative escape using similar movement principles
- [[Posture Recovery]] - Fundamental skill required throughout triangle escape
- [[Armbar from Guard]] - Common counter when opponent defends triangle poorly
- [[Omoplata from Guard]] - Alternative attack when defender circles predictably
- [[Stack Pass]] - Passing strategy that uses similar stacking mechanics
- [[Guard Replacement]] - Follow-up technique after escaping to recover defensive position
- [[Frame and Shrimp]] - Complementary escape mechanics using similar principles
- [[Standing up in Base]] - Alternative defensive strategy against guard attacks
