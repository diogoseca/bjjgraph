...
transition_id: "T320"
transition_name: "Guillotine Counter"
alternative_names: ["Guillotine Escape", "Guillotine Defense", "Headlock Counter"]
starting_state: "Guillotine Control Defense"
...
schema_tools:
  ...
  - "Training partner"
  - "Mat space"
tags: ["bjj", "transition", "counter", "defense", "submission-defense", "guillotine"]
related_positions: ["Turtle Position", "Half Guard Top", "Side Control", "Standing Position"]
...
- **[[Sit Back and Squeeze]]** → [[Tighter Guillotine]] (Success Rate: 55%, Conditions: when defender hasn't established forward pressure)
- **[[Sweep Attempt]]** → [[Guard Position]] (Success Rate: 45%, Conditions: when defender's base is narrow or weight is too forward)
- **[[Transition to Different Submission]]** → [[Alternative Attack]] (Success Rate: 40%, Conditions: when defender focuses solely on guillotine defense)
- **[[Close Guard]]** → [[Guard with Guillotine]] (Success Rate: 50%, Conditions: before defender establishes strong base)
...
- [[Guillotine Danger]] → [[Guillotine Counter]] → [[Side Control Top]]
- [[Guillotine Danger]] → [[Guillotine Counter]] → [[Half Guard Top]]
- [[Standing Guillotine]] → [[Guillotine Counter]] → [[Turtle Position]]
- [[Guard with Guillotine]] → [[Guillotine Counter]] → [[Guard Pass]]

## Related Techniques

- [[Guillotine Choke]] - The submission this technique directly counters
- [[Front Headlock Defense]] - Related defensive framework
- [[Head Position Recovery]] - Broader principle applied in defense
- [[Von Flue Choke]] - Counter-attack opportunity during guillotine defense
