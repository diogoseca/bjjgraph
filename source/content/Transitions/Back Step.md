...
## Execution Steps
1. Establish control in a passing position (e.g., leg drag or headquarters) with hip and upper body connection.
2. Recognize opponent's defensive turn or rotation away from you as a trigger for the back step.
3. Lift your back leg (typically the one furthest from their turning direction) and step it in a circular motion around their body.
4. Maintain upper body connection by keeping chest close and controlling their near arm to prevent framing.
5. Adjust your supporting leg to maintain balance and avoid overcommitting weight forward.
6. Pivot your hips to face their back, securing an underhook or other control point on the far side.
7. Complete the transition by inserting hooks for back control or establishing alternative dominant positions like crucifix.
8. Consolidate the new position with appropriate pressure and control to prevent escapes.
