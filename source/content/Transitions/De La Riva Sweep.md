...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 3, "name": "De La Riva Sweep", "item": "https://bjjgraph.org/Transitions/De-La-Riva-Sweep"}
  ]
}
</script>
...
- [[Waiter Sweep]] - Variation - overhead sweep using similar De La Riva structure
- [[Single Leg X-Guard]] - Related position - common transition when opponent steps back
- [[X-Guard]] - Related position - connected guard system with similar mechanics
- [[Omoplata from Guard]] - Alternative submission - attack when opponent posts to defend sweep
- [[Triangle from De La Riva]] - Submission option - complementary attack from same guard
