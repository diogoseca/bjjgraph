...
<script type="application/ld+json">
{
  ...
  "step": [
    ...
    {
      "@type": "HowToStep",
      "name": "Complete body positioning",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 3, "name": "Peruvian Necktie Setup", "item": "https://bjjgraph.org/Transitions/Peruvian-Necktie-Setup"}
  ]
}
</script>
...
## What is Peruvian Necktie Setup?
...
- **Error**: Attempting setup without secure overhook control
...
- **Error**: Threading leg too slowly or hesitantly
...
- **Error**: Releasing head pressure during transition
...
- **Error**: Failing to lock leg triangle tightly
...
- **Error**: Positioning too far from opponent's body when inverting
...
- **Error**: Incorrect shoulder placement for choking mechanism
...
- [[Front Headlock to Anaconda]] - Alternative finish - complementary technique from same starting position
- [[Front Headlock to Darce]] - Alternative finish - creates submission dilemma when chained together
- [[Peruvian Necktie]] - Finish - the submission completed after this setup
- [[Japanese Necktie Setup]] - Variation - related necktie-style setup with different entry angle
- [[Anaconda Choke]] - Complementary technique - creates threat sequence from front headlock
- [[Darce Choke]] - Complementary technique - alternative front headlock finish
- [[Front Headlock to Guillotine]] - Alternative finish - backup option if Peruvian Necktie entry fails
- [[Front Headlock to Back]] - Alternative transition - positional advancement option from same control
- [[Guillotine Setup]] - Related setup - shares similar control principles and timing windows
- [[Snap Down to Front Headlock]] - Entry technique - creates front headlock control for setup opportunity
