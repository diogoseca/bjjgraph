...
- [[Turtle to Guard]] - Alternative turtle escape method to guard
- [[Elbow Escape]] - Complementary escape using different mechanics for similar goals
- [[Bridge and Roll]] - Alternative rotation-based escape from bottom positions
- [[Re-Guard]] - Generic guard recovery category that Granby to Guard exemplifies
- [[Forward Roll]] - Related rolling movement using similar biomechanics
- [[Shrimp Escape]] - Complementary linear escape technique for guard recovery
- [[Guard Replacement]] - Alternative guard recovery method from compromised positions
- [[Frame and Shrimp]] - Alternative escape combining framing with linear movement
