...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 3, "name": "Knee Tap", "item": "https://bjjgraph.org/Transitions/Knee-Tap"}
  ]
}
</script>
...
- [[Double leg takedown]] - Follow-up - Chain when knee tap is defended with step back
- [[Snap Down]] - Setup - Creates ideal weight distribution for knee tap
- [[Collar Drag]] - Setup - Establishes angle and off-balance for entry
...
- [[High Crotch]] - Alternative - Different angle of attack from similar setup
