...
description: "Learn Knee Shield Retention in BJJ. Defensive technique maintaining guard integrity from Half Guard Bottom. Success: Beginner 60%, Intermediate 75%, Advanced 90%."
transition_id: "T212"
transition_name: "Knee Shield Retention"
alternative_names: []
...
schema_type: "HowTo"
total_time: "PT5M"
tags: ["bjj", "transition", "guard_retention", "half_guard", "defensive"]
---
...
<script type="application/ld+json">
{
  ...
  "description": "Learn how to execute Knee Shield Retention in Brazilian Jiu-Jitsu.",
  "step": [
    {
      "@type": "HowToStep",
...
From half guard bottom, you maintain a strong knee shield frame with your top leg, creating distance between you and your opponent. Your bottom leg controls their leg, while your hands establish grips on their collar and sleeve or lapel. As they attempt to pass, you adjust your knee shield angle and hip position to maintain the barrier. The frame prevents them from achieving chest-to-chest pressure while your grips control their posture and movement. Your hips remain mobile, ready to recover full guard or transition to other positions.

**One-Sentence Summary**: "From half guard bottom with knee shield frame, you maintain distance and control through frame adjustments and hip mobility, preventing the pass."
...
### Error 1: Allowing knee shield to collapse under pressure
...
### Error 2: Static hip positioning without mobility
...
### Error 3: Poor grip management on opponent's upper body
...
3. **Error Prevention**: "What is a critical mistake to avoid?"
   - A) Allowing knee shield to collapse under pressure
   - B) Taking your time
