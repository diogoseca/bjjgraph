...
- **Pass Adjustment** → [[Side Control]] (Success Rate: 30%, Conditions: opponent adjusts angle to complete pass)
- **Stack Persistence** → [[Top Position]] (Success Rate: 25%, Conditions: opponent maintains stack and forces legs over head)
- **Posture Recovery** → [[Open Guard Top]] (Success Rate: 20%, Conditions: opponent breaks posture control and stands back up)
- **Submission Attempt** → [[Can Opener]] (Success Rate: 15%, Conditions: opponent capitalizes on stacked position for submission)
- **Control Counter** → [[Knee Cut Position]] (Success Rate: 10%, Conditions: opponent uses your defensive movement for alternative pass)
...
- [[Stack Defense]] → [[Guard Recovery]] → [[Closed Guard Bottom]]
- [[Stack Defense]] → [[Neutral Position]] → [[Standing Position]]
- [[Stack Defense]] → [[Hip Escape]] → [[Guard Retention]]
