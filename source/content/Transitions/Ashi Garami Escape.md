...
4. **Clear the bottom leg**: Use your free leg to step over or push down on opponent's bottom leg (the leg that is under your trapped leg). This is critical as the bottom leg provides the foundation for their ashi garami control. Push or kick the bottom leg away while maintaining hip angle and frames to prevent opponent from recomposing. (Timing: Once sufficient space is created)
5. **Clear the top leg**: After removing the bottom leg threat, address the top leg by either pushing it down toward the mat or stepping over it with your free leg. Maintain constant pressure and control as you clear this second leg, ensuring opponent cannot re-establish the entanglement or triangle their legs around yours. (Timing: Immediately after clearing bottom leg)
6. **Extract trapped leg**: With both of opponent's legs cleared, pull your trapped leg straight back and away from opponent's control. Keep your knee pointing upward and foot flexed as you extract. Immediately establish distance by creating space between you and opponent, either coming to standing position or establishing a guard position. (Timing: Final extraction after both legs cleared)
7. **Secure safe position**: Once leg is extracted, immediately stand up or establish a defensive guard position. Do not remain in range where opponent can re-enter on the legs. Create distance using frames and footwork, then reassess and decide whether to re-engage or maintain distance. (Timing: Immediately post-extraction)
...
- **Error**: Straightening the trapped leg completely during escape attempt
...
- **Error**: Attempting to extract leg before clearing both of opponent's legs
...
- **Error**: Losing upper body frames and falling to back
...
- **Error**: Ignoring opponent's grip fighting and focusing only on leg position
...
- **Error**: Panicking and making explosive, jerking movements
...
- **Error**: Remaining in range after extraction instead of creating distance
...
- **Danaher System**: The ashi garami escape exemplifies a fundamental principle of defensive grappling: you must address control points in hierarchical order based on their structural significance. The bottom leg provides the foundation upon which all ashi garami control rests - it is the load-bearing element of the entanglement. Attempting to clear the top leg first is biomechanically inefficient because the bottom leg can still maintain the core structure of the position. This is analogous to trying to demolish a building by removing the roof before the supporting columns. Students must understand that defensive sequences are not arbitrary - they follow mechanical logic. The systematic nature of this escape teaches broader lessons about how to approach all entanglement defenses: identify the structural foundation, remove it methodically, then address secondary controls. The grip fighting component cannot be overstated. Grips represent the transmission of force from the opponent's body to yours. Superior grip configuration allows inferior positions to maintain control, while broken grips render even structurally sound positions vulnerable. In ashi garami escapes, the battle over heel control is paramount. The heel provides the fulcrum for rotational attacks and must be protected through grip fighting and positional awareness. This escape rewards patience and systematic execution over athleticism and explosiveness.
- **Gordon Ryan**: In high-level competition, the ashi garami escape is a race against time and opponent advancement. You need to recognize immediately whether your opponent is a leg lock specialist or an opportunistic attacker, because this determines how much time you have to work the escape. Against elite leg lockers like Craig Jones or Garry Tonon, you have maybe two to three seconds before they advance to saddle or secure a dangerous heel hook grip. This means your escape must be rehearsed to the point of instinct - you cannot afford to think through steps. My approach emphasizes aggressive grip fighting from the first moment of entanglement. I use both hands to break heel control immediately, even if it means temporarily sacrificing some defensive framing. Without heel control, most opponents cannot finish efficiently, buying me the time to execute the systematic clearing sequence. I also focus on hip positioning to make saddle entries difficult. By keeping my hips turned away and maintaining frames, I force opponents to work harder for advancements, creating windows for escape. In competition, I've found that the standing extraction variation works extremely well against opponents who commit heavily to the bottom leg position. If I can establish vertical base, I can use my bodyweight to collapse their structure and extract quickly. The key competitive insight is this: defensive success in leg entanglements comes from making the position uncomfortable and unprofitable for your opponent, forcing them to abandon it rather than waiting to perfectly execute every step of the escape.
- **Eddie Bravo**: The traditional ashi garami escape works, but in 10th Planet system we also explore some unconventional options that keep opponents guessing. One technique we use is the inverted approach - instead of always trying to extract backward, sometimes we commit forward over the trapped leg with a rolling motion. This completely changes the angle and can break stubborn grips through momentum rather than pure strength. It's not the highest percentage move, but it's a valid tool when conventional escapes are being shut down. The other thing we emphasize is staying dangerous even while defending. From ashi garami, before fully escaping, we look for heel hook entries on the opponent's exposed leg. This creates a dilemma for them - finish their attack quickly or defend their own leg. That split-second hesitation can be the window you need to complete the escape. We also integrate the escape into our overall leg entanglement game. Students learn that ashi garami escape and ashi garami entry use similar movements in reverse. Understanding the entry helps you defend it better. In training, we do specific sparring starting from ashi garami where both people can attack or escape. This live problem-solving develops the creativity and adaptability needed when perfect technical execution isn't available. The reality is leg entanglements are chaotic and dynamic - having multiple escape paths and the ability to improvise is just as important as knowing the fundamental technique.
