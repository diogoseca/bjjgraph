...
<script type="application/ld+json">
{
  ...
  "step": [
    {
      "@type": "HowToStep",
      "name": "Establish deep lasso control",
      "text": "Thread your leg deeply over opponent's arm, ensuring your shin is positioned across their tricep with your foot emerging behind their back. Pull their sleeve to deepen the lasso while keeping your knee tight to their shoulder.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Secure opposite leg control",
      "text": "Grip opponent's opposite pant leg at the knee or establish a butterfly hook. This control is critical for preventing them from posting and maintaining base during the sweep. Your free leg should be active and mobile.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Create angular pressure",
      "text": "Rotate your hips away from the lasso side while pulling the lasso arm across your body. This creates a diagonal line of force that compromises their base. Your shoulders should move toward the mat on the non-lasso side.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Extend lasso leg explosively",
      "text": "Drive your lasso leg straight while maintaining shin pressure on their arm. Simultaneously pull their sleeve toward your hip and use your opposite leg to lift or sweep their posting leg. The extension should be powerful and directed toward their weak corner.",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Drive through with hip pressure",
      "text": "As opponent begins to fall, release the lasso and drive your hips forward and upward. Use your grips to control their upper body while transitioning your legs to establish top position. Keep pressure constant to prevent recovery.",
      "position": 5
    },
    {
      "@type": "HowToStep",
      "name": "Establish dominant position",
      "text": "Follow through completely by coming up to mount, side control, or maintaining back exposure depending on how they fall. Immediately consolidate control with proper weight distribution and control points before they can recover guard.",
      "position": 6
    }
  ],
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 3, "name": "Lasso Guard Sweeps", "item": "https://bjjgraph.org/Transitions/Lasso-Guard-Sweeps"}
  ]
}
</script>
...
**Q2**: What is the proper shin placement for deep lasso control and why does depth matter?
**A**: The shin should be positioned across the opponent's tricep muscle with your foot threading behind their back. Depth matters because a shallow lasso on the forearm allows easy extraction through simple arm retraction, while a deep lasso on the tricep creates mechanical disadvantage where the opponent must lift their entire arm against the leverage of your extended leg. The deeper the lasso, the more control you have and the more energy they must expend to escape.

**Q3**: How should you create angular pressure to maximize sweep effectiveness?
**A**: Rotate your hips away from the lasso side while pulling the lasso arm across your body, creating a diagonal line of force that targets the opponent's weak corner (between their base points). This angular approach is superior to pulling straight toward yourself because it eliminates their ability to post on both knees simultaneously. The angle should be approximately 45 degrees from your centerline, directing force toward their far hip.

**Q4**: What is the appropriate response when an opponent successfully stacks your lasso guard?
**A**: When stacked, immediately transition to inverted lasso or rotate to omoplata position as the opponent commits their weight forward. Alternatively, create frames with your arms and use technical stand-up to re-establish distance and start over. Fighting the stack position directly while remaining on your back is ineffective because their weight advantage is maximized. The key is to use their forward pressure against them by transitioning to attacks that capitalize on their committed position.

**Q5**: How does lasso guard sweeping integrate into a comprehensive open guard system?
**A**: Lasso guard functions as a transitional position within the broader spider guard family and connects directly to De La Riva, X-guard, and triangle attacks. When opponents defend the lasso by creating distance, you transition to spider or De La Riva. When they pressure forward, you transition to triangle or omoplata. The lasso should never be viewed as an isolated position but rather as one tool in a connected system where each guard position flows into others based on opponent reactions. Elite players use lasso sweeps to set up submission attacks or to force opponents into positions where other guards become more effective.

**Q6**: What timing indicators signal the optimal moment to execute a lasso sweep?
...
- [[Spider Guard Sweeps]] - Related guard sweeping system
- [[De La Riva Sweep]] - Alternative sweep from connected guard
- [[Omoplata Sweep]] - Submission-based sweep combination
- [[Triangle Setup]] - Attack option from lasso control
- [[Inverted Guard]] - Advanced variation transition
- [[X-Guard]] - Follow-up position when sweep is defended
- [[Collar Sleeve Guard]] - Entry position to establish lasso
- [[Open Guard]] - Parent category system
- [[Reverse De La Riva Guard]] - Alternative when lasso is countered
- [[Triangle from Spider Guard]] - Submission chain from similar control
