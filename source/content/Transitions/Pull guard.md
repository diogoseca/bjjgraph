...
## Execution Steps
1. Begin in a Standing Position, recognizing the opportunity to pull guard when you prefer to fight from the bottom or need to neutralize an opponent's takedown attempt.
2. Establish control by securing a grip on their sleeve or wrist with one hand, and reaching for their collar or neck with the other hand to control their posture, stepping back slightly to create an angle.
3. Lower your center of gravity by bending your knees, keeping your back straight, as you pull them towards you with both grips, stepping your other foot back to further off-balance them.
4. Sit down to the mat with control, pulling them down with you using your grips, while wrapping your legs around their torso to aim for Closed Guard, or preparing for Open Guard if needed.
5. Maintain your grips to control their upper body during the transition, keeping your elbows tucked to prevent them from standing back up easily, as you adjust your hips to center yourself under them.
6. Position your legs to either lock in Closed Guard by securing your ankles behind their back, or frame for Open Guard with feet on their hips or knees to create distance, preventing an immediate pass.
7. Settle into your chosen guard position, tightening your Closed Guard with legs locked and pulling their posture down, or establishing an active Open Guard to control space and initiate attacks.
8. Remain aware of their attempts to resist the pull or initiate a takedown during the transition, adjusting your grip strength, hip positioning, and leg placement to counter and secure the guard position.
...
- **Why It Fails**: Allows opponent to break free or maintain posture, preventing pull
- **Correction**: Secure sleeve/wrist and collar/neck grips to control upper body
- **Recognition**: Opponent easily resists pull or stands back up

- **Error**: Uncontrolled descent to mat
- **Why It Fails**: Risks hard impact or loss of balance, exposing you to passes
- **Correction**: Sit down with control, keeping back straight and grips tight
- **Recognition**: Feeling off-balance or opponent immediately passing guard

- **Error**: Delayed leg positioning after pull
- **Why It Fails**: Allows opponent to posture up or initiate pass before guard is set
- **Correction**: Wrap legs for Closed Guard or frame for Open Guard during descent
- **Recognition**: Opponent stands or passes before guard is established
