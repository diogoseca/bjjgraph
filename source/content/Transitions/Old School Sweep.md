...
<script type="application/ld+json">
{
  ...
  "step": [
    ...
    },
    {
      ...
      "text": "As opponent begins to tip, use your inside leg (the lockdown leg) to control their trapped leg, preventing them from posting it out for base. You can hook their ankle or simply use your legs to keep their leg trapped and immobilized between your thighs.",
      "position": 5
    },
    {
      "@type": "HowToStep",
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the old school sweep integrate with the electric chair submission in the 10th Planet system?",
      "acceptedAnswer": {
        "@type": "Answer",
...
5. **Control near leg**: As opponent begins to tip, use your inside leg (the lockdown leg) to control their trapped leg, preventing them from posting it out for base. You can hook their ankle or simply use your legs to keep their leg trapped and immobilized between your thighs. (Timing: As opponent starts to fall backward)
...
**Q6**: How does the old school sweep integrate with the electric chair submission in the 10th Planet system?
...
- [[Half Guard Sweeps]] - Category system - old school is fundamental sweep within half guard game
- [[Lockdown Sweeps]] - System integration - old school combined with lockdown creates powerful sweeping system
- [[Underhook Control]] - Control principle - underhook is primary control mechanism for sweep
