...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for 50-50 Pass from 50-50 Guard to Side Control.",
  "step": [
    {
      "@type": "HowToStep",
...
# 50-50 Pass
#bjj #technique #pass #leg-locks #50-50 #guard-passing #leg-entanglement #no-gi #leg-defense 

> **Quick Answer**: 50-50 Pass transitions from [[50-50 Guard]] to [[Side Control]]. Success rates: Beginner 35%, Intermediate 50%, Advanced 65%.
...
- **Error**: Attempting to pass without protecting exposed heel first
...
- **Error**: Pulling legs straight back without creating hip space first
...
- **Error**: Losing upper body control while extracting legs
...
- **Error**: Rising up too high when extracting legs
...
- **Error**: Stopping after extracting bottom leg without immediately stepping over
...
- **Error**: Stepping over to wrong side without following your crossface
...
**Q6**: How does the 50-50 pass integrate into modern leg lock meta-game strategy?
...
**Q7**: When should you abandon the 50-50 pass and return to defensive positioning?
...
- [[Saddle Entry from Top]] - Counter - opponent may attempt this if you lose position during pass
...
- [[Craig Jones Leg Lock System]] - System Context - understanding opponent's attacking system from 50-50
- [[Lachlan Giles Leg Lock Defense Framework]] - Defensive System - broader context for 50-50 escape strategies
- [[Ashi Garami]] - Related Position - similar leg entanglement structure
- [[Saddle]] - Related Position - another dangerous leg entanglement to escape from
- [[X-Guard to Ashi Transition]] - Entry Path - common route into 50-50 position
