...
## Execution Steps
1. Begin in a Standing Position, recognizing the opportunity for a takedown when the opponent's stance is wide or during a scramble where their balance is vulnerable.
2. Establish control by securing a grip on their collar or neck with one hand to manage their posture, stepping forward with one foot to close the distance, and dropping your level by bending your knees to prepare for the shot.
3. Shoot in with your head on the outside of their targeted hip, wrapping both arms around one of their legs just below the knee, hugging it tightly with one arm and reinforcing with the other, while driving your shoulder into their midsection to disrupt balance.
4. Lift their targeted leg slightly off the ground by straightening your legs, pulling it to the side while keeping your head tight to their hip to control their upper body, driving forward with your legs to push them backward.
5. Maintain your grip on their leg during the transition, keeping it elevated to prevent them from regaining a stable stance, as you adjust your head position or circle to the side to further off-balance them, preventing guard pulls or submission counters.
6. Complete the takedown by tripping their supporting leg with your foot behind their heel or driving forward to force them to the mat, ensuring you land on top with control of their leg.
7. Settle into a Top Position, maintaining control of their leg to prevent recovery, or transition to Side Control if they turn to their side, securing a dominant ground position.
8. Remain aware of their defensive attempts like sprawling, pulling guard, or countering with submissions, adjusting your grip strength, head position, and driving pressure to counter and consolidate the takedown.
...
- **Error**: Poor level change or penetration
- **Why It Fails**: Prevents deep shot, allowing opponent to sprawl or resist easily
- **Correction**: Drop center of gravity significantly by bending knees before shooting in
- **Recognition**: Opponent remains balanced or sprawls effectively

- **Error**: Incorrect head positioning
- **Why It Fails**: Exposes neck to submissions like guillotines or reduces control
- **Correction**: Place head tight to hip, either outside or inside, for safety and leverage
- **Recognition**: Feeling vulnerable to chokes or lacking control during shot

- **Error**: Delayed finish after leg control
- **Why It Fails**: Allows opponent to regain balance or counter with guard pull
- **Correction**: Immediately lift leg and drive or trip to complete takedown
- **Recognition**: Opponent hops or pulls guard before takedown completion
