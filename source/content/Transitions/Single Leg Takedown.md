...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for Single Leg Takedown from Standing Position/Top. Possible outcomes: Side Control/Top (70%), Standing Position/Top (20%), Standing Position/Bottom (10%).",
  "step": [
    {
      "@type": "HowToStep",
...
- [[Single Leg Variations]] - Alternative approaches - different grips and angles for attacking single leg
- [[Single Leg to Back Take]] - Alternative finish - taking the back when traditional finishes are defended
- [[Double leg takedown]] - Alternative takedown - can switch to when opponent squares hips
- [[Ankle Pick]] - Related leg attack - lower-level single leg variation
- [[High Crotch]] - Similar technique - deeper penetration single leg variant
- [[Sprawl Defense]] - Primary counter - main defensive response opponents will use
