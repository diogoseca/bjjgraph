...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "Bodylock Pass",
  "description": "Learn how to execute Bodylock Pass in Brazilian Jiu-Jitsu.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Setup Requirements",
      "text": "Establish open guard top; secure bodylock grip around torso; establish strong posture",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Initial Movement",
      "text": "Lift opponent's hips slightly; drive forward pressure; begin walking laterally",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Opponent Response",
      "text": "Opponent attempts to keep hips heavy, create frames, or hook your legs",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Adaptation",
      "text": "Maintain tight bodylock; adjust lifting and pressure; continue lateral movement",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Completion",
      "text": "Clear opponent's legs completely; drive to side control; maintain bodylock initially",
      "position": 5
    },
    {
      "@type": "HowToStep",
      "name": "Consolidation",
      "text": "Release bodylock; establish standard side control grips; settle weight",
      "position": 6
    }
  ],
  "tool": [
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "Bodylock Pass",
      "item": "https://bjjgraph.org/Transitions/Bodylock-Pass"
    }
  ]
}
</script>
...
4. **Setup Requirements**: "What must be combined with the lift for effective passing?"
