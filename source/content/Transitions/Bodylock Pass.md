...
description: "Master the Bodylock Pass in BJJ. Powerful pressure passing technique from Half Guard to Side Control. Success rates: Beginner 45%, Intermediate 60%, Advanced 75%."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Execute Bodylock Pass in BJJ",
  "description": "Step-by-step guide for Bodylock Pass from Half Guard to Side Control.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Establish bodylock grip",
      "text": "From half guard top position, thread your arm under the opponent's far armpit and connect your hands behind their back in a tight bodylock configuration. Use a gable grip or S-grip depending on arm length and body proportions. Ensure the lock is high on their back, near the shoulder blades, to maximize control.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Apply shoulder pressure",
      "text": "Drive your shoulder into the opponent's sternum or upper chest, creating downward and forward pressure. Position your head on the far side of their body (opposite the trapped leg) to prevent them from turning into you. Your chest should be heavy on theirs, making it difficult for them to breathe or create space.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Lower your hips",
      "text": "Drop your hips toward the mat while maintaining the bodylock, creating a heavy, low base that makes it nearly impossible for the opponent to roll or sweep you. Your weight should be distributed through your chest and hips onto the opponent, not supported by your own base.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Clear the knee shield",
      "text": "If the opponent has a knee shield, use your free hand or hip pressure to push their knee down and away. Walk your hips slightly toward their legs to create the angle needed to pass over or around their defensive knee. Maintain constant bodylock pressure during this adjustment.",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Extract your trapped leg",
      "text": "Keeping the bodylock tight and pressure constant, begin to pull your trapped leg backward and upward, using small movements. You may need to slightly adjust your hip angle or step your free leg around to create space. Do not compromise upper body control while freeing your leg.",
      "position": 5
    },
    {
      "@type": "HowToStep",
      "name": "Secure side control",
      "text": "As your leg clears the opponent's half guard, immediately drive your knee across their belly and establish side control position. Keep the bodylock or transition to crossface and underhook control. Your chest should remain heavy on theirs throughout the transition.",
      "position": 6
    }
  ],
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 3, "name": "Bodylock Pass", "item": "https://bjjgraph.org/Transitions/Bodylock-Pass"}
  ]
}
</script>
...
**Week 3-4: Controlled Passing** - Full pass sequence with light resistance
Execute the complete passing sequence from bodylock establishment to side control while partner provides light defensive frames and minimal half guard retention. Focus on maintaining pressure throughout each step. Reset and repeat 10-15 times per training session.
(Resistance: Light)

**Week 5-8: Counter Defense** - Dealing with common defensive reactions
Partner actively attempts specific counters (underhook, frames, bridges) at designated points during the pass. Practice recognizing and countering each defensive action while maintaining control. Isolate one counter type per session initially, then combine multiple defenses.
(Resistance: Medium)

**Week 9-12: Dynamic Integration** - Combining bodylock pass with other half guard attacks
Integrate the bodylock pass into your broader half guard passing game. Practice transitioning from other passing attempts into the bodylock pass and vice versa. Partner provides full resistance to guard retention. Work on recognizing optimal timing for this specific pass.
(Resistance: Full)

**Week 13+: Competition Application** - Application under fatigue and pressure
Use the bodylock pass during competition-style positional sparring and full rolling. Focus on maintaining technical precision even when tired. Film sessions and analyze where control breaks down. Develop personal variations based on your body type and strengths.
(Resistance: Full)
...
**Single Leg Bodylock Pass**: Secure the bodylock while simultaneously controlling one of the opponent's legs (usually the outside leg) by trapping it between your legs or controlling it with your free hand. This prevents them from using that leg to create frames or space. (When to use: Against athletic opponents who use their legs actively to create defensive frames and space)
...
**Q2**: Why is head position on the far side of the opponent's body crucial for this passing technique?
...
**Q3**: What is the most effective response when your opponent secures a deep underhook during the bodylock pass?
**A**: The deep underhook is one of the most dangerous counters to the bodylock pass. Your immediate response should be to sprawl your hips backward and increase downward shoulder pressure to flatten them before they can build up to their side or knees. Consider transitioning to a crossface grip temporarily to control their head and shoulder, preventing them from using the underhook to come up. You may need to abandon the bodylock temporarily to address the underhook threat, then re-establish the bodylock once they are flattened.

**Q4**: How does the bodylock pass specifically neutralize the knee shield defense commonly used in half guard?
**A**: The bodylock pass neutralizes the knee shield by creating upper body control that makes the knee shield less effective. When you have a tight bodylock with heavy shoulder pressure, the opponent's knee shield loses much of its structural integrity because they cannot effectively extend their leg into your chest or create distance. The bodylock allows you to pressure through or around the knee shield while maintaining dominant control, and you can use your free hand or hip pressure to push the knee down while keeping the upper body locked down.

**Q5**: What is the correct timing and sequence for extracting your trapped leg during the bodylock pass?
**A**: Leg extraction should only be attempted after you have established complete upper body control with the bodylock and shoulder pressure, flattened the opponent so they cannot bridge or turn, and neutralized any frames or defensive structures they have created. The extraction itself should be progressive and patient, using small backward and upward movements rather than one explosive pull. You must maintain constant bodylock pressure during extraction and be ready to pause and consolidate control if the opponent creates any defensive reaction. Rushing the leg extraction before proper control is established is one of the most common errors that leads to failed passes.

**Q6**: Why is maintaining low, heavy hips essential throughout the bodylock pass sequence?
**A**: Low, heavy hips serve multiple critical functions in the bodylock pass. They create maximum downward pressure that makes it difficult for the opponent to breathe, move, or create space through bridging. Heavy hips prevent the opponent from getting underneath you to sweep or reverse position. A low hip position also makes it harder for them to recover guard by shrimping away, as your weight is distributed effectively to control their movement. Finally, keeping hips low maintains your base and balance, preventing you from being rolled or swept during the passing sequence.
...
- [[Over-Under Pass]] - Similar bodylock concept applied to different guard position
- [[Smash Pass]] - Pressure passing variation with similar principles
- [[Long Step Pass]] - Alternative when opponent defends bodylock effectively
- [[Arm Triangle]] - Common submission follow-up from side control after pass
- [[Darce Choke]] - Submission opportunity during passing sequence
- [[Kimura from Side Control]] - Follow-up submission after successful pass
- [[Deep Half Guard]] - Position opponent may attempt to escape into during pass
- [[Lockdown]] - Counter-position opponent uses to defend the pass
