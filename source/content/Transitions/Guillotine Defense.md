...
**Q3**: What is the correct direction to circle when defending a standard guillotine choke, and why?
**A**: You should circle toward the side of the choking arm (into the choke), not away from it. This seems counterintuitive, but circling toward the choking side while driving your shoulder forward creates angles where the guillotine's structure breaks down. Circling away actually tightens the choke by allowing opponent to use their non-choking arm more effectively and maintain better alignment. Forward pressure toward the choking side combined with circular motion exploits the mechanical weakness in the submission.
...
- [[Von Flue Choke]] - Counter-submission opportunity when opponent holds guillotine from inferior position
- [[Guillotine Counter]] - Alternative defensive approach focusing on positional counters
- [[High Elbow Guillotine]] - Variation requiring modified defensive approach
- [[Arm in Guillotine]] - Variation with different defensive requirements
- [[Sprawl Defense]] - Preventative defense to avoid guillotine setups during takedown attempts
- [[Posture Recovery]] - Essential skill for maintaining defensive structure against guillotines
- [[Frame and Shrimp]] - Foundational movement pattern used within guillotine defense
- [[Guard Recovery]] - Alternative defensive goal when top position recovery isn't viable
- [[Darce Choke]] - Related front headlock submission with similar defensive principles
- [[Anaconda Choke]] - Related front headlock submission with overlapping defensive concepts
