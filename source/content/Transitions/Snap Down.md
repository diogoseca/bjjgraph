...
description: "Learn Snap Down in BJJ. Takedown technique from Standing Neutral to Front Headlock. Success: Beginner 55%, Intermediate 75%, Advanced 90%."
transition_id: "T218"
transition_name: "Snap Down"
alternative_names: []
starting_state: "Standing Neutral"
ending_state: "Front Headlock"
...
schema_type: "HowTo"
total_time: "PT5M"
tags: ["bjj", "transition", "takedown", "wrestling", "snap_down"]
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "Snap Down",
  "description": "Learn how to execute Snap Down in Brazilian Jiu-Jitsu.",
  "step": [
    {
      "@type": "HowToStep",
    ...
    },
    {
      "@type": "HowToStep",
      "name": "Completion",
      "text": "Execute final movements to achieve the ending position, transitioning to [[Front Headlock]]",
      "position": 5
    },
    {
      "@type": "HowToStep",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "Snap Down",
      "item": "https://bjjgraph.org/Transitions/Snap-Down"
    }
  ]
}
</script>
