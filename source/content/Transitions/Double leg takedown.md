...
description: "Master the Double Leg Takedown in BJJ. Complete execution from standing to side control with setup, timing, and counters. Beginner 30%, Intermediate 50%, Advanced 70%."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Execute Double leg takedown in BJJ",
  "description": "Step-by-step guide for Double leg takedown from Standing Position to Side Control.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Setup and distance management",
    ...
    {
      "@type": "HowToStep",
      "name": "Level change and penetration step",
      "text": "Drop your level explosively by bending at the hips and knees, not by bending forward at the waist. Simultaneously take a deep penetration step with your lead leg, placing your foot between your opponent's feet or slightly behind their front foot. Your hips should drive forward and down, getting closer to your opponent than their hips are to you. Keep your head up and spine straight to maintain power.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Hand connection and head placement",
      "text": "As you penetrate, drive both arms around the outside of your opponent's legs. Your hands should connect behind their knees or even behind their calves—the deeper the better. Your head should be placed firmly against their hip or lower abdomen on one side (never in the center where it's vulnerable to guillotine). Your shoulder should make contact with their midsection.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Lift and drive",
      "text": "Squeeze your hands together tightly behind their knees, pulling their legs toward you while driving your shoulder into their center of mass. Simultaneously drive your hips forward and upward, lifting with your legs (not your back). Your head pressure and shoulder drive should push them backward while your hands prevent them from stepping back to regain base. Keep your elbows tight to your body.",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Run the pipe and finish",
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the most important factor for achieving deep hand positioning on a double leg takedown?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The penetration step is the most important factor. Your lead foot must step deep between or past your opponent's feet, getting your hips closer to them than theirs are to you. This deep penetration naturally allows your hands to reach behind their knees rather than just at their thighs. Without proper penetration depth, you're forced into a shallow shot that's easy to defend."
      }
    },
    {
      "@type": "Question",
      "name": "Why should your head be positioned to the side rather than in the center during a double leg takedown?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Center head position makes you extremely vulnerable to guillotine chokes and allows your opponent to easily control and stuff your shot by driving your head downward. Side head position (ear to their hip) protects your neck, generates more power through your shoulder into their center of mass, and makes it much harder for them to control your head. This is the most critical safety and technical detail of the double leg."
      }
    },
    {
      "@type": "Question",
      "name": "What does 'running the pipe' mean in the context of finishing a double leg takedown, and why is it important?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "'Running the pipe' refers to continuing to drive forward with small, powerful steps after making initial contact until your opponent's back hits the mat. It's important because many practitioners stop driving too early once they have the legs, allowing the opponent to recover their base, establish guard, or initiate a scramble. Continuous forward pressure ensures the takedown is completed and you land in a dominant position. The technique isn't finished when you grab the legs—it's finished when their back is on the mat."
      }
    },
    {
      "@type": "Question",
      "name": "If your opponent catches you in a guillotine during your double leg attempt, what are your immediate defensive actions and should you abandon the takedown?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "What are the biomechanical differences between proper and improper level change mechanics for a double leg takedown?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Proper level change involves dropping the hips by bending at the hip joints and knees (like sitting in a chair) while keeping the spine relatively straight and head up, generating power from the legs and glutes. Improper level change involves bending forward at the waist with legs relatively straight, which creates a slow, telegraphed movement, positions the head centrally (guillotine danger), and relies on weaker back muscles rather than powerful leg drive. Proper mechanics allow explosive penetration, maintain a strong posture for defense, and generate significantly more power for the finish."
      }
    },
    {
      "@type": "Question",
      "name": "How should you chain the double leg takedown with other techniques when it's defended, and what are the best transitions based on different defensive reactions?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Against a sprawl: transition to single leg (especially on the side where you have deeper penetration), ankle pick, or establish front headlock control for guillotine/anaconda/darce opportunities. Against a whizzer: convert to a single leg on the opposite side, using the whizzer to elevate their leg. Against a guard pull: don't follow blindly—establish standing guard passing position or drive through to a strong passing position like headquarters. Against a successful stuff with knee/forearm frames: circle away, reset, and attack from a different angle or with a different technique. The key is recognizing the defense early and flowing to the next attack rather than forcing a defended position."
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 3, "name": "Double leg takedown", "item": "https://bjjgraph.org/Transitions/Double-leg-takedown"}
  ]
}
</script>
...
4. **Lift and drive**: Squeeze your hands together tightly behind their knees, pulling their legs toward you while driving your shoulder into their center of mass. Simultaneously drive your hips forward and upward, lifting with your legs (not your back). Your head pressure and shoulder drive should push them backward while your hands prevent them from stepping back to regain base. Keep your elbows tight to your body. (Timing: Continuous pressure, 1-2 seconds)
5. **Run the pipe and finish**: Continue driving forward with small, powerful steps (called 'running the pipe'). Don't stop moving forward until your opponent's back hits the mat. As they begin to fall, you can either keep them tight to your body for a clean landing, or slightly adjust your angle to land in side control. Drive through the takedown—many failures occur from stopping forward movement too early. (Timing: 1-2 seconds of continuous driving)
6. **Establish top position**: As your opponent lands on their back, immediately transition to side control by releasing one hand and stepping your leg over to establish crossface position. Maintain chest-to-chest pressure to prevent them from creating space. If they turn to their side or turtle, be prepared to take the back or work for a submission. Do not allow space for them to recover guard or initiate a scramble. (Timing: Immediate transition, 1-2 seconds)
...
## Common Mistakes
- **Mistake**: Shooting from too far away (distance management failure)
  - **Consequence**: Opponent easily sprawls or moves backward, you end up on your knees with no control, vulnerable to guillotine or front headlock attacks
  - **Correction**: Close the distance first through grip fighting, feints, or footwork. You should be able to touch your opponent before initiating the shot. Practice proper setup sequences rather than shooting from static positions.
- **Mistake**: Head position in the center (telegraph position)
  - **Consequence**: Extremely vulnerable to guillotine choke, easy for opponent to stuff the shot by driving your head down, no power in your drive
  - **Correction**: Always place head to one side, pressed firmly against opponent's hip. Your ear should touch their body. Practice with a partner who will guillotine you every time your head is centered to build the habit.
- **Mistake**: Hands connecting at the thighs instead of behind the knees
  - **Consequence**: Shallow connection gives opponent room to sprawl, much easier for them to base out with their legs, reduced control over their lower body
  - **Correction**: Drill penetration depth until your hands can consistently reach behind the knees or calves. Think 'elbows to knees' to remind yourself to get deep. If you can't get deep, don't force the double leg—switch to a different technique.
- **Mistake**: Stopping forward drive too early
  - **Consequence**: Opponent recovers base, establishes guard, or initiates a scramble. You end up in a weak position despite initially successful penetration
  - **Correction**: Commit to 'running the pipe'—keep driving with small steps until opponent's back hits the mat. Practice this in drilling by having a partner resist at 50% and refusing to stop until they're completely down. Never stop moving forward.
- **Mistake**: Poor level change mechanics (bending at waist instead of hips and knees)
  - **Consequence**: Slow telegraphed shot that's easy to defend, weak penetration step, vulnerable neck position, reduced power generation
  - **Correction**: Practice level changes separately from the full technique. Drop your hips like sitting in a chair, keep your back straight, and maintain head up position. Use a mirror or video to check your mechanics. Your chest should stay relatively upright throughout.
- **Mistake**: Leading with arms instead of hips on penetration
  - **Consequence**: Weak shot that can be easily sprawled on, arms extended and vulnerable to kimura or overhook controls, no power behind the takedown
  - **Correction**: Your hips should lead the movement—drive forward with your legs and hips while your arms follow. Think 'hip to hip' contact before hand connection. Practice shadow penetration steps focusing on hip drive before adding the arm connection.
- **Mistake**: Not adjusting head position away from guillotine danger
  - **Consequence**: Easy guillotine choke for opponent, forced to abandon the takedown attempt, potentially lose the position entirely
  - **Correction**: As soon as you feel any pressure on your neck, look up toward the ceiling and adjust your head to the side immediately. Better yet, drill the technique with head position as the primary focus from the beginning. Have training partners catch bad head position with light guillotine pressure as feedback.
...
**Week 1-2: Fundamental mechanics** - Level change and penetration step without resistance
Practice level changes from standing, focusing on dropping hips while keeping back straight and head up. Work penetration steps to get deep positioning. Partner stands still in neutral stance. Emphasize proper mechanics over speed. 5-10 repetitions per training session on each side.
(Resistance: None)

**Week 3-4: Hand positioning and drive** - Complete technique with cooperative partner
Add hand connection behind the knees and driving mechanics. Partner remains relatively stationary but provides body weight resistance. Focus on getting hands deep, maintaining head position to the side, and running the pipe until partner's back touches the mat. Work both left and right side entries. 8-12 repetitions per side.
(Resistance: Light)

**Week 5-8: Defensive responses and setup** - Technique against light resistance and sprawl defense
Partner provides 30-50% resistance through light sprawl attempts and hip movement. Practice adjusting to counter-pressure, maintaining forward drive, and transitioning to alternatives when double leg is denied. Add setup work including feints, hand fighting, and distance management. 10-15 attempts per session with varying defensive responses.
(Resistance: Medium)

**Week 9-12: Timing and chaining techniques** - Integration with other techniques and realistic setups
Practice double leg as part of takedown chains (e.g., failed single leg to double leg, ankle pick to double leg). Work against 60-70% resistance with partner using realistic defensive reactions. Focus on timing the shot based on opponent's movement, grip fighting, and weight distribution. Include guillotine defense scenarios. 15-20 attempts with full setup sequences.
(Resistance: Medium)

**Week 13+: Competition simulation** - Full resistance application and position transitions
Execute double leg takedowns during positional sparring from standing. Partner uses full defensive repertoire including sprawl, guillotine, whizzer, and guard pull. Emphasis on completing the takedown and immediately establishing dominant position (side control or mount). Work on recognizing optimal timing windows during live movement. Include scenario training where you must complete a takedown within time limits.
(Resistance: Full)

**Ongoing: Refinement and specialization** - Personal style development and high-level details
Develop your preferred setups, grips, and angles based on body type and athletic attributes. Work with training partners of different sizes and styles. Film and analyze your competition footage to identify technical gaps. Practice against specialist defenders who know your game. Add variations like outside step double leg, low single to double leg conversion, and reactive doubles off opponent's attacks.
(Resistance: Full)
...
## Variations
**High crotch to double leg conversion**: Begin with a high crotch single leg attack (hands clasped behind single leg, head outside). When opponent defends by squaring up or whizzering, quickly switch to double leg by dropping your level, circling your outside arm to catch the second leg, and driving through both legs. (When to use: When your initial single leg attack is defended but opponent's weight is still forward. Excellent for no-gi where grips are less secure and position changes happen quickly.)

**Outside step double leg (blast double)**: Instead of penetrating between opponent's legs, take a power step to the outside of their lead leg while simultaneously level changing and driving your shoulder into their hip. Your head goes to the outside, hands still connect behind both knees. This creates a different angle and can bypass certain sprawl defenses. (When to use: Against opponents with excellent sprawl defense who react quickly to traditional penetration. Also effective when you want to create an angle for a back take opportunity if the takedown is defended.)

**Low double leg (knee tap variation)**: Drop your level extremely low, almost to one knee, and attack the legs very low—behind the ankles or at the achilles. Drive forward and upward, lifting the legs while your head drives into their lower abdomen or thigh. This is a lower percentage finish but harder to sprawl on. (When to use: Against taller opponents or those with exceptional sprawl defense. Also useful when you're already in a lowered position from previous attacks or exchanges. Common in gi BJJ where grips slow down movement.)

**Reactive double leg off failed guard pull**: When opponent attempts to pull guard but doesn't secure sufficient grips, react immediately by driving forward into a double leg position. Catch their legs as they're pulling and drive through to complete the takedown before they can establish guard. (When to use: Common in sport BJJ against opponents who favor guard pulling. Requires quick recognition and explosive reaction. Most effective in no-gi where guard pulls are more common and grip control is less secure.)

**Double leg from collar tie position**: Establish a strong collar tie grip on opponent's neck. Use the tie to break their posture downward and forward, then explosively change levels and shoot the double leg. The collar tie both sets up the shot and prevents them from sprawling effectively by controlling their head position. (When to use: Effective in gi and no-gi when you can establish upper body control first. The collar tie commitment from opponent makes them slower to react to the level change. Commonly used in wrestling and no-gi grappling.)
...
**Q2**: Why should your head be positioned to the side rather than in the center during a double leg takedown?
**A**: Center head position makes you extremely vulnerable to guillotine chokes and allows your opponent to easily control and stuff your shot by driving your head downward. Side head position (ear to their hip) protects your neck, generates more power through your shoulder into their center of mass, and makes it much harder for them to control your head. This is the most critical safety and technical detail of the double leg.

**Q3**: What does 'running the pipe' mean in the context of finishing a double leg takedown, and why is it important?
**A**: 'Running the pipe' refers to continuing to drive forward with small, powerful steps after making initial contact until your opponent's back hits the mat. It's important because many practitioners stop driving too early once they have the legs, allowing the opponent to recover their base, establish guard, or initiate a scramble. Continuous forward pressure ensures the takedown is completed and you land in a dominant position. The technique isn't finished when you grab the legs—it's finished when their back is on the mat.

**Q4**: If your opponent catches you in a guillotine during your double leg attempt, what are your immediate defensive actions and should you abandon the takedown?
**A**: Immediate actions: look up toward the ceiling to create space and relieve pressure on your neck, adjust your head position to the side if it's centered, and most importantly, continue driving forward aggressively to complete the takedown. Do not abandon the technique unless the choke is fully locked—it's much easier to escape a guillotine from top position than from your knees. Once on top in side control or mount, you can address the guillotine with proper escapes. Prevention is better: always maintain side head position from the start.

**Q5**: What are the biomechanical differences between proper and improper level change mechanics for a double leg takedown?
**A**: Proper level change involves dropping the hips by bending at the hip joints and knees (like sitting in a chair) while keeping the spine relatively straight and head up, generating power from the legs and glutes. Improper level change involves bending forward at the waist with legs relatively straight, which creates a slow, telegraphed movement, positions the head centrally (guillotine danger), and relies on weaker back muscles rather than powerful leg drive. Proper mechanics allow explosive penetration, maintain a strong posture for defense, and generate significantly more power for the finish.

**Q6**: How should you chain the double leg takedown with other techniques when it's defended, and what are the best transitions based on different defensive reactions?
**A**: Against a sprawl: transition to single leg (especially on the side where you have deeper penetration), ankle pick, or establish front headlock control for guillotine/anaconda/darce opportunities. Against a whizzer: convert to a single leg on the opposite side, using the whizzer to elevate their leg. Against a guard pull: don't follow blindly—establish standing guard passing position or drive through to a strong passing position like headquarters. Against a successful stuff with knee/forearm frames: circle away, reset, and attack from a different angle or with a different technique. The key is recognizing the defense early and flowing to the next attack rather than forcing a defended position.
...
- [[Single Leg Takedown]] - Alternative—can chain between double and single leg attacks based on defensive reactions
- [[High Crotch]] - Related setup—high crotch can convert to double leg when opponent defends
- [[Sprawl Defense]] - Primary counter—understanding sprawl defense helps improve your double leg timing and depth
- [[Front Headlock]] - Follow-up—if double leg is stuffed, transition to front headlock for submissions or back take
- [[Guillotine Choke]] - Common counter—must defend against this when executing double leg with poor head position
- [[Anaconda Choke]] - Alternative finish—if opponent sprawls on your double leg, anaconda becomes available
- [[Side Control]] - Primary ending position—double leg most commonly finishes in side control
- [[Body Lock Pass]] - Related technique—uses similar body lock mechanics and driving pressure
- [[Takedown Entry]] - Concept—fundamental concept for all takedown setups and timing
- [[Standing Position]] - Starting position—neutral standing is where double leg initiates from
- [[Guard Opening Sequence]] - Alternative—opponent may pull guard to counter, requiring passing strategy
- [[Combat Base]] - Recovery position—if takedown partially defended, may need to establish base
