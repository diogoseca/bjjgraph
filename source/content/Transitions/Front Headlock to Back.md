...
<script type="application/ld+json">
{
  ...
  "description": "Learn how to execute Front Headlock to Back Take in Brazilian Jiu-Jitsu.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Setup Requirements",
      "text": "Front headlock established with opponent turtled defensively",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Initial Movement",
      "text": "Opponent turns away to defend submissions, presenting back",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Follow Motion",
      "text": "Step around outside, maintain head control throughout",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Transition Grips",
      "text": "Switch from head control to seatbelt configuration",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Insert Hooks",
      "text": "Slide hooks in as you establish back position",
      "position": 5
    },
    {
      "@type": "HowToStep",
      "name": "Consolidation",
      "text": "Secure back control with both hooks and seatbelt grip",
      "position": 6
    }
  ],
  "tool": [
