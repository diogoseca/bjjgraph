...
- [[Butterfly Elevation]] → [[Butterfly Sweep]] (Success Rate: 50%, Conditions: opponent elevates with hooks before body lock is secure)
- [[Arm Frame]] → [[Space Creation]] (Success Rate: 45%, Conditions: opponent frames with arms to push away)
- [[Head Position Control]] → [[Guard Retention]] (Success Rate: 55%, Conditions: opponent controls head for posture or submission)
- [[Shin Shield]] → [[Defensive Frame]] (Success Rate: 40%, Conditions: opponent inserts shin shield to block pressure)
- [[Single Leg X Entry]] → [[Single Leg X Guard]] (Success Rate: 60%, Conditions: opponent transitions to leg entanglement)
...
## Setup Connections
- [[Open Guard Top]] → [[Body Lock Pass]]
- [[Butterfly Guard]] (top) → [[Body Lock Pass]]
- [[Standing Position]] → [[Body Lock Pass]]
- [[Headquarters Position]] → [[Body Lock Pass]]
- [[Top Half Guard]] → [[Body Lock Pass]]
- [[Smash Pass Position]] → [[Body Lock Pass]]
