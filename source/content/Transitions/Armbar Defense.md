...
- [[Mount Escape Series]] - Broader escape system that includes armbar defense from mount
- [[Elbow Escape]] - Foundational escape movement that supports armbar defense mechanics
- [[Posture Recovery]] - Preventive technique that stops armbar setups from guard positions
- [[Stack Defense]] - Core defensive principle used to compromise opponent's leverage
...
- [[Guard Replacement]] - Follow-up position after successful armbar defense from top
- [[Hip Escape]] - Movement pattern used in mount armbar defense variations
- [[Submission Defense]] - Broader defensive framework encompassing armbar defense principles
- [[Omoplata]] - Common transition when armbar defense creates shoulder exposure
