...
- [[Standing Position]] (Position) - Starting position where sprawl defense is most commonly required against takedown attempts
- [[Double Leg Entry]] (Transition) - Primary offensive technique that sprawl defense is designed to counter
- [[Single Leg Entry]] (Transition) - Alternative takedown attack that requires modified sprawl defense mechanics
...
- [[Sprawl]] (Transition) - Technical execution and movement patterns that implement the sprawl defense concept
- [[Takedown Defense]] (Transition) - Broader defensive framework that includes sprawl defense as one of multiple defensive options
- [[Snap Down]] (Transition) - Complementary standing control technique that creates front headlock opportunities similar to sprawl outcomes
