...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Apply Base Maintenance in BJJ",
  "description": "Decision framework for applying Base Maintenance.",
  "step": [
    {
      "@type": "HowToStep",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 3, "name": "Base Maintenance", "item": "https://bjjgraph.org/Principles/Base-Maintenance"}
  ]
}
</script>
...
- **Error**: Creating excessively wide base that limits mobility
...
- **Error**: Maintaining too narrow base when stability is required
...
- **Error**: Failing to adjust base in response to opponent pressure
...
- **Error**: Poor weight distribution leaving center of gravity outside stability zone
...
- **Error**: Compromising posture to establish base
...
- **Error**: Losing base awareness during offensive sequences
...
**Dynamic Base Maintenance Drills** (Focus: Building ability to preserve base integrity during active grappling. Develops unconscious base maintenance that persists during complex technical sequences.)
...
**Pressure Application Through Base** (Focus: Learning to utilize base not just for defensive stability but as offensive tool for pressure application and opponent control. Understanding base-pressure relationship.)
...
- [[Biomechanical Principles]] (Principle) - Theoretical foundation providing scientific basis for base maintenance techniques
- [[Off-Balancing]] (Principle) - Offensive concept that succeeds when base maintenance fails
