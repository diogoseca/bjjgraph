...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 3, "name": "Position-Over-Submission Approach", "item": "https://bjjgraph.org/Principles/Position-Over-Submission-Approach"}
  ]
}
</script>
...
- **[[Guard Passing Principles]]** (Extension): Guard passing principles exemplify position-over-submission philosophy by prioritizing systematic pass completion and consolidation before attempting submissions from top positions.
...
- [[Defensive Position]] (Position) - Illustrates defensive application of concept where positional recovery takes absolute priority over offensive actions
