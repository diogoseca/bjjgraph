...
---
title: "Posture Breaking | BJJ Principle | BJJ Graph"
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Apply Posture Breaking in BJJ",
  "description": "Decision framework for applying Posture Breaking.",
  "step": [
    {
      "@type": "HowToStep",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 3, "name": "Posture Breaking", "item": "https://bjjgraph.org/Principles/Posture-Breaking"}
  ]
}
</script>
...
- **[[Guard Retention Concepts]]** (Complementary): Guard retention and posture breaking are defensive/offensive sides of the same strategic framework. Posture breaking prevents guard passing by eliminating opponent's ability to generate passing pressure. Strong posture breaking capability is fundamental component of effective guard retention systems.
...
**Posture Breaking to Attack Flow** (Focus: Integration of posture breaking with immediate offensive follow-up. Eliminates dead time between breaking posture and attacking. Develops automatic connection between achieving broken posture and initiating offensive sequences.)
...
**Guard Type Rotation for Posture Breaking Variation** (Focus: Comprehensive development of posture breaking capability across all major guard types rather than specialization in single guard. Ensures well-rounded guard game where posture breaking competency isn't limited to preferred guard positions.)
...
- [[Grip Strategy]] (Principle) - Complementary concept determining which grips provide optimal posture breaking capability
- [[Base Maintenance]] (Principle) - Understanding opponent's base requirements reveals vulnerabilities to exploit through posture breaking
- [[Guard Retention Concepts]] (Principle) - Posture breaking serves as primary guard retention mechanism by eliminating opponent's passing pressure
- [[Off-Balancing]] (Principle) - Works synergistically with posture breaking to create maximum positional dominance from guard
